...
public struct InlineResponse200: Codable, Hashable {
    ...
    public init(appname: String, copyright: String, request: String, timeToRun: String, timestamp: String, version: String, www: String, response: String, result: InlineResponse200Result) {

...
public struct InlineResponse2001: Codable, Hashable {
    ...
    public var responseArray: InlineResponse2001ResponseArray

    public init(appname: String, copyright: String, exampleRequests: AnyCodable? = nil, request: String, timeToRun: String, timestamp: String, version: String, www: String, result: InlineResponse200Result, responseArray: InlineResponse2001ResponseArray) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(responseArray, forKey: .responseArray)
    }
}

...
class InlineResponse200(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, appname, copyright, request, time_to_run, timestamp, version, www, response, result, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, appname, copyright, request, time_to_run, timestamp, version, www, response, result, *args, **kwargs):  # noqa: E501
        """InlineResponse200 - a model defined in OpenAPI

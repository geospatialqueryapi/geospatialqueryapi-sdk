...
class InlineResponse400(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, appname, copyright, example_requests, request, time_to_run, timestamp, version, www, response, result, *args, **kwargs):  # noqa: E501
        ...
        self.example_requests = example_requests
    ...
    @convert_js_args_to_python_args
    def __init__(self, appname, copyright, example_requests, request, time_to_run, timestamp, version, www, response, result, *args, **kwargs):  # noqa: E501
        """InlineResponse400 - a model defined in OpenAPI

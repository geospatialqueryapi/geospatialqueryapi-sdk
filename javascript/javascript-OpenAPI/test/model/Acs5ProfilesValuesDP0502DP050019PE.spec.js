...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoSpatialQueryApiUsCensusBoundariesAndCensusData.Acs5ProfilesValuesDP0502DP050019PE();
  });
  ...
  describe('Acs5ProfilesValuesDP0502DP050019PE', function() {
    it('should create an instance of Acs5ProfilesValuesDP0502DP050019PE', function() {
      // uncomment below and update the code to test Acs5ProfilesValuesDP0502DP050019PE
      //var instane = new GeoSpatialQueryApiUsCensusBoundariesAndCensusData.Acs5ProfilesValuesDP0502DP050019PE();
      //expect(instance).to.be.a(GeoSpatialQueryApiUsCensusBoundariesAndCensusData.Acs5ProfilesValuesDP0502DP050019PE);
    });
    ...
    it('should have the property mDBCode (base name: "MDBCode")', function() {
      ...
      //var instance = new GeoSpatialQueryApiUsCensusBoundariesAndCensusData.Acs5ProfilesValuesDP0502DP050019PE();

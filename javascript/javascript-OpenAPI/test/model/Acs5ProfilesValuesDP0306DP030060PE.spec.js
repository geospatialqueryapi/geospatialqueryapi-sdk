...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoSpatialQueryApiUsCensusBoundariesAndCensusData.Acs5ProfilesValuesDP0306DP030060PE();
  });
  ...
  describe('Acs5ProfilesValuesDP0306DP030060PE', function() {
    it('should create an instance of Acs5ProfilesValuesDP0306DP030060PE', function() {
      // uncomment below and update the code to test Acs5ProfilesValuesDP0306DP030060PE
      //var instane = new GeoSpatialQueryApiUsCensusBoundariesAndCensusData.Acs5ProfilesValuesDP0306DP030060PE();
      //expect(instance).to.be.a(GeoSpatialQueryApiUsCensusBoundariesAndCensusData.Acs5ProfilesValuesDP0306DP030060PE);
    });
    ...
    it('should have the property mDBCode (base name: "MDBCode")', function() {
      ...
      //var instance = new GeoSpatialQueryApiUsCensusBoundariesAndCensusData.Acs5ProfilesValuesDP0306DP030060PE();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoSpatialQueryApiUsCensusBoundariesAndCensusData.InlineResponse2002();
  });
  ...
  describe('InlineResponse2002', function() {
    it('should create an instance of InlineResponse2002', function() {
      ...
      //var instane = new GeoSpatialQueryApiUsCensusBoundariesAndCensusData.InlineResponse2002();
      //expect(instance).to.be.a(GeoSpatialQueryApiUsCensusBoundariesAndCensusData.InlineResponse2002);
    });
    ...
    it('should have the property appname (base name: "appname")', function() {
      ...
      //var instance = new GeoSpatialQueryApiUsCensusBoundariesAndCensusData.InlineResponse2002();

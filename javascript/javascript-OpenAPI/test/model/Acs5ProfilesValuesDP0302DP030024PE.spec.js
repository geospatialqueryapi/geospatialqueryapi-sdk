...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeoSpatialQueryApiUsCensusBoundariesAndCensusData.Acs5ProfilesValuesDP0302DP030024PE();
  });
  ...
  describe('Acs5ProfilesValuesDP0302DP030024PE', function() {
    it('should create an instance of Acs5ProfilesValuesDP0302DP030024PE', function() {
      // uncomment below and update the code to test Acs5ProfilesValuesDP0302DP030024PE
      //var instane = new GeoSpatialQueryApiUsCensusBoundariesAndCensusData.Acs5ProfilesValuesDP0302DP030024PE();
      //expect(instance).to.be.a(GeoSpatialQueryApiUsCensusBoundariesAndCensusData.Acs5ProfilesValuesDP0302DP030024PE);
    });
    ...
    it('should have the property mDBCode (base name: "MDBCode")', function() {
      ...
      //var instance = new GeoSpatialQueryApiUsCensusBoundariesAndCensusData.Acs5ProfilesValuesDP0302DP030024PE();

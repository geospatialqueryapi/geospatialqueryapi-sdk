...
export default class DataApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getV1BoundariesUstractLatLatLon operation.
     * @callback module:api/DataApi~getV1BoundariesUstractLatLatLonCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeatureGeoJSON} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} latLon local identifier of a feature
     * @param {module:api/DataApi~getV1BoundariesUstractLatLatLonCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeatureGeoJSON}
     */
    getV1BoundariesUstractLatLatLon(latLon, callback) {
      let postBody = null;
      // verify the required parameter 'latLon' is set
      if (latLon === undefined || latLon === null) {
        throw new Error("Missing the required parameter 'latLon' when calling getV1BoundariesUstractLatLatLon");
      }

...
// Acs5ProfilesValuesDP0201DP020007PE Male householder, no spouse/partner present: With own children of the householder under 18 years (percent)
type Acs5ProfilesValuesDP0201DP020007PE struct {
	// DP02_0007PE
...
type _Acs5ProfilesValuesDP0201DP020007PE Acs5ProfilesValuesDP0201DP020007PE
...
func NewAcs5ProfilesValuesDP0201DP020007PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0201DP020007PE {
	this := Acs5ProfilesValuesDP0201DP020007PE{}
...
func (o Acs5ProfilesValuesDP0201DP020007PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0201DP020007PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0201DP020007PE := _Acs5ProfilesValuesDP0201DP020007PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0201DP020007PE); err == nil {
		*o = Acs5ProfilesValuesDP0201DP020007PE(varAcs5ProfilesValuesDP0201DP020007PE)
	}
...
type NullableAcs5ProfilesValuesDP0201DP020007PE struct {
	value *Acs5ProfilesValuesDP0201DP020007PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0201DP020007PE) Get() *Acs5ProfilesValuesDP0201DP020007PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0201DP020007PE) Set(val *Acs5ProfilesValuesDP0201DP020007PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0201DP020007PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0201DP020007PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0201DP020007PE(val *Acs5ProfilesValuesDP0201DP020007PE) *NullableAcs5ProfilesValuesDP0201DP020007PE {
	return &NullableAcs5ProfilesValuesDP0201DP020007PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0201DP020007PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0201DP020007PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

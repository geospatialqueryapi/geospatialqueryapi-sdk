...
// Acs5ProfilesValuesDP0504DP050035PE struct for Acs5ProfilesValuesDP0504DP050035PE
type Acs5ProfilesValuesDP0504DP050035PE struct {
...
type _Acs5ProfilesValuesDP0504DP050035PE Acs5ProfilesValuesDP0504DP050035PE
...
func NewAcs5ProfilesValuesDP0504DP050035PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0504DP050035PE {
	this := Acs5ProfilesValuesDP0504DP050035PE{}
...
func (o Acs5ProfilesValuesDP0504DP050035PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0504DP050035PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0504DP050035PE := _Acs5ProfilesValuesDP0504DP050035PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0504DP050035PE); err == nil {
		*o = Acs5ProfilesValuesDP0504DP050035PE(varAcs5ProfilesValuesDP0504DP050035PE)
	}
...
type NullableAcs5ProfilesValuesDP0504DP050035PE struct {
	value *Acs5ProfilesValuesDP0504DP050035PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0504DP050035PE) Get() *Acs5ProfilesValuesDP0504DP050035PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0504DP050035PE) Set(val *Acs5ProfilesValuesDP0504DP050035PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0504DP050035PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0504DP050035PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0504DP050035PE(val *Acs5ProfilesValuesDP0504DP050035PE) *NullableAcs5ProfilesValuesDP0504DP050035PE {
	return &NullableAcs5ProfilesValuesDP0504DP050035PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0504DP050035PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0504DP050035PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

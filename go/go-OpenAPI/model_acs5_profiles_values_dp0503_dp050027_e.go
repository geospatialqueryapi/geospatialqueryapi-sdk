...
// Acs5ProfilesValuesDP0503DP050027E struct for Acs5ProfilesValuesDP0503DP050027E
type Acs5ProfilesValuesDP0503DP050027E struct {
...
type _Acs5ProfilesValuesDP0503DP050027E Acs5ProfilesValuesDP0503DP050027E
...
func NewAcs5ProfilesValuesDP0503DP050027E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0503DP050027E {
	this := Acs5ProfilesValuesDP0503DP050027E{}
...
func (o Acs5ProfilesValuesDP0503DP050027E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0503DP050027E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0503DP050027E := _Acs5ProfilesValuesDP0503DP050027E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0503DP050027E); err == nil {
		*o = Acs5ProfilesValuesDP0503DP050027E(varAcs5ProfilesValuesDP0503DP050027E)
	}
...
type NullableAcs5ProfilesValuesDP0503DP050027E struct {
	value *Acs5ProfilesValuesDP0503DP050027E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0503DP050027E) Get() *Acs5ProfilesValuesDP0503DP050027E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0503DP050027E) Set(val *Acs5ProfilesValuesDP0503DP050027E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0503DP050027E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0503DP050027E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0503DP050027E(val *Acs5ProfilesValuesDP0503DP050027E) *NullableAcs5ProfilesValuesDP0503DP050027E {
	return &NullableAcs5ProfilesValuesDP0503DP050027E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0503DP050027E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0503DP050027E) UnmarshalJSON(src []byte) error {
	v.isSet = true

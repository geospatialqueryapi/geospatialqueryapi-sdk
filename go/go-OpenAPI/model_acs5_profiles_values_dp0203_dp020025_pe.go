...
// Acs5ProfilesValuesDP0203DP020025PE Marital status: Males 15 years and over (percent)
type Acs5ProfilesValuesDP0203DP020025PE struct {
	// DP02_0025PE
...
type _Acs5ProfilesValuesDP0203DP020025PE Acs5ProfilesValuesDP0203DP020025PE
...
func NewAcs5ProfilesValuesDP0203DP020025PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0203DP020025PE {
	this := Acs5ProfilesValuesDP0203DP020025PE{}
...
func (o Acs5ProfilesValuesDP0203DP020025PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0203DP020025PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0203DP020025PE := _Acs5ProfilesValuesDP0203DP020025PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0203DP020025PE); err == nil {
		*o = Acs5ProfilesValuesDP0203DP020025PE(varAcs5ProfilesValuesDP0203DP020025PE)
	}
...
type NullableAcs5ProfilesValuesDP0203DP020025PE struct {
	value *Acs5ProfilesValuesDP0203DP020025PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0203DP020025PE) Get() *Acs5ProfilesValuesDP0203DP020025PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0203DP020025PE) Set(val *Acs5ProfilesValuesDP0203DP020025PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0203DP020025PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0203DP020025PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0203DP020025PE(val *Acs5ProfilesValuesDP0203DP020025PE) *NullableAcs5ProfilesValuesDP0203DP020025PE {
	return &NullableAcs5ProfilesValuesDP0203DP020025PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0203DP020025PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0203DP020025PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

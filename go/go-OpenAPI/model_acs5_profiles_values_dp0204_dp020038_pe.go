...
// Acs5ProfilesValuesDP0204DP020038PE Unmarried women (widowed, divorced, and never married) (percent)
type Acs5ProfilesValuesDP0204DP020038PE struct {
	// DP02_0038PE
...
type _Acs5ProfilesValuesDP0204DP020038PE Acs5ProfilesValuesDP0204DP020038PE
...
func NewAcs5ProfilesValuesDP0204DP020038PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0204DP020038PE {
	this := Acs5ProfilesValuesDP0204DP020038PE{}
...
func (o Acs5ProfilesValuesDP0204DP020038PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0204DP020038PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0204DP020038PE := _Acs5ProfilesValuesDP0204DP020038PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0204DP020038PE); err == nil {
		*o = Acs5ProfilesValuesDP0204DP020038PE(varAcs5ProfilesValuesDP0204DP020038PE)
	}
...
type NullableAcs5ProfilesValuesDP0204DP020038PE struct {
	value *Acs5ProfilesValuesDP0204DP020038PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0204DP020038PE) Get() *Acs5ProfilesValuesDP0204DP020038PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0204DP020038PE) Set(val *Acs5ProfilesValuesDP0204DP020038PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0204DP020038PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0204DP020038PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0204DP020038PE(val *Acs5ProfilesValuesDP0204DP020038PE) *NullableAcs5ProfilesValuesDP0204DP020038PE {
	return &NullableAcs5ProfilesValuesDP0204DP020038PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0204DP020038PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0204DP020038PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

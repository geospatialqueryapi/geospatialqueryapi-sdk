...
// Acs5ProfilesValuesDP0305DP030049E Self-employed in own not incorporated business workers
type Acs5ProfilesValuesDP0305DP030049E struct {
	// DP03_0049E
...
type _Acs5ProfilesValuesDP0305DP030049E Acs5ProfilesValuesDP0305DP030049E
...
func NewAcs5ProfilesValuesDP0305DP030049E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0305DP030049E {
	this := Acs5ProfilesValuesDP0305DP030049E{}
...
func (o Acs5ProfilesValuesDP0305DP030049E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0305DP030049E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0305DP030049E := _Acs5ProfilesValuesDP0305DP030049E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0305DP030049E); err == nil {
		*o = Acs5ProfilesValuesDP0305DP030049E(varAcs5ProfilesValuesDP0305DP030049E)
	}
...
type NullableAcs5ProfilesValuesDP0305DP030049E struct {
	value *Acs5ProfilesValuesDP0305DP030049E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0305DP030049E) Get() *Acs5ProfilesValuesDP0305DP030049E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0305DP030049E) Set(val *Acs5ProfilesValuesDP0305DP030049E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0305DP030049E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0305DP030049E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0305DP030049E(val *Acs5ProfilesValuesDP0305DP030049E) *NullableAcs5ProfilesValuesDP0305DP030049E {
	return &NullableAcs5ProfilesValuesDP0305DP030049E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0305DP030049E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0305DP030049E) UnmarshalJSON(src []byte) error {
	v.isSet = true

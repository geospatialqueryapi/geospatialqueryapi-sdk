...
// Acs5ProfilesValuesDP0306DP030052PE struct for Acs5ProfilesValuesDP0306DP030052PE
type Acs5ProfilesValuesDP0306DP030052PE struct {
...
type _Acs5ProfilesValuesDP0306DP030052PE Acs5ProfilesValuesDP0306DP030052PE
...
func NewAcs5ProfilesValuesDP0306DP030052PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030052PE {
	this := Acs5ProfilesValuesDP0306DP030052PE{}
...
func (o Acs5ProfilesValuesDP0306DP030052PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030052PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030052PE := _Acs5ProfilesValuesDP0306DP030052PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030052PE); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030052PE(varAcs5ProfilesValuesDP0306DP030052PE)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030052PE struct {
	value *Acs5ProfilesValuesDP0306DP030052PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030052PE) Get() *Acs5ProfilesValuesDP0306DP030052PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030052PE) Set(val *Acs5ProfilesValuesDP0306DP030052PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030052PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030052PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030052PE(val *Acs5ProfilesValuesDP0306DP030052PE) *NullableAcs5ProfilesValuesDP0306DP030052PE {
	return &NullableAcs5ProfilesValuesDP0306DP030052PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030052PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030052PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

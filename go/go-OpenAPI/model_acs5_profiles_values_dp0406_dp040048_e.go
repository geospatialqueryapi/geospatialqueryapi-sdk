...
// Acs5ProfilesValuesDP0406DP040048E Average household size of owner-occupied unit
type Acs5ProfilesValuesDP0406DP040048E struct {
	// DP04_0048E
...
type _Acs5ProfilesValuesDP0406DP040048E Acs5ProfilesValuesDP0406DP040048E
...
func NewAcs5ProfilesValuesDP0406DP040048E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0406DP040048E {
	this := Acs5ProfilesValuesDP0406DP040048E{}
...
func (o Acs5ProfilesValuesDP0406DP040048E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0406DP040048E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0406DP040048E := _Acs5ProfilesValuesDP0406DP040048E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0406DP040048E); err == nil {
		*o = Acs5ProfilesValuesDP0406DP040048E(varAcs5ProfilesValuesDP0406DP040048E)
	}
...
type NullableAcs5ProfilesValuesDP0406DP040048E struct {
	value *Acs5ProfilesValuesDP0406DP040048E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0406DP040048E) Get() *Acs5ProfilesValuesDP0406DP040048E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0406DP040048E) Set(val *Acs5ProfilesValuesDP0406DP040048E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0406DP040048E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0406DP040048E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0406DP040048E(val *Acs5ProfilesValuesDP0406DP040048E) *NullableAcs5ProfilesValuesDP0406DP040048E {
	return &NullableAcs5ProfilesValuesDP0406DP040048E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0406DP040048E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0406DP040048E) UnmarshalJSON(src []byte) error {
	v.isSet = true

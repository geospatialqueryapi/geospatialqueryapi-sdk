...
// Acs5ProfilesValuesDP0504DP050039E struct for Acs5ProfilesValuesDP0504DP050039E
type Acs5ProfilesValuesDP0504DP050039E struct {
...
type _Acs5ProfilesValuesDP0504DP050039E Acs5ProfilesValuesDP0504DP050039E
...
func NewAcs5ProfilesValuesDP0504DP050039E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0504DP050039E {
	this := Acs5ProfilesValuesDP0504DP050039E{}
...
func (o Acs5ProfilesValuesDP0504DP050039E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0504DP050039E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0504DP050039E := _Acs5ProfilesValuesDP0504DP050039E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0504DP050039E); err == nil {
		*o = Acs5ProfilesValuesDP0504DP050039E(varAcs5ProfilesValuesDP0504DP050039E)
	}
...
type NullableAcs5ProfilesValuesDP0504DP050039E struct {
	value *Acs5ProfilesValuesDP0504DP050039E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0504DP050039E) Get() *Acs5ProfilesValuesDP0504DP050039E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0504DP050039E) Set(val *Acs5ProfilesValuesDP0504DP050039E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0504DP050039E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0504DP050039E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0504DP050039E(val *Acs5ProfilesValuesDP0504DP050039E) *NullableAcs5ProfilesValuesDP0504DP050039E {
	return &NullableAcs5ProfilesValuesDP0504DP050039E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0504DP050039E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0504DP050039E) UnmarshalJSON(src []byte) error {
	v.isSet = true

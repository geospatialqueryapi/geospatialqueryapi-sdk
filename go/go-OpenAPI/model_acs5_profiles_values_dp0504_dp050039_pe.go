...
// Acs5ProfilesValuesDP0504DP050039PE One race: American Indian and Alaska Native (percent)
type Acs5ProfilesValuesDP0504DP050039PE struct {
	// DP05_0039PE
...
type _Acs5ProfilesValuesDP0504DP050039PE Acs5ProfilesValuesDP0504DP050039PE
...
func NewAcs5ProfilesValuesDP0504DP050039PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0504DP050039PE {
	this := Acs5ProfilesValuesDP0504DP050039PE{}
...
func (o Acs5ProfilesValuesDP0504DP050039PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0504DP050039PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0504DP050039PE := _Acs5ProfilesValuesDP0504DP050039PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0504DP050039PE); err == nil {
		*o = Acs5ProfilesValuesDP0504DP050039PE(varAcs5ProfilesValuesDP0504DP050039PE)
	}
...
type NullableAcs5ProfilesValuesDP0504DP050039PE struct {
	value *Acs5ProfilesValuesDP0504DP050039PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0504DP050039PE) Get() *Acs5ProfilesValuesDP0504DP050039PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0504DP050039PE) Set(val *Acs5ProfilesValuesDP0504DP050039PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0504DP050039PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0504DP050039PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0504DP050039PE(val *Acs5ProfilesValuesDP0504DP050039PE) *NullableAcs5ProfilesValuesDP0504DP050039PE {
	return &NullableAcs5ProfilesValuesDP0504DP050039PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0504DP050039PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0504DP050039PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

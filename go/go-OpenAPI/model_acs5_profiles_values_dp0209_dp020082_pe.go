...
// Acs5ProfilesValuesDP0209DP020082PE Population 1 year and over: Different house in the U.S.: Same county (percent)
type Acs5ProfilesValuesDP0209DP020082PE struct {
	// DP02_0082PE
...
type _Acs5ProfilesValuesDP0209DP020082PE Acs5ProfilesValuesDP0209DP020082PE
...
func NewAcs5ProfilesValuesDP0209DP020082PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0209DP020082PE {
	this := Acs5ProfilesValuesDP0209DP020082PE{}
...
func (o Acs5ProfilesValuesDP0209DP020082PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0209DP020082PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0209DP020082PE := _Acs5ProfilesValuesDP0209DP020082PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0209DP020082PE); err == nil {
		*o = Acs5ProfilesValuesDP0209DP020082PE(varAcs5ProfilesValuesDP0209DP020082PE)
	}
...
type NullableAcs5ProfilesValuesDP0209DP020082PE struct {
	value *Acs5ProfilesValuesDP0209DP020082PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0209DP020082PE) Get() *Acs5ProfilesValuesDP0209DP020082PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0209DP020082PE) Set(val *Acs5ProfilesValuesDP0209DP020082PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0209DP020082PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0209DP020082PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0209DP020082PE(val *Acs5ProfilesValuesDP0209DP020082PE) *NullableAcs5ProfilesValuesDP0209DP020082PE {
	return &NullableAcs5ProfilesValuesDP0209DP020082PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0209DP020082PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0209DP020082PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

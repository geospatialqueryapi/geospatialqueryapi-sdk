...
// Acs5ProfilesValuesDP0502DP050019PE struct for Acs5ProfilesValuesDP0502DP050019PE
type Acs5ProfilesValuesDP0502DP050019PE struct {
...
type _Acs5ProfilesValuesDP0502DP050019PE Acs5ProfilesValuesDP0502DP050019PE
...
func NewAcs5ProfilesValuesDP0502DP050019PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0502DP050019PE {
	this := Acs5ProfilesValuesDP0502DP050019PE{}
...
func (o Acs5ProfilesValuesDP0502DP050019PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0502DP050019PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0502DP050019PE := _Acs5ProfilesValuesDP0502DP050019PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0502DP050019PE); err == nil {
		*o = Acs5ProfilesValuesDP0502DP050019PE(varAcs5ProfilesValuesDP0502DP050019PE)
	}
...
type NullableAcs5ProfilesValuesDP0502DP050019PE struct {
	value *Acs5ProfilesValuesDP0502DP050019PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0502DP050019PE) Get() *Acs5ProfilesValuesDP0502DP050019PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0502DP050019PE) Set(val *Acs5ProfilesValuesDP0502DP050019PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0502DP050019PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0502DP050019PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0502DP050019PE(val *Acs5ProfilesValuesDP0502DP050019PE) *NullableAcs5ProfilesValuesDP0502DP050019PE {
	return &NullableAcs5ProfilesValuesDP0502DP050019PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0502DP050019PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0502DP050019PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0403DP040022PE struct for Acs5ProfilesValuesDP0403DP040022PE
type Acs5ProfilesValuesDP0403DP040022PE struct {
...
type _Acs5ProfilesValuesDP0403DP040022PE Acs5ProfilesValuesDP0403DP040022PE
...
func NewAcs5ProfilesValuesDP0403DP040022PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040022PE {
	this := Acs5ProfilesValuesDP0403DP040022PE{}
...
func (o Acs5ProfilesValuesDP0403DP040022PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040022PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040022PE := _Acs5ProfilesValuesDP0403DP040022PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040022PE); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040022PE(varAcs5ProfilesValuesDP0403DP040022PE)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040022PE struct {
	value *Acs5ProfilesValuesDP0403DP040022PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040022PE) Get() *Acs5ProfilesValuesDP0403DP040022PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040022PE) Set(val *Acs5ProfilesValuesDP0403DP040022PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040022PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040022PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040022PE(val *Acs5ProfilesValuesDP0403DP040022PE) *NullableAcs5ProfilesValuesDP0403DP040022PE {
	return &NullableAcs5ProfilesValuesDP0403DP040022PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040022PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040022PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

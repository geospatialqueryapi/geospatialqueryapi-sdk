...
// Acs5ProfilesValuesDP0402DP040007E struct for Acs5ProfilesValuesDP0402DP040007E
type Acs5ProfilesValuesDP0402DP040007E struct {
...
type _Acs5ProfilesValuesDP0402DP040007E Acs5ProfilesValuesDP0402DP040007E
...
func NewAcs5ProfilesValuesDP0402DP040007E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040007E {
	this := Acs5ProfilesValuesDP0402DP040007E{}
...
func (o Acs5ProfilesValuesDP0402DP040007E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040007E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040007E := _Acs5ProfilesValuesDP0402DP040007E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040007E); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040007E(varAcs5ProfilesValuesDP0402DP040007E)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040007E struct {
	value *Acs5ProfilesValuesDP0402DP040007E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040007E) Get() *Acs5ProfilesValuesDP0402DP040007E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040007E) Set(val *Acs5ProfilesValuesDP0402DP040007E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040007E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040007E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040007E(val *Acs5ProfilesValuesDP0402DP040007E) *NullableAcs5ProfilesValuesDP0402DP040007E {
	return &NullableAcs5ProfilesValuesDP0402DP040007E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040007E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040007E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0402DP040011PE struct for Acs5ProfilesValuesDP0402DP040011PE
type Acs5ProfilesValuesDP0402DP040011PE struct {
...
type _Acs5ProfilesValuesDP0402DP040011PE Acs5ProfilesValuesDP0402DP040011PE
...
func NewAcs5ProfilesValuesDP0402DP040011PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040011PE {
	this := Acs5ProfilesValuesDP0402DP040011PE{}
...
func (o Acs5ProfilesValuesDP0402DP040011PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040011PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040011PE := _Acs5ProfilesValuesDP0402DP040011PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040011PE); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040011PE(varAcs5ProfilesValuesDP0402DP040011PE)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040011PE struct {
	value *Acs5ProfilesValuesDP0402DP040011PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040011PE) Get() *Acs5ProfilesValuesDP0402DP040011PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040011PE) Set(val *Acs5ProfilesValuesDP0402DP040011PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040011PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040011PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040011PE(val *Acs5ProfilesValuesDP0402DP040011PE) *NullableAcs5ProfilesValuesDP0402DP040011PE {
	return &NullableAcs5ProfilesValuesDP0402DP040011PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040011PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040011PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

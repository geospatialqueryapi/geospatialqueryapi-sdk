...
// Acs5ProfilesValuesDP0201DP020002PE struct for Acs5ProfilesValuesDP0201DP020002PE
type Acs5ProfilesValuesDP0201DP020002PE struct {
...
type _Acs5ProfilesValuesDP0201DP020002PE Acs5ProfilesValuesDP0201DP020002PE
...
func NewAcs5ProfilesValuesDP0201DP020002PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0201DP020002PE {
	this := Acs5ProfilesValuesDP0201DP020002PE{}
...
func (o Acs5ProfilesValuesDP0201DP020002PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0201DP020002PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0201DP020002PE := _Acs5ProfilesValuesDP0201DP020002PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0201DP020002PE); err == nil {
		*o = Acs5ProfilesValuesDP0201DP020002PE(varAcs5ProfilesValuesDP0201DP020002PE)
	}
...
type NullableAcs5ProfilesValuesDP0201DP020002PE struct {
	value *Acs5ProfilesValuesDP0201DP020002PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0201DP020002PE) Get() *Acs5ProfilesValuesDP0201DP020002PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0201DP020002PE) Set(val *Acs5ProfilesValuesDP0201DP020002PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0201DP020002PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0201DP020002PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0201DP020002PE(val *Acs5ProfilesValuesDP0201DP020002PE) *NullableAcs5ProfilesValuesDP0201DP020002PE {
	return &NullableAcs5ProfilesValuesDP0201DP020002PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0201DP020002PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0201DP020002PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

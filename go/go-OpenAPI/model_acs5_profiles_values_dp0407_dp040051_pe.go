...
// Acs5ProfilesValuesDP0407DP040051PE struct for Acs5ProfilesValuesDP0407DP040051PE
type Acs5ProfilesValuesDP0407DP040051PE struct {
...
type _Acs5ProfilesValuesDP0407DP040051PE Acs5ProfilesValuesDP0407DP040051PE
...
func NewAcs5ProfilesValuesDP0407DP040051PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0407DP040051PE {
	this := Acs5ProfilesValuesDP0407DP040051PE{}
...
func (o Acs5ProfilesValuesDP0407DP040051PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0407DP040051PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0407DP040051PE := _Acs5ProfilesValuesDP0407DP040051PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0407DP040051PE); err == nil {
		*o = Acs5ProfilesValuesDP0407DP040051PE(varAcs5ProfilesValuesDP0407DP040051PE)
	}
...
type NullableAcs5ProfilesValuesDP0407DP040051PE struct {
	value *Acs5ProfilesValuesDP0407DP040051PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0407DP040051PE) Get() *Acs5ProfilesValuesDP0407DP040051PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0407DP040051PE) Set(val *Acs5ProfilesValuesDP0407DP040051PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0407DP040051PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0407DP040051PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0407DP040051PE(val *Acs5ProfilesValuesDP0407DP040051PE) *NullableAcs5ProfilesValuesDP0407DP040051PE {
	return &NullableAcs5ProfilesValuesDP0407DP040051PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0407DP040051PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0407DP040051PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0407DP040053PE struct for Acs5ProfilesValuesDP0407DP040053PE
type Acs5ProfilesValuesDP0407DP040053PE struct {
...
type _Acs5ProfilesValuesDP0407DP040053PE Acs5ProfilesValuesDP0407DP040053PE
...
func NewAcs5ProfilesValuesDP0407DP040053PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0407DP040053PE {
	this := Acs5ProfilesValuesDP0407DP040053PE{}
...
func (o Acs5ProfilesValuesDP0407DP040053PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0407DP040053PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0407DP040053PE := _Acs5ProfilesValuesDP0407DP040053PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0407DP040053PE); err == nil {
		*o = Acs5ProfilesValuesDP0407DP040053PE(varAcs5ProfilesValuesDP0407DP040053PE)
	}
...
type NullableAcs5ProfilesValuesDP0407DP040053PE struct {
	value *Acs5ProfilesValuesDP0407DP040053PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0407DP040053PE) Get() *Acs5ProfilesValuesDP0407DP040053PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0407DP040053PE) Set(val *Acs5ProfilesValuesDP0407DP040053PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0407DP040053PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0407DP040053PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0407DP040053PE(val *Acs5ProfilesValuesDP0407DP040053PE) *NullableAcs5ProfilesValuesDP0407DP040053PE {
	return &NullableAcs5ProfilesValuesDP0407DP040053PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0407DP040053PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0407DP040053PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0409DP040088E struct for Acs5ProfilesValuesDP0409DP040088E
type Acs5ProfilesValuesDP0409DP040088E struct {
...
type _Acs5ProfilesValuesDP0409DP040088E Acs5ProfilesValuesDP0409DP040088E
...
func NewAcs5ProfilesValuesDP0409DP040088E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0409DP040088E {
	this := Acs5ProfilesValuesDP0409DP040088E{}
...
func (o Acs5ProfilesValuesDP0409DP040088E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0409DP040088E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0409DP040088E := _Acs5ProfilesValuesDP0409DP040088E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0409DP040088E); err == nil {
		*o = Acs5ProfilesValuesDP0409DP040088E(varAcs5ProfilesValuesDP0409DP040088E)
	}
...
type NullableAcs5ProfilesValuesDP0409DP040088E struct {
	value *Acs5ProfilesValuesDP0409DP040088E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0409DP040088E) Get() *Acs5ProfilesValuesDP0409DP040088E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0409DP040088E) Set(val *Acs5ProfilesValuesDP0409DP040088E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0409DP040088E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0409DP040088E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0409DP040088E(val *Acs5ProfilesValuesDP0409DP040088E) *NullableAcs5ProfilesValuesDP0409DP040088E {
	return &NullableAcs5ProfilesValuesDP0409DP040088E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0409DP040088E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0409DP040088E) UnmarshalJSON(src []byte) error {
	v.isSet = true

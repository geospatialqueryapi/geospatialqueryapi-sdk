...
// Acs5ProfilesValuesDP0306DP030053E struct for Acs5ProfilesValuesDP0306DP030053E
type Acs5ProfilesValuesDP0306DP030053E struct {
...
type _Acs5ProfilesValuesDP0306DP030053E Acs5ProfilesValuesDP0306DP030053E
...
func NewAcs5ProfilesValuesDP0306DP030053E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030053E {
	this := Acs5ProfilesValuesDP0306DP030053E{}
...
func (o Acs5ProfilesValuesDP0306DP030053E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030053E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030053E := _Acs5ProfilesValuesDP0306DP030053E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030053E); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030053E(varAcs5ProfilesValuesDP0306DP030053E)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030053E struct {
	value *Acs5ProfilesValuesDP0306DP030053E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030053E) Get() *Acs5ProfilesValuesDP0306DP030053E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030053E) Set(val *Acs5ProfilesValuesDP0306DP030053E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030053E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030053E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030053E(val *Acs5ProfilesValuesDP0306DP030053E) *NullableAcs5ProfilesValuesDP0306DP030053E {
	return &NullableAcs5ProfilesValuesDP0306DP030053E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030053E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030053E) UnmarshalJSON(src []byte) error {
	v.isSet = true

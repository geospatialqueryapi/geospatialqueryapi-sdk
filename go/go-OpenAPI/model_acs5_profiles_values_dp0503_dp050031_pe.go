...
// Acs5ProfilesValuesDP0503DP050031PE struct for Acs5ProfilesValuesDP0503DP050031PE
type Acs5ProfilesValuesDP0503DP050031PE struct {
...
type _Acs5ProfilesValuesDP0503DP050031PE Acs5ProfilesValuesDP0503DP050031PE
...
func NewAcs5ProfilesValuesDP0503DP050031PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0503DP050031PE {
	this := Acs5ProfilesValuesDP0503DP050031PE{}
...
func (o Acs5ProfilesValuesDP0503DP050031PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0503DP050031PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0503DP050031PE := _Acs5ProfilesValuesDP0503DP050031PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0503DP050031PE); err == nil {
		*o = Acs5ProfilesValuesDP0503DP050031PE(varAcs5ProfilesValuesDP0503DP050031PE)
	}
...
type NullableAcs5ProfilesValuesDP0503DP050031PE struct {
	value *Acs5ProfilesValuesDP0503DP050031PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0503DP050031PE) Get() *Acs5ProfilesValuesDP0503DP050031PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0503DP050031PE) Set(val *Acs5ProfilesValuesDP0503DP050031PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0503DP050031PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0503DP050031PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0503DP050031PE(val *Acs5ProfilesValuesDP0503DP050031PE) *NullableAcs5ProfilesValuesDP0503DP050031PE {
	return &NullableAcs5ProfilesValuesDP0503DP050031PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0503DP050031PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0503DP050031PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

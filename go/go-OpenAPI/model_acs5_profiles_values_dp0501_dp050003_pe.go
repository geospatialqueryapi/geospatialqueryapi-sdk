...
// Acs5ProfilesValuesDP0501DP050003PE struct for Acs5ProfilesValuesDP0501DP050003PE
type Acs5ProfilesValuesDP0501DP050003PE struct {
...
type _Acs5ProfilesValuesDP0501DP050003PE Acs5ProfilesValuesDP0501DP050003PE
...
func NewAcs5ProfilesValuesDP0501DP050003PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0501DP050003PE {
	this := Acs5ProfilesValuesDP0501DP050003PE{}
...
func (o Acs5ProfilesValuesDP0501DP050003PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0501DP050003PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0501DP050003PE := _Acs5ProfilesValuesDP0501DP050003PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0501DP050003PE); err == nil {
		*o = Acs5ProfilesValuesDP0501DP050003PE(varAcs5ProfilesValuesDP0501DP050003PE)
	}
...
type NullableAcs5ProfilesValuesDP0501DP050003PE struct {
	value *Acs5ProfilesValuesDP0501DP050003PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0501DP050003PE) Get() *Acs5ProfilesValuesDP0501DP050003PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0501DP050003PE) Set(val *Acs5ProfilesValuesDP0501DP050003PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0501DP050003PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0501DP050003PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0501DP050003PE(val *Acs5ProfilesValuesDP0501DP050003PE) *NullableAcs5ProfilesValuesDP0501DP050003PE {
	return &NullableAcs5ProfilesValuesDP0501DP050003PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0501DP050003PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0501DP050003PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

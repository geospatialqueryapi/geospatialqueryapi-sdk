...
// Acs5ProfilesValuesDP0402DP040008E struct for Acs5ProfilesValuesDP0402DP040008E
type Acs5ProfilesValuesDP0402DP040008E struct {
...
type _Acs5ProfilesValuesDP0402DP040008E Acs5ProfilesValuesDP0402DP040008E
...
func NewAcs5ProfilesValuesDP0402DP040008E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040008E {
	this := Acs5ProfilesValuesDP0402DP040008E{}
...
func (o Acs5ProfilesValuesDP0402DP040008E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040008E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040008E := _Acs5ProfilesValuesDP0402DP040008E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040008E); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040008E(varAcs5ProfilesValuesDP0402DP040008E)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040008E struct {
	value *Acs5ProfilesValuesDP0402DP040008E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040008E) Get() *Acs5ProfilesValuesDP0402DP040008E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040008E) Set(val *Acs5ProfilesValuesDP0402DP040008E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040008E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040008E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040008E(val *Acs5ProfilesValuesDP0402DP040008E) *NullableAcs5ProfilesValuesDP0402DP040008E {
	return &NullableAcs5ProfilesValuesDP0402DP040008E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040008E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040008E) UnmarshalJSON(src []byte) error {
	v.isSet = true

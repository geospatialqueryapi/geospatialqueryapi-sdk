...
// Acs5ProfilesValuesDP0503DP050030E struct for Acs5ProfilesValuesDP0503DP050030E
type Acs5ProfilesValuesDP0503DP050030E struct {
...
type _Acs5ProfilesValuesDP0503DP050030E Acs5ProfilesValuesDP0503DP050030E
...
func NewAcs5ProfilesValuesDP0503DP050030E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0503DP050030E {
	this := Acs5ProfilesValuesDP0503DP050030E{}
...
func (o Acs5ProfilesValuesDP0503DP050030E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0503DP050030E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0503DP050030E := _Acs5ProfilesValuesDP0503DP050030E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0503DP050030E); err == nil {
		*o = Acs5ProfilesValuesDP0503DP050030E(varAcs5ProfilesValuesDP0503DP050030E)
	}
...
type NullableAcs5ProfilesValuesDP0503DP050030E struct {
	value *Acs5ProfilesValuesDP0503DP050030E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0503DP050030E) Get() *Acs5ProfilesValuesDP0503DP050030E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0503DP050030E) Set(val *Acs5ProfilesValuesDP0503DP050030E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0503DP050030E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0503DP050030E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0503DP050030E(val *Acs5ProfilesValuesDP0503DP050030E) *NullableAcs5ProfilesValuesDP0503DP050030E {
	return &NullableAcs5ProfilesValuesDP0503DP050030E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0503DP050030E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0503DP050030E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0403DP040025PE struct for Acs5ProfilesValuesDP0403DP040025PE
type Acs5ProfilesValuesDP0403DP040025PE struct {
...
type _Acs5ProfilesValuesDP0403DP040025PE Acs5ProfilesValuesDP0403DP040025PE
...
func NewAcs5ProfilesValuesDP0403DP040025PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040025PE {
	this := Acs5ProfilesValuesDP0403DP040025PE{}
...
func (o Acs5ProfilesValuesDP0403DP040025PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040025PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040025PE := _Acs5ProfilesValuesDP0403DP040025PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040025PE); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040025PE(varAcs5ProfilesValuesDP0403DP040025PE)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040025PE struct {
	value *Acs5ProfilesValuesDP0403DP040025PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040025PE) Get() *Acs5ProfilesValuesDP0403DP040025PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040025PE) Set(val *Acs5ProfilesValuesDP0403DP040025PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040025PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040025PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040025PE(val *Acs5ProfilesValuesDP0403DP040025PE) *NullableAcs5ProfilesValuesDP0403DP040025PE {
	return &NullableAcs5ProfilesValuesDP0403DP040025PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040025PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040025PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0408DP040061E struct for Acs5ProfilesValuesDP0408DP040061E
type Acs5ProfilesValuesDP0408DP040061E struct {
...
type _Acs5ProfilesValuesDP0408DP040061E Acs5ProfilesValuesDP0408DP040061E
...
func NewAcs5ProfilesValuesDP0408DP040061E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0408DP040061E {
	this := Acs5ProfilesValuesDP0408DP040061E{}
...
func (o Acs5ProfilesValuesDP0408DP040061E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0408DP040061E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0408DP040061E := _Acs5ProfilesValuesDP0408DP040061E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0408DP040061E); err == nil {
		*o = Acs5ProfilesValuesDP0408DP040061E(varAcs5ProfilesValuesDP0408DP040061E)
	}
...
type NullableAcs5ProfilesValuesDP0408DP040061E struct {
	value *Acs5ProfilesValuesDP0408DP040061E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0408DP040061E) Get() *Acs5ProfilesValuesDP0408DP040061E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0408DP040061E) Set(val *Acs5ProfilesValuesDP0408DP040061E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0408DP040061E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0408DP040061E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0408DP040061E(val *Acs5ProfilesValuesDP0408DP040061E) *NullableAcs5ProfilesValuesDP0408DP040061E {
	return &NullableAcs5ProfilesValuesDP0408DP040061E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0408DP040061E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0408DP040061E) UnmarshalJSON(src []byte) error {
	v.isSet = true

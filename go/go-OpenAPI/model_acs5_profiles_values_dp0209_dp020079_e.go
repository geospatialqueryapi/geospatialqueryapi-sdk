...
// Acs5ProfilesValuesDP0209DP020079E struct for Acs5ProfilesValuesDP0209DP020079E
type Acs5ProfilesValuesDP0209DP020079E struct {
...
type _Acs5ProfilesValuesDP0209DP020079E Acs5ProfilesValuesDP0209DP020079E
...
func NewAcs5ProfilesValuesDP0209DP020079E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0209DP020079E {
	this := Acs5ProfilesValuesDP0209DP020079E{}
...
func (o Acs5ProfilesValuesDP0209DP020079E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0209DP020079E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0209DP020079E := _Acs5ProfilesValuesDP0209DP020079E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0209DP020079E); err == nil {
		*o = Acs5ProfilesValuesDP0209DP020079E(varAcs5ProfilesValuesDP0209DP020079E)
	}
...
type NullableAcs5ProfilesValuesDP0209DP020079E struct {
	value *Acs5ProfilesValuesDP0209DP020079E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0209DP020079E) Get() *Acs5ProfilesValuesDP0209DP020079E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0209DP020079E) Set(val *Acs5ProfilesValuesDP0209DP020079E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0209DP020079E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0209DP020079E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0209DP020079E(val *Acs5ProfilesValuesDP0209DP020079E) *NullableAcs5ProfilesValuesDP0209DP020079E {
	return &NullableAcs5ProfilesValuesDP0209DP020079E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0209DP020079E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0209DP020079E) UnmarshalJSON(src []byte) error {
	v.isSet = true

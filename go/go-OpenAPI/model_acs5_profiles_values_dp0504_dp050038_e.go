...
// Acs5ProfilesValuesDP0504DP050038E struct for Acs5ProfilesValuesDP0504DP050038E
type Acs5ProfilesValuesDP0504DP050038E struct {
...
type _Acs5ProfilesValuesDP0504DP050038E Acs5ProfilesValuesDP0504DP050038E
...
func NewAcs5ProfilesValuesDP0504DP050038E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0504DP050038E {
	this := Acs5ProfilesValuesDP0504DP050038E{}
...
func (o Acs5ProfilesValuesDP0504DP050038E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0504DP050038E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0504DP050038E := _Acs5ProfilesValuesDP0504DP050038E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0504DP050038E); err == nil {
		*o = Acs5ProfilesValuesDP0504DP050038E(varAcs5ProfilesValuesDP0504DP050038E)
	}
...
type NullableAcs5ProfilesValuesDP0504DP050038E struct {
	value *Acs5ProfilesValuesDP0504DP050038E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0504DP050038E) Get() *Acs5ProfilesValuesDP0504DP050038E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0504DP050038E) Set(val *Acs5ProfilesValuesDP0504DP050038E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0504DP050038E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0504DP050038E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0504DP050038E(val *Acs5ProfilesValuesDP0504DP050038E) *NullableAcs5ProfilesValuesDP0504DP050038E {
	return &NullableAcs5ProfilesValuesDP0504DP050038E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0504DP050038E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0504DP050038E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0406DP040046PE struct for Acs5ProfilesValuesDP0406DP040046PE
type Acs5ProfilesValuesDP0406DP040046PE struct {
...
type _Acs5ProfilesValuesDP0406DP040046PE Acs5ProfilesValuesDP0406DP040046PE
...
func NewAcs5ProfilesValuesDP0406DP040046PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0406DP040046PE {
	this := Acs5ProfilesValuesDP0406DP040046PE{}
...
func (o Acs5ProfilesValuesDP0406DP040046PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0406DP040046PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0406DP040046PE := _Acs5ProfilesValuesDP0406DP040046PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0406DP040046PE); err == nil {
		*o = Acs5ProfilesValuesDP0406DP040046PE(varAcs5ProfilesValuesDP0406DP040046PE)
	}
...
type NullableAcs5ProfilesValuesDP0406DP040046PE struct {
	value *Acs5ProfilesValuesDP0406DP040046PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0406DP040046PE) Get() *Acs5ProfilesValuesDP0406DP040046PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0406DP040046PE) Set(val *Acs5ProfilesValuesDP0406DP040046PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0406DP040046PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0406DP040046PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0406DP040046PE(val *Acs5ProfilesValuesDP0406DP040046PE) *NullableAcs5ProfilesValuesDP0406DP040046PE {
	return &NullableAcs5ProfilesValuesDP0406DP040046PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0406DP040046PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0406DP040046PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

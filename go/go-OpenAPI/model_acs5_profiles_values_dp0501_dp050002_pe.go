...
// Acs5ProfilesValuesDP0501DP050002PE struct for Acs5ProfilesValuesDP0501DP050002PE
type Acs5ProfilesValuesDP0501DP050002PE struct {
...
type _Acs5ProfilesValuesDP0501DP050002PE Acs5ProfilesValuesDP0501DP050002PE
...
func NewAcs5ProfilesValuesDP0501DP050002PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0501DP050002PE {
	this := Acs5ProfilesValuesDP0501DP050002PE{}
...
func (o Acs5ProfilesValuesDP0501DP050002PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0501DP050002PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0501DP050002PE := _Acs5ProfilesValuesDP0501DP050002PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0501DP050002PE); err == nil {
		*o = Acs5ProfilesValuesDP0501DP050002PE(varAcs5ProfilesValuesDP0501DP050002PE)
	}
...
type NullableAcs5ProfilesValuesDP0501DP050002PE struct {
	value *Acs5ProfilesValuesDP0501DP050002PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0501DP050002PE) Get() *Acs5ProfilesValuesDP0501DP050002PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0501DP050002PE) Set(val *Acs5ProfilesValuesDP0501DP050002PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0501DP050002PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0501DP050002PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0501DP050002PE(val *Acs5ProfilesValuesDP0501DP050002PE) *NullableAcs5ProfilesValuesDP0501DP050002PE {
	return &NullableAcs5ProfilesValuesDP0501DP050002PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0501DP050002PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0501DP050002PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

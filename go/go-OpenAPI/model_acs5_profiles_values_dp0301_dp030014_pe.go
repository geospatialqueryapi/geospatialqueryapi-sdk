...
// Acs5ProfilesValuesDP0301DP030014PE EMPLOYMENT STATUS: Own children of the householder under 6 years (percent)
type Acs5ProfilesValuesDP0301DP030014PE struct {
	// DP03_0014PE
...
type _Acs5ProfilesValuesDP0301DP030014PE Acs5ProfilesValuesDP0301DP030014PE
...
func NewAcs5ProfilesValuesDP0301DP030014PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0301DP030014PE {
	this := Acs5ProfilesValuesDP0301DP030014PE{}
...
func (o Acs5ProfilesValuesDP0301DP030014PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0301DP030014PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0301DP030014PE := _Acs5ProfilesValuesDP0301DP030014PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0301DP030014PE); err == nil {
		*o = Acs5ProfilesValuesDP0301DP030014PE(varAcs5ProfilesValuesDP0301DP030014PE)
	}
...
type NullableAcs5ProfilesValuesDP0301DP030014PE struct {
	value *Acs5ProfilesValuesDP0301DP030014PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0301DP030014PE) Get() *Acs5ProfilesValuesDP0301DP030014PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0301DP030014PE) Set(val *Acs5ProfilesValuesDP0301DP030014PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0301DP030014PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0301DP030014PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0301DP030014PE(val *Acs5ProfilesValuesDP0301DP030014PE) *NullableAcs5ProfilesValuesDP0301DP030014PE {
	return &NullableAcs5ProfilesValuesDP0301DP030014PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0301DP030014PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0301DP030014PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

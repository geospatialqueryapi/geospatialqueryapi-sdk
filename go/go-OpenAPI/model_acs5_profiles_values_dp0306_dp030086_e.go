...
// Acs5ProfilesValuesDP0306DP030086E struct for Acs5ProfilesValuesDP0306DP030086E
type Acs5ProfilesValuesDP0306DP030086E struct {
...
type _Acs5ProfilesValuesDP0306DP030086E Acs5ProfilesValuesDP0306DP030086E
...
func NewAcs5ProfilesValuesDP0306DP030086E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030086E {
	this := Acs5ProfilesValuesDP0306DP030086E{}
...
func (o Acs5ProfilesValuesDP0306DP030086E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030086E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030086E := _Acs5ProfilesValuesDP0306DP030086E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030086E); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030086E(varAcs5ProfilesValuesDP0306DP030086E)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030086E struct {
	value *Acs5ProfilesValuesDP0306DP030086E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030086E) Get() *Acs5ProfilesValuesDP0306DP030086E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030086E) Set(val *Acs5ProfilesValuesDP0306DP030086E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030086E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030086E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030086E(val *Acs5ProfilesValuesDP0306DP030086E) *NullableAcs5ProfilesValuesDP0306DP030086E {
	return &NullableAcs5ProfilesValuesDP0306DP030086E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030086E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030086E) UnmarshalJSON(src []byte) error {
	v.isSet = true

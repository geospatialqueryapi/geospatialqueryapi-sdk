...
// Acs5ProfilesValuesDP0413DP040134E struct for Acs5ProfilesValuesDP0413DP040134E
type Acs5ProfilesValuesDP0413DP040134E struct {
...
type _Acs5ProfilesValuesDP0413DP040134E Acs5ProfilesValuesDP0413DP040134E
...
func NewAcs5ProfilesValuesDP0413DP040134E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0413DP040134E {
	this := Acs5ProfilesValuesDP0413DP040134E{}
...
func (o Acs5ProfilesValuesDP0413DP040134E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0413DP040134E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0413DP040134E := _Acs5ProfilesValuesDP0413DP040134E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0413DP040134E); err == nil {
		*o = Acs5ProfilesValuesDP0413DP040134E(varAcs5ProfilesValuesDP0413DP040134E)
	}
...
type NullableAcs5ProfilesValuesDP0413DP040134E struct {
	value *Acs5ProfilesValuesDP0413DP040134E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0413DP040134E) Get() *Acs5ProfilesValuesDP0413DP040134E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0413DP040134E) Set(val *Acs5ProfilesValuesDP0413DP040134E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0413DP040134E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0413DP040134E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0413DP040134E(val *Acs5ProfilesValuesDP0413DP040134E) *NullableAcs5ProfilesValuesDP0413DP040134E {
	return &NullableAcs5ProfilesValuesDP0413DP040134E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0413DP040134E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0413DP040134E) UnmarshalJSON(src []byte) error {
	v.isSet = true

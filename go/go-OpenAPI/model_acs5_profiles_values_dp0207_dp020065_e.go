...
// Acs5ProfilesValuesDP0207DP020065E Population 25 years and over: Bachelor's degree
type Acs5ProfilesValuesDP0207DP020065E struct {
	// DP02_0065E
...
type _Acs5ProfilesValuesDP0207DP020065E Acs5ProfilesValuesDP0207DP020065E
...
func NewAcs5ProfilesValuesDP0207DP020065E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0207DP020065E {
	this := Acs5ProfilesValuesDP0207DP020065E{}
...
func (o Acs5ProfilesValuesDP0207DP020065E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0207DP020065E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0207DP020065E := _Acs5ProfilesValuesDP0207DP020065E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0207DP020065E); err == nil {
		*o = Acs5ProfilesValuesDP0207DP020065E(varAcs5ProfilesValuesDP0207DP020065E)
	}
...
type NullableAcs5ProfilesValuesDP0207DP020065E struct {
	value *Acs5ProfilesValuesDP0207DP020065E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0207DP020065E) Get() *Acs5ProfilesValuesDP0207DP020065E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0207DP020065E) Set(val *Acs5ProfilesValuesDP0207DP020065E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0207DP020065E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0207DP020065E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0207DP020065E(val *Acs5ProfilesValuesDP0207DP020065E) *NullableAcs5ProfilesValuesDP0207DP020065E {
	return &NullableAcs5ProfilesValuesDP0207DP020065E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0207DP020065E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0207DP020065E) UnmarshalJSON(src []byte) error {
	v.isSet = true

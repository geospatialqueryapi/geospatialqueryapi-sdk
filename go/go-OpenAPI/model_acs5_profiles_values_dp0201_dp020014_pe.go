...
// Acs5ProfilesValuesDP0201DP020014PE Households with one or more people under 18 years (percent)
type Acs5ProfilesValuesDP0201DP020014PE struct {
	// DP02_0014PE
...
type _Acs5ProfilesValuesDP0201DP020014PE Acs5ProfilesValuesDP0201DP020014PE
...
func NewAcs5ProfilesValuesDP0201DP020014PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0201DP020014PE {
	this := Acs5ProfilesValuesDP0201DP020014PE{}
...
func (o Acs5ProfilesValuesDP0201DP020014PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0201DP020014PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0201DP020014PE := _Acs5ProfilesValuesDP0201DP020014PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0201DP020014PE); err == nil {
		*o = Acs5ProfilesValuesDP0201DP020014PE(varAcs5ProfilesValuesDP0201DP020014PE)
	}
...
type NullableAcs5ProfilesValuesDP0201DP020014PE struct {
	value *Acs5ProfilesValuesDP0201DP020014PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0201DP020014PE) Get() *Acs5ProfilesValuesDP0201DP020014PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0201DP020014PE) Set(val *Acs5ProfilesValuesDP0201DP020014PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0201DP020014PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0201DP020014PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0201DP020014PE(val *Acs5ProfilesValuesDP0201DP020014PE) *NullableAcs5ProfilesValuesDP0201DP020014PE {
	return &NullableAcs5ProfilesValuesDP0201DP020014PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0201DP020014PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0201DP020014PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

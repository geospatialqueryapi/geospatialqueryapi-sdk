...
// Acs5ProfilesValuesDP0403DP040026PE struct for Acs5ProfilesValuesDP0403DP040026PE
type Acs5ProfilesValuesDP0403DP040026PE struct {
...
type _Acs5ProfilesValuesDP0403DP040026PE Acs5ProfilesValuesDP0403DP040026PE
...
func NewAcs5ProfilesValuesDP0403DP040026PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040026PE {
	this := Acs5ProfilesValuesDP0403DP040026PE{}
...
func (o Acs5ProfilesValuesDP0403DP040026PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040026PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040026PE := _Acs5ProfilesValuesDP0403DP040026PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040026PE); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040026PE(varAcs5ProfilesValuesDP0403DP040026PE)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040026PE struct {
	value *Acs5ProfilesValuesDP0403DP040026PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040026PE) Get() *Acs5ProfilesValuesDP0403DP040026PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040026PE) Set(val *Acs5ProfilesValuesDP0403DP040026PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040026PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040026PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040026PE(val *Acs5ProfilesValuesDP0403DP040026PE) *NullableAcs5ProfilesValuesDP0403DP040026PE {
	return &NullableAcs5ProfilesValuesDP0403DP040026PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040026PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040026PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

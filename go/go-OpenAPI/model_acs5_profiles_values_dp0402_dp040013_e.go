...
// Acs5ProfilesValuesDP0402DP040013E struct for Acs5ProfilesValuesDP0402DP040013E
type Acs5ProfilesValuesDP0402DP040013E struct {
...
type _Acs5ProfilesValuesDP0402DP040013E Acs5ProfilesValuesDP0402DP040013E
...
func NewAcs5ProfilesValuesDP0402DP040013E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040013E {
	this := Acs5ProfilesValuesDP0402DP040013E{}
...
func (o Acs5ProfilesValuesDP0402DP040013E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040013E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040013E := _Acs5ProfilesValuesDP0402DP040013E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040013E); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040013E(varAcs5ProfilesValuesDP0402DP040013E)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040013E struct {
	value *Acs5ProfilesValuesDP0402DP040013E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040013E) Get() *Acs5ProfilesValuesDP0402DP040013E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040013E) Set(val *Acs5ProfilesValuesDP0402DP040013E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040013E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040013E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040013E(val *Acs5ProfilesValuesDP0402DP040013E) *NullableAcs5ProfilesValuesDP0402DP040013E {
	return &NullableAcs5ProfilesValuesDP0402DP040013E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040013E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040013E) UnmarshalJSON(src []byte) error {
	v.isSet = true

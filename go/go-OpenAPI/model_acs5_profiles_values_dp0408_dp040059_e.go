...
// Acs5ProfilesValuesDP0408DP040059E struct for Acs5ProfilesValuesDP0408DP040059E
type Acs5ProfilesValuesDP0408DP040059E struct {
...
type _Acs5ProfilesValuesDP0408DP040059E Acs5ProfilesValuesDP0408DP040059E
...
func NewAcs5ProfilesValuesDP0408DP040059E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0408DP040059E {
	this := Acs5ProfilesValuesDP0408DP040059E{}
...
func (o Acs5ProfilesValuesDP0408DP040059E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0408DP040059E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0408DP040059E := _Acs5ProfilesValuesDP0408DP040059E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0408DP040059E); err == nil {
		*o = Acs5ProfilesValuesDP0408DP040059E(varAcs5ProfilesValuesDP0408DP040059E)
	}
...
type NullableAcs5ProfilesValuesDP0408DP040059E struct {
	value *Acs5ProfilesValuesDP0408DP040059E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0408DP040059E) Get() *Acs5ProfilesValuesDP0408DP040059E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0408DP040059E) Set(val *Acs5ProfilesValuesDP0408DP040059E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0408DP040059E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0408DP040059E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0408DP040059E(val *Acs5ProfilesValuesDP0408DP040059E) *NullableAcs5ProfilesValuesDP0408DP040059E {
	return &NullableAcs5ProfilesValuesDP0408DP040059E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0408DP040059E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0408DP040059E) UnmarshalJSON(src []byte) error {
	v.isSet = true

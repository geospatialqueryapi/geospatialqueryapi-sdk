...
// Acs5ProfilesValuesDP0503DP050026PE struct for Acs5ProfilesValuesDP0503DP050026PE
type Acs5ProfilesValuesDP0503DP050026PE struct {
...
type _Acs5ProfilesValuesDP0503DP050026PE Acs5ProfilesValuesDP0503DP050026PE
...
func NewAcs5ProfilesValuesDP0503DP050026PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0503DP050026PE {
	this := Acs5ProfilesValuesDP0503DP050026PE{}
...
func (o Acs5ProfilesValuesDP0503DP050026PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0503DP050026PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0503DP050026PE := _Acs5ProfilesValuesDP0503DP050026PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0503DP050026PE); err == nil {
		*o = Acs5ProfilesValuesDP0503DP050026PE(varAcs5ProfilesValuesDP0503DP050026PE)
	}
...
type NullableAcs5ProfilesValuesDP0503DP050026PE struct {
	value *Acs5ProfilesValuesDP0503DP050026PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0503DP050026PE) Get() *Acs5ProfilesValuesDP0503DP050026PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0503DP050026PE) Set(val *Acs5ProfilesValuesDP0503DP050026PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0503DP050026PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0503DP050026PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0503DP050026PE(val *Acs5ProfilesValuesDP0503DP050026PE) *NullableAcs5ProfilesValuesDP0503DP050026PE {
	return &NullableAcs5ProfilesValuesDP0503DP050026PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0503DP050026PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0503DP050026PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

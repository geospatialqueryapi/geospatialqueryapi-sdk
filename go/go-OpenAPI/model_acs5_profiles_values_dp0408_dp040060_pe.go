...
// Acs5ProfilesValuesDP0408DP040060PE struct for Acs5ProfilesValuesDP0408DP040060PE
type Acs5ProfilesValuesDP0408DP040060PE struct {
...
type _Acs5ProfilesValuesDP0408DP040060PE Acs5ProfilesValuesDP0408DP040060PE
...
func NewAcs5ProfilesValuesDP0408DP040060PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0408DP040060PE {
	this := Acs5ProfilesValuesDP0408DP040060PE{}
...
func (o Acs5ProfilesValuesDP0408DP040060PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0408DP040060PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0408DP040060PE := _Acs5ProfilesValuesDP0408DP040060PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0408DP040060PE); err == nil {
		*o = Acs5ProfilesValuesDP0408DP040060PE(varAcs5ProfilesValuesDP0408DP040060PE)
	}
...
type NullableAcs5ProfilesValuesDP0408DP040060PE struct {
	value *Acs5ProfilesValuesDP0408DP040060PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0408DP040060PE) Get() *Acs5ProfilesValuesDP0408DP040060PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0408DP040060PE) Set(val *Acs5ProfilesValuesDP0408DP040060PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0408DP040060PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0408DP040060PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0408DP040060PE(val *Acs5ProfilesValuesDP0408DP040060PE) *NullableAcs5ProfilesValuesDP0408DP040060PE {
	return &NullableAcs5ProfilesValuesDP0408DP040060PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0408DP040060PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0408DP040060PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0201DP020015PE Households with one or more people 65 years and over (percent)
type Acs5ProfilesValuesDP0201DP020015PE struct {
	// DP02_0015PE
...
type _Acs5ProfilesValuesDP0201DP020015PE Acs5ProfilesValuesDP0201DP020015PE
...
func NewAcs5ProfilesValuesDP0201DP020015PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0201DP020015PE {
	this := Acs5ProfilesValuesDP0201DP020015PE{}
...
func (o Acs5ProfilesValuesDP0201DP020015PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0201DP020015PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0201DP020015PE := _Acs5ProfilesValuesDP0201DP020015PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0201DP020015PE); err == nil {
		*o = Acs5ProfilesValuesDP0201DP020015PE(varAcs5ProfilesValuesDP0201DP020015PE)
	}
...
type NullableAcs5ProfilesValuesDP0201DP020015PE struct {
	value *Acs5ProfilesValuesDP0201DP020015PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0201DP020015PE) Get() *Acs5ProfilesValuesDP0201DP020015PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0201DP020015PE) Set(val *Acs5ProfilesValuesDP0201DP020015PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0201DP020015PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0201DP020015PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0201DP020015PE(val *Acs5ProfilesValuesDP0201DP020015PE) *NullableAcs5ProfilesValuesDP0201DP020015PE {
	return &NullableAcs5ProfilesValuesDP0201DP020015PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0201DP020015PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0201DP020015PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0503DP050030PE struct for Acs5ProfilesValuesDP0503DP050030PE
type Acs5ProfilesValuesDP0503DP050030PE struct {
...
type _Acs5ProfilesValuesDP0503DP050030PE Acs5ProfilesValuesDP0503DP050030PE
...
func NewAcs5ProfilesValuesDP0503DP050030PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0503DP050030PE {
	this := Acs5ProfilesValuesDP0503DP050030PE{}
...
func (o Acs5ProfilesValuesDP0503DP050030PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0503DP050030PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0503DP050030PE := _Acs5ProfilesValuesDP0503DP050030PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0503DP050030PE); err == nil {
		*o = Acs5ProfilesValuesDP0503DP050030PE(varAcs5ProfilesValuesDP0503DP050030PE)
	}
...
type NullableAcs5ProfilesValuesDP0503DP050030PE struct {
	value *Acs5ProfilesValuesDP0503DP050030PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0503DP050030PE) Get() *Acs5ProfilesValuesDP0503DP050030PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0503DP050030PE) Set(val *Acs5ProfilesValuesDP0503DP050030PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0503DP050030PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0503DP050030PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0503DP050030PE(val *Acs5ProfilesValuesDP0503DP050030PE) *NullableAcs5ProfilesValuesDP0503DP050030PE {
	return &NullableAcs5ProfilesValuesDP0503DP050030PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0503DP050030PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0503DP050030PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

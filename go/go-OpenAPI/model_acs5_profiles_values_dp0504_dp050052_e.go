...
// Acs5ProfilesValuesDP0504DP050052E One race: Native Hawaiian and Other Pacific Islander
type Acs5ProfilesValuesDP0504DP050052E struct {
	// DP05_0052E
...
type _Acs5ProfilesValuesDP0504DP050052E Acs5ProfilesValuesDP0504DP050052E
...
func NewAcs5ProfilesValuesDP0504DP050052E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0504DP050052E {
	this := Acs5ProfilesValuesDP0504DP050052E{}
...
func (o Acs5ProfilesValuesDP0504DP050052E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0504DP050052E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0504DP050052E := _Acs5ProfilesValuesDP0504DP050052E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0504DP050052E); err == nil {
		*o = Acs5ProfilesValuesDP0504DP050052E(varAcs5ProfilesValuesDP0504DP050052E)
	}
...
type NullableAcs5ProfilesValuesDP0504DP050052E struct {
	value *Acs5ProfilesValuesDP0504DP050052E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0504DP050052E) Get() *Acs5ProfilesValuesDP0504DP050052E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0504DP050052E) Set(val *Acs5ProfilesValuesDP0504DP050052E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0504DP050052E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0504DP050052E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0504DP050052E(val *Acs5ProfilesValuesDP0504DP050052E) *NullableAcs5ProfilesValuesDP0504DP050052E {
	return &NullableAcs5ProfilesValuesDP0504DP050052E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0504DP050052E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0504DP050052E) UnmarshalJSON(src []byte) error {
	v.isSet = true

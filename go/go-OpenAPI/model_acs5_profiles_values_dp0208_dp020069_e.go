...
// Acs5ProfilesValuesDP0208DP020069E VETERAN STATUS: Civilian population 18 years and over
type Acs5ProfilesValuesDP0208DP020069E struct {
	// DP02_0069E
...
type _Acs5ProfilesValuesDP0208DP020069E Acs5ProfilesValuesDP0208DP020069E
...
func NewAcs5ProfilesValuesDP0208DP020069E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0208DP020069E {
	this := Acs5ProfilesValuesDP0208DP020069E{}
...
func (o Acs5ProfilesValuesDP0208DP020069E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0208DP020069E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0208DP020069E := _Acs5ProfilesValuesDP0208DP020069E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0208DP020069E); err == nil {
		*o = Acs5ProfilesValuesDP0208DP020069E(varAcs5ProfilesValuesDP0208DP020069E)
	}
...
type NullableAcs5ProfilesValuesDP0208DP020069E struct {
	value *Acs5ProfilesValuesDP0208DP020069E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0208DP020069E) Get() *Acs5ProfilesValuesDP0208DP020069E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0208DP020069E) Set(val *Acs5ProfilesValuesDP0208DP020069E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0208DP020069E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0208DP020069E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0208DP020069E(val *Acs5ProfilesValuesDP0208DP020069E) *NullableAcs5ProfilesValuesDP0208DP020069E {
	return &NullableAcs5ProfilesValuesDP0208DP020069E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0208DP020069E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0208DP020069E) UnmarshalJSON(src []byte) error {
	v.isSet = true

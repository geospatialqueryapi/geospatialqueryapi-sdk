...
// Acs5ProfilesValuesDP0301DP030006PE struct for Acs5ProfilesValuesDP0301DP030006PE
type Acs5ProfilesValuesDP0301DP030006PE struct {
...
type _Acs5ProfilesValuesDP0301DP030006PE Acs5ProfilesValuesDP0301DP030006PE
...
func NewAcs5ProfilesValuesDP0301DP030006PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0301DP030006PE {
	this := Acs5ProfilesValuesDP0301DP030006PE{}
...
func (o Acs5ProfilesValuesDP0301DP030006PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0301DP030006PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0301DP030006PE := _Acs5ProfilesValuesDP0301DP030006PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0301DP030006PE); err == nil {
		*o = Acs5ProfilesValuesDP0301DP030006PE(varAcs5ProfilesValuesDP0301DP030006PE)
	}
...
type NullableAcs5ProfilesValuesDP0301DP030006PE struct {
	value *Acs5ProfilesValuesDP0301DP030006PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0301DP030006PE) Get() *Acs5ProfilesValuesDP0301DP030006PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0301DP030006PE) Set(val *Acs5ProfilesValuesDP0301DP030006PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0301DP030006PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0301DP030006PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0301DP030006PE(val *Acs5ProfilesValuesDP0301DP030006PE) *NullableAcs5ProfilesValuesDP0301DP030006PE {
	return &NullableAcs5ProfilesValuesDP0301DP030006PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0301DP030006PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0301DP030006PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

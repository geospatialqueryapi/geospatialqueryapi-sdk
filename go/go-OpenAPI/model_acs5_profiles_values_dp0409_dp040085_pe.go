...
// Acs5ProfilesValuesDP0409DP040085PE struct for Acs5ProfilesValuesDP0409DP040085PE
type Acs5ProfilesValuesDP0409DP040085PE struct {
...
type _Acs5ProfilesValuesDP0409DP040085PE Acs5ProfilesValuesDP0409DP040085PE
...
func NewAcs5ProfilesValuesDP0409DP040085PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0409DP040085PE {
	this := Acs5ProfilesValuesDP0409DP040085PE{}
...
func (o Acs5ProfilesValuesDP0409DP040085PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0409DP040085PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0409DP040085PE := _Acs5ProfilesValuesDP0409DP040085PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0409DP040085PE); err == nil {
		*o = Acs5ProfilesValuesDP0409DP040085PE(varAcs5ProfilesValuesDP0409DP040085PE)
	}
...
type NullableAcs5ProfilesValuesDP0409DP040085PE struct {
	value *Acs5ProfilesValuesDP0409DP040085PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0409DP040085PE) Get() *Acs5ProfilesValuesDP0409DP040085PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0409DP040085PE) Set(val *Acs5ProfilesValuesDP0409DP040085PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0409DP040085PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0409DP040085PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0409DP040085PE(val *Acs5ProfilesValuesDP0409DP040085PE) *NullableAcs5ProfilesValuesDP0409DP040085PE {
	return &NullableAcs5ProfilesValuesDP0409DP040085PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0409DP040085PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0409DP040085PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

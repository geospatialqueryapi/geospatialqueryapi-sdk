...
// Acs5ProfilesValuesDP0306DP030061PE struct for Acs5ProfilesValuesDP0306DP030061PE
type Acs5ProfilesValuesDP0306DP030061PE struct {
...
type _Acs5ProfilesValuesDP0306DP030061PE Acs5ProfilesValuesDP0306DP030061PE
...
func NewAcs5ProfilesValuesDP0306DP030061PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030061PE {
	this := Acs5ProfilesValuesDP0306DP030061PE{}
...
func (o Acs5ProfilesValuesDP0306DP030061PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030061PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030061PE := _Acs5ProfilesValuesDP0306DP030061PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030061PE); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030061PE(varAcs5ProfilesValuesDP0306DP030061PE)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030061PE struct {
	value *Acs5ProfilesValuesDP0306DP030061PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030061PE) Get() *Acs5ProfilesValuesDP0306DP030061PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030061PE) Set(val *Acs5ProfilesValuesDP0306DP030061PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030061PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030061PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030061PE(val *Acs5ProfilesValuesDP0306DP030061PE) *NullableAcs5ProfilesValuesDP0306DP030061PE {
	return &NullableAcs5ProfilesValuesDP0306DP030061PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030061PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030061PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

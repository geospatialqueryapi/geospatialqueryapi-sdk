...
// Acs5ProfilesValuesDP0209DP020084E Population 1 year and over: Different house in the U.S.: Different county: Same state
type Acs5ProfilesValuesDP0209DP020084E struct {
	// DP02_0084E
...
type _Acs5ProfilesValuesDP0209DP020084E Acs5ProfilesValuesDP0209DP020084E
...
func NewAcs5ProfilesValuesDP0209DP020084E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0209DP020084E {
	this := Acs5ProfilesValuesDP0209DP020084E{}
...
func (o Acs5ProfilesValuesDP0209DP020084E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0209DP020084E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0209DP020084E := _Acs5ProfilesValuesDP0209DP020084E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0209DP020084E); err == nil {
		*o = Acs5ProfilesValuesDP0209DP020084E(varAcs5ProfilesValuesDP0209DP020084E)
	}
...
type NullableAcs5ProfilesValuesDP0209DP020084E struct {
	value *Acs5ProfilesValuesDP0209DP020084E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0209DP020084E) Get() *Acs5ProfilesValuesDP0209DP020084E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0209DP020084E) Set(val *Acs5ProfilesValuesDP0209DP020084E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0209DP020084E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0209DP020084E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0209DP020084E(val *Acs5ProfilesValuesDP0209DP020084E) *NullableAcs5ProfilesValuesDP0209DP020084E {
	return &NullableAcs5ProfilesValuesDP0209DP020084E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0209DP020084E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0209DP020084E) UnmarshalJSON(src []byte) error {
	v.isSet = true

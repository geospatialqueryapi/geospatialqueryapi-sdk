...
// Acs5ProfilesValuesDP0306DP030054E struct for Acs5ProfilesValuesDP0306DP030054E
type Acs5ProfilesValuesDP0306DP030054E struct {
...
type _Acs5ProfilesValuesDP0306DP030054E Acs5ProfilesValuesDP0306DP030054E
...
func NewAcs5ProfilesValuesDP0306DP030054E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030054E {
	this := Acs5ProfilesValuesDP0306DP030054E{}
...
func (o Acs5ProfilesValuesDP0306DP030054E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030054E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030054E := _Acs5ProfilesValuesDP0306DP030054E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030054E); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030054E(varAcs5ProfilesValuesDP0306DP030054E)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030054E struct {
	value *Acs5ProfilesValuesDP0306DP030054E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030054E) Get() *Acs5ProfilesValuesDP0306DP030054E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030054E) Set(val *Acs5ProfilesValuesDP0306DP030054E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030054E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030054E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030054E(val *Acs5ProfilesValuesDP0306DP030054E) *NullableAcs5ProfilesValuesDP0306DP030054E {
	return &NullableAcs5ProfilesValuesDP0306DP030054E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030054E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030054E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0209DP020081PE Population 1 year and over: Different house in the U.S. (percent)
type Acs5ProfilesValuesDP0209DP020081PE struct {
	// DP02_0081PE
...
type _Acs5ProfilesValuesDP0209DP020081PE Acs5ProfilesValuesDP0209DP020081PE
...
func NewAcs5ProfilesValuesDP0209DP020081PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0209DP020081PE {
	this := Acs5ProfilesValuesDP0209DP020081PE{}
...
func (o Acs5ProfilesValuesDP0209DP020081PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0209DP020081PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0209DP020081PE := _Acs5ProfilesValuesDP0209DP020081PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0209DP020081PE); err == nil {
		*o = Acs5ProfilesValuesDP0209DP020081PE(varAcs5ProfilesValuesDP0209DP020081PE)
	}
...
type NullableAcs5ProfilesValuesDP0209DP020081PE struct {
	value *Acs5ProfilesValuesDP0209DP020081PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0209DP020081PE) Get() *Acs5ProfilesValuesDP0209DP020081PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0209DP020081PE) Set(val *Acs5ProfilesValuesDP0209DP020081PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0209DP020081PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0209DP020081PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0209DP020081PE(val *Acs5ProfilesValuesDP0209DP020081PE) *NullableAcs5ProfilesValuesDP0209DP020081PE {
	return &NullableAcs5ProfilesValuesDP0209DP020081PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0209DP020081PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0209DP020081PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

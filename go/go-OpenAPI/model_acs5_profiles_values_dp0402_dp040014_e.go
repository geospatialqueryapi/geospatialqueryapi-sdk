...
// Acs5ProfilesValuesDP0402DP040014E struct for Acs5ProfilesValuesDP0402DP040014E
type Acs5ProfilesValuesDP0402DP040014E struct {
...
type _Acs5ProfilesValuesDP0402DP040014E Acs5ProfilesValuesDP0402DP040014E
...
func NewAcs5ProfilesValuesDP0402DP040014E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040014E {
	this := Acs5ProfilesValuesDP0402DP040014E{}
...
func (o Acs5ProfilesValuesDP0402DP040014E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040014E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040014E := _Acs5ProfilesValuesDP0402DP040014E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040014E); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040014E(varAcs5ProfilesValuesDP0402DP040014E)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040014E struct {
	value *Acs5ProfilesValuesDP0402DP040014E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040014E) Get() *Acs5ProfilesValuesDP0402DP040014E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040014E) Set(val *Acs5ProfilesValuesDP0402DP040014E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040014E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040014E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040014E(val *Acs5ProfilesValuesDP0402DP040014E) *NullableAcs5ProfilesValuesDP0402DP040014E {
	return &NullableAcs5ProfilesValuesDP0402DP040014E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040014E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040014E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0408DP040060E struct for Acs5ProfilesValuesDP0408DP040060E
type Acs5ProfilesValuesDP0408DP040060E struct {
...
type _Acs5ProfilesValuesDP0408DP040060E Acs5ProfilesValuesDP0408DP040060E
...
func NewAcs5ProfilesValuesDP0408DP040060E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0408DP040060E {
	this := Acs5ProfilesValuesDP0408DP040060E{}
...
func (o Acs5ProfilesValuesDP0408DP040060E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0408DP040060E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0408DP040060E := _Acs5ProfilesValuesDP0408DP040060E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0408DP040060E); err == nil {
		*o = Acs5ProfilesValuesDP0408DP040060E(varAcs5ProfilesValuesDP0408DP040060E)
	}
...
type NullableAcs5ProfilesValuesDP0408DP040060E struct {
	value *Acs5ProfilesValuesDP0408DP040060E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0408DP040060E) Get() *Acs5ProfilesValuesDP0408DP040060E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0408DP040060E) Set(val *Acs5ProfilesValuesDP0408DP040060E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0408DP040060E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0408DP040060E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0408DP040060E(val *Acs5ProfilesValuesDP0408DP040060E) *NullableAcs5ProfilesValuesDP0408DP040060E {
	return &NullableAcs5ProfilesValuesDP0408DP040060E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0408DP040060E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0408DP040060E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0201DP020015E Households with one or more people 65 years and over
type Acs5ProfilesValuesDP0201DP020015E struct {
	// DP02_0015E
...
type _Acs5ProfilesValuesDP0201DP020015E Acs5ProfilesValuesDP0201DP020015E
...
func NewAcs5ProfilesValuesDP0201DP020015E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0201DP020015E {
	this := Acs5ProfilesValuesDP0201DP020015E{}
...
func (o Acs5ProfilesValuesDP0201DP020015E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0201DP020015E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0201DP020015E := _Acs5ProfilesValuesDP0201DP020015E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0201DP020015E); err == nil {
		*o = Acs5ProfilesValuesDP0201DP020015E(varAcs5ProfilesValuesDP0201DP020015E)
	}
...
type NullableAcs5ProfilesValuesDP0201DP020015E struct {
	value *Acs5ProfilesValuesDP0201DP020015E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0201DP020015E) Get() *Acs5ProfilesValuesDP0201DP020015E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0201DP020015E) Set(val *Acs5ProfilesValuesDP0201DP020015E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0201DP020015E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0201DP020015E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0201DP020015E(val *Acs5ProfilesValuesDP0201DP020015E) *NullableAcs5ProfilesValuesDP0201DP020015E {
	return &NullableAcs5ProfilesValuesDP0201DP020015E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0201DP020015E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0201DP020015E) UnmarshalJSON(src []byte) error {
	v.isSet = true

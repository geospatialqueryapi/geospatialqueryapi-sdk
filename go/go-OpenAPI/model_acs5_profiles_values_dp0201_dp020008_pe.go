...
type _Acs5ProfilesValuesDP0201DP020008PE Acs5ProfilesValuesDP0201DP020008PE
...
func NewAcs5ProfilesValuesDP0201DP020008PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0201DP020008PE {
	this := Acs5ProfilesValuesDP0201DP020008PE{}
...
func (o Acs5ProfilesValuesDP0201DP020008PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0201DP020008PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0201DP020008PE := _Acs5ProfilesValuesDP0201DP020008PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0201DP020008PE); err == nil {
		*o = Acs5ProfilesValuesDP0201DP020008PE(varAcs5ProfilesValuesDP0201DP020008PE)
	}
...
type NullableAcs5ProfilesValuesDP0201DP020008PE struct {
	value *Acs5ProfilesValuesDP0201DP020008PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0201DP020008PE) Get() *Acs5ProfilesValuesDP0201DP020008PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0201DP020008PE) Set(val *Acs5ProfilesValuesDP0201DP020008PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0201DP020008PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0201DP020008PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0201DP020008PE(val *Acs5ProfilesValuesDP0201DP020008PE) *NullableAcs5ProfilesValuesDP0201DP020008PE {
	return &NullableAcs5ProfilesValuesDP0201DP020008PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0201DP020008PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0201DP020008PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

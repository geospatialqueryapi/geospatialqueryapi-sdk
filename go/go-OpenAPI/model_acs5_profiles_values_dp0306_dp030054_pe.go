...
// Acs5ProfilesValuesDP0306DP030054PE struct for Acs5ProfilesValuesDP0306DP030054PE
type Acs5ProfilesValuesDP0306DP030054PE struct {
...
type _Acs5ProfilesValuesDP0306DP030054PE Acs5ProfilesValuesDP0306DP030054PE
...
func NewAcs5ProfilesValuesDP0306DP030054PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030054PE {
	this := Acs5ProfilesValuesDP0306DP030054PE{}
...
func (o Acs5ProfilesValuesDP0306DP030054PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030054PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030054PE := _Acs5ProfilesValuesDP0306DP030054PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030054PE); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030054PE(varAcs5ProfilesValuesDP0306DP030054PE)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030054PE struct {
	value *Acs5ProfilesValuesDP0306DP030054PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030054PE) Get() *Acs5ProfilesValuesDP0306DP030054PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030054PE) Set(val *Acs5ProfilesValuesDP0306DP030054PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030054PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030054PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030054PE(val *Acs5ProfilesValuesDP0306DP030054PE) *NullableAcs5ProfilesValuesDP0306DP030054PE {
	return &NullableAcs5ProfilesValuesDP0306DP030054PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030054PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030054PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

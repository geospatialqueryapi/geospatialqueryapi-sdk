...
// Acs5ProfilesValuesDP0505DP050076PE struct for Acs5ProfilesValuesDP0505DP050076PE
type Acs5ProfilesValuesDP0505DP050076PE struct {
...
type _Acs5ProfilesValuesDP0505DP050076PE Acs5ProfilesValuesDP0505DP050076PE
...
func NewAcs5ProfilesValuesDP0505DP050076PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0505DP050076PE {
	this := Acs5ProfilesValuesDP0505DP050076PE{}
...
func (o Acs5ProfilesValuesDP0505DP050076PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0505DP050076PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0505DP050076PE := _Acs5ProfilesValuesDP0505DP050076PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0505DP050076PE); err == nil {
		*o = Acs5ProfilesValuesDP0505DP050076PE(varAcs5ProfilesValuesDP0505DP050076PE)
	}
...
type NullableAcs5ProfilesValuesDP0505DP050076PE struct {
	value *Acs5ProfilesValuesDP0505DP050076PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0505DP050076PE) Get() *Acs5ProfilesValuesDP0505DP050076PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0505DP050076PE) Set(val *Acs5ProfilesValuesDP0505DP050076PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0505DP050076PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0505DP050076PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0505DP050076PE(val *Acs5ProfilesValuesDP0505DP050076PE) *NullableAcs5ProfilesValuesDP0505DP050076PE {
	return &NullableAcs5ProfilesValuesDP0505DP050076PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0505DP050076PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0505DP050076PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0303DP030028E struct for Acs5ProfilesValuesDP0303DP030028E
type Acs5ProfilesValuesDP0303DP030028E struct {
...
type _Acs5ProfilesValuesDP0303DP030028E Acs5ProfilesValuesDP0303DP030028E
...
func NewAcs5ProfilesValuesDP0303DP030028E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0303DP030028E {
	this := Acs5ProfilesValuesDP0303DP030028E{}
...
func (o Acs5ProfilesValuesDP0303DP030028E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0303DP030028E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0303DP030028E := _Acs5ProfilesValuesDP0303DP030028E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0303DP030028E); err == nil {
		*o = Acs5ProfilesValuesDP0303DP030028E(varAcs5ProfilesValuesDP0303DP030028E)
	}
...
type NullableAcs5ProfilesValuesDP0303DP030028E struct {
	value *Acs5ProfilesValuesDP0303DP030028E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0303DP030028E) Get() *Acs5ProfilesValuesDP0303DP030028E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0303DP030028E) Set(val *Acs5ProfilesValuesDP0303DP030028E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0303DP030028E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0303DP030028E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0303DP030028E(val *Acs5ProfilesValuesDP0303DP030028E) *NullableAcs5ProfilesValuesDP0303DP030028E {
	return &NullableAcs5ProfilesValuesDP0303DP030028E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0303DP030028E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0303DP030028E) UnmarshalJSON(src []byte) error {
	v.isSet = true

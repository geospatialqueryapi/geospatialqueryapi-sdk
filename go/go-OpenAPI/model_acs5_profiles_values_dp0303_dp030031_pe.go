...
// Acs5ProfilesValuesDP0303DP030031PE Production, transportation, and material moving occupations (percent)
type Acs5ProfilesValuesDP0303DP030031PE struct {
	// DP03_0031PE
...
type _Acs5ProfilesValuesDP0303DP030031PE Acs5ProfilesValuesDP0303DP030031PE
...
func NewAcs5ProfilesValuesDP0303DP030031PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0303DP030031PE {
	this := Acs5ProfilesValuesDP0303DP030031PE{}
...
func (o Acs5ProfilesValuesDP0303DP030031PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0303DP030031PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0303DP030031PE := _Acs5ProfilesValuesDP0303DP030031PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0303DP030031PE); err == nil {
		*o = Acs5ProfilesValuesDP0303DP030031PE(varAcs5ProfilesValuesDP0303DP030031PE)
	}
...
type NullableAcs5ProfilesValuesDP0303DP030031PE struct {
	value *Acs5ProfilesValuesDP0303DP030031PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0303DP030031PE) Get() *Acs5ProfilesValuesDP0303DP030031PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0303DP030031PE) Set(val *Acs5ProfilesValuesDP0303DP030031PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0303DP030031PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0303DP030031PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0303DP030031PE(val *Acs5ProfilesValuesDP0303DP030031PE) *NullableAcs5ProfilesValuesDP0303DP030031PE {
	return &NullableAcs5ProfilesValuesDP0303DP030031PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0303DP030031PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0303DP030031PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0306DP030051E Income and benefits (in 2019 inflation-adjusted dollars): Total households
type Acs5ProfilesValuesDP0306DP030051E struct {
	// DP03_0051E
...
type _Acs5ProfilesValuesDP0306DP030051E Acs5ProfilesValuesDP0306DP030051E
...
func NewAcs5ProfilesValuesDP0306DP030051E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030051E {
	this := Acs5ProfilesValuesDP0306DP030051E{}
...
func (o Acs5ProfilesValuesDP0306DP030051E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030051E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030051E := _Acs5ProfilesValuesDP0306DP030051E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030051E); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030051E(varAcs5ProfilesValuesDP0306DP030051E)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030051E struct {
	value *Acs5ProfilesValuesDP0306DP030051E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030051E) Get() *Acs5ProfilesValuesDP0306DP030051E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030051E) Set(val *Acs5ProfilesValuesDP0306DP030051E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030051E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030051E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030051E(val *Acs5ProfilesValuesDP0306DP030051E) *NullableAcs5ProfilesValuesDP0306DP030051E {
	return &NullableAcs5ProfilesValuesDP0306DP030051E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030051E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030051E) UnmarshalJSON(src []byte) error {
	v.isSet = true

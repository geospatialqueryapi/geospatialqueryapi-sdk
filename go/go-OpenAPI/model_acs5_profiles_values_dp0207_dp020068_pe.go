...
// Acs5ProfilesValuesDP0207DP020068PE struct for Acs5ProfilesValuesDP0207DP020068PE
...
type _Acs5ProfilesValuesDP0207DP020068PE Acs5ProfilesValuesDP0207DP020068PE
...
func NewAcs5ProfilesValuesDP0207DP020068PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0207DP020068PE {
	this := Acs5ProfilesValuesDP0207DP020068PE{}
...
func (o Acs5ProfilesValuesDP0207DP020068PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0207DP020068PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0207DP020068PE := _Acs5ProfilesValuesDP0207DP020068PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0207DP020068PE); err == nil {
		*o = Acs5ProfilesValuesDP0207DP020068PE(varAcs5ProfilesValuesDP0207DP020068PE)
	}
...
type NullableAcs5ProfilesValuesDP0207DP020068PE struct {
	value *Acs5ProfilesValuesDP0207DP020068PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0207DP020068PE) Get() *Acs5ProfilesValuesDP0207DP020068PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0207DP020068PE) Set(val *Acs5ProfilesValuesDP0207DP020068PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0207DP020068PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0207DP020068PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0207DP020068PE(val *Acs5ProfilesValuesDP0207DP020068PE) *NullableAcs5ProfilesValuesDP0207DP020068PE {
	return &NullableAcs5ProfilesValuesDP0207DP020068PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0207DP020068PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0207DP020068PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

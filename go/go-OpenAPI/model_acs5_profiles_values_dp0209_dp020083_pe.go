...
// Acs5ProfilesValuesDP0209DP020083PE Population 1 year and over: Different house in the U.S.: Different county (percent)
type Acs5ProfilesValuesDP0209DP020083PE struct {
	// DP02_0083PE
...
type _Acs5ProfilesValuesDP0209DP020083PE Acs5ProfilesValuesDP0209DP020083PE
...
func NewAcs5ProfilesValuesDP0209DP020083PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0209DP020083PE {
	this := Acs5ProfilesValuesDP0209DP020083PE{}
...
func (o Acs5ProfilesValuesDP0209DP020083PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0209DP020083PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0209DP020083PE := _Acs5ProfilesValuesDP0209DP020083PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0209DP020083PE); err == nil {
		*o = Acs5ProfilesValuesDP0209DP020083PE(varAcs5ProfilesValuesDP0209DP020083PE)
	}
...
type NullableAcs5ProfilesValuesDP0209DP020083PE struct {
	value *Acs5ProfilesValuesDP0209DP020083PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0209DP020083PE) Get() *Acs5ProfilesValuesDP0209DP020083PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0209DP020083PE) Set(val *Acs5ProfilesValuesDP0209DP020083PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0209DP020083PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0209DP020083PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0209DP020083PE(val *Acs5ProfilesValuesDP0209DP020083PE) *NullableAcs5ProfilesValuesDP0209DP020083PE {
	return &NullableAcs5ProfilesValuesDP0209DP020083PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0209DP020083PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0209DP020083PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

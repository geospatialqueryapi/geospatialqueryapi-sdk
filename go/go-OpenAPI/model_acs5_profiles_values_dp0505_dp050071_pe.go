...
// Acs5ProfilesValuesDP0505DP050071PE struct for Acs5ProfilesValuesDP0505DP050071PE
type Acs5ProfilesValuesDP0505DP050071PE struct {
...
type _Acs5ProfilesValuesDP0505DP050071PE Acs5ProfilesValuesDP0505DP050071PE
...
func NewAcs5ProfilesValuesDP0505DP050071PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0505DP050071PE {
	this := Acs5ProfilesValuesDP0505DP050071PE{}
...
func (o Acs5ProfilesValuesDP0505DP050071PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0505DP050071PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0505DP050071PE := _Acs5ProfilesValuesDP0505DP050071PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0505DP050071PE); err == nil {
		*o = Acs5ProfilesValuesDP0505DP050071PE(varAcs5ProfilesValuesDP0505DP050071PE)
	}
...
type NullableAcs5ProfilesValuesDP0505DP050071PE struct {
	value *Acs5ProfilesValuesDP0505DP050071PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0505DP050071PE) Get() *Acs5ProfilesValuesDP0505DP050071PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0505DP050071PE) Set(val *Acs5ProfilesValuesDP0505DP050071PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0505DP050071PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0505DP050071PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0505DP050071PE(val *Acs5ProfilesValuesDP0505DP050071PE) *NullableAcs5ProfilesValuesDP0505DP050071PE {
	return &NullableAcs5ProfilesValuesDP0505DP050071PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0505DP050071PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0505DP050071PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

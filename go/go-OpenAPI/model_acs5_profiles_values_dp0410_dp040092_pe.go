...
// Acs5ProfilesValuesDP0410DP040092PE struct for Acs5ProfilesValuesDP0410DP040092PE
type Acs5ProfilesValuesDP0410DP040092PE struct {
...
type _Acs5ProfilesValuesDP0410DP040092PE Acs5ProfilesValuesDP0410DP040092PE
...
func NewAcs5ProfilesValuesDP0410DP040092PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0410DP040092PE {
	this := Acs5ProfilesValuesDP0410DP040092PE{}
...
func (o Acs5ProfilesValuesDP0410DP040092PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0410DP040092PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0410DP040092PE := _Acs5ProfilesValuesDP0410DP040092PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0410DP040092PE); err == nil {
		*o = Acs5ProfilesValuesDP0410DP040092PE(varAcs5ProfilesValuesDP0410DP040092PE)
	}
...
type NullableAcs5ProfilesValuesDP0410DP040092PE struct {
	value *Acs5ProfilesValuesDP0410DP040092PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0410DP040092PE) Get() *Acs5ProfilesValuesDP0410DP040092PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0410DP040092PE) Set(val *Acs5ProfilesValuesDP0410DP040092PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0410DP040092PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0410DP040092PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0410DP040092PE(val *Acs5ProfilesValuesDP0410DP040092PE) *NullableAcs5ProfilesValuesDP0410DP040092PE {
	return &NullableAcs5ProfilesValuesDP0410DP040092PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0410DP040092PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0410DP040092PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

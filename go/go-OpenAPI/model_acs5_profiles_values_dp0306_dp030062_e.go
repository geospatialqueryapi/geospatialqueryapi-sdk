...
// Acs5ProfilesValuesDP0306DP030062E struct for Acs5ProfilesValuesDP0306DP030062E
type Acs5ProfilesValuesDP0306DP030062E struct {
...
type _Acs5ProfilesValuesDP0306DP030062E Acs5ProfilesValuesDP0306DP030062E
...
func NewAcs5ProfilesValuesDP0306DP030062E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030062E {
	this := Acs5ProfilesValuesDP0306DP030062E{}
...
func (o Acs5ProfilesValuesDP0306DP030062E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030062E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030062E := _Acs5ProfilesValuesDP0306DP030062E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030062E); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030062E(varAcs5ProfilesValuesDP0306DP030062E)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030062E struct {
	value *Acs5ProfilesValuesDP0306DP030062E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030062E) Get() *Acs5ProfilesValuesDP0306DP030062E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030062E) Set(val *Acs5ProfilesValuesDP0306DP030062E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030062E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030062E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030062E(val *Acs5ProfilesValuesDP0306DP030062E) *NullableAcs5ProfilesValuesDP0306DP030062E {
	return &NullableAcs5ProfilesValuesDP0306DP030062E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030062E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030062E) UnmarshalJSON(src []byte) error {
	v.isSet = true

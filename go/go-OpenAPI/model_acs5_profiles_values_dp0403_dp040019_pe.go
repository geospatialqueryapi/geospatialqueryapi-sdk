...
// Acs5ProfilesValuesDP0403DP040019PE struct for Acs5ProfilesValuesDP0403DP040019PE
type Acs5ProfilesValuesDP0403DP040019PE struct {
...
type _Acs5ProfilesValuesDP0403DP040019PE Acs5ProfilesValuesDP0403DP040019PE
...
func NewAcs5ProfilesValuesDP0403DP040019PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040019PE {
	this := Acs5ProfilesValuesDP0403DP040019PE{}
...
func (o Acs5ProfilesValuesDP0403DP040019PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040019PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040019PE := _Acs5ProfilesValuesDP0403DP040019PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040019PE); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040019PE(varAcs5ProfilesValuesDP0403DP040019PE)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040019PE struct {
	value *Acs5ProfilesValuesDP0403DP040019PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040019PE) Get() *Acs5ProfilesValuesDP0403DP040019PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040019PE) Set(val *Acs5ProfilesValuesDP0403DP040019PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040019PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040019PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040019PE(val *Acs5ProfilesValuesDP0403DP040019PE) *NullableAcs5ProfilesValuesDP0403DP040019PE {
	return &NullableAcs5ProfilesValuesDP0403DP040019PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040019PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040019PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

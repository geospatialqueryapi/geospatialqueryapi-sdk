...
// Acs5ProfilesValuesDP0502DP050005E struct for Acs5ProfilesValuesDP0502DP050005E
type Acs5ProfilesValuesDP0502DP050005E struct {
...
type _Acs5ProfilesValuesDP0502DP050005E Acs5ProfilesValuesDP0502DP050005E
...
func NewAcs5ProfilesValuesDP0502DP050005E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0502DP050005E {
	this := Acs5ProfilesValuesDP0502DP050005E{}
...
func (o Acs5ProfilesValuesDP0502DP050005E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0502DP050005E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0502DP050005E := _Acs5ProfilesValuesDP0502DP050005E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0502DP050005E); err == nil {
		*o = Acs5ProfilesValuesDP0502DP050005E(varAcs5ProfilesValuesDP0502DP050005E)
	}
...
type NullableAcs5ProfilesValuesDP0502DP050005E struct {
	value *Acs5ProfilesValuesDP0502DP050005E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0502DP050005E) Get() *Acs5ProfilesValuesDP0502DP050005E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0502DP050005E) Set(val *Acs5ProfilesValuesDP0502DP050005E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0502DP050005E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0502DP050005E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0502DP050005E(val *Acs5ProfilesValuesDP0502DP050005E) *NullableAcs5ProfilesValuesDP0502DP050005E {
	return &NullableAcs5ProfilesValuesDP0502DP050005E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0502DP050005E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0502DP050005E) UnmarshalJSON(src []byte) error {
	v.isSet = true

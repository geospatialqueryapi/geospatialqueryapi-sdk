...
// Acs5ProfilesValuesDP0302DP030025E struct for Acs5ProfilesValuesDP0302DP030025E
type Acs5ProfilesValuesDP0302DP030025E struct {
...
type _Acs5ProfilesValuesDP0302DP030025E Acs5ProfilesValuesDP0302DP030025E
...
func NewAcs5ProfilesValuesDP0302DP030025E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0302DP030025E {
	this := Acs5ProfilesValuesDP0302DP030025E{}
...
func (o Acs5ProfilesValuesDP0302DP030025E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0302DP030025E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0302DP030025E := _Acs5ProfilesValuesDP0302DP030025E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0302DP030025E); err == nil {
		*o = Acs5ProfilesValuesDP0302DP030025E(varAcs5ProfilesValuesDP0302DP030025E)
	}
...
type NullableAcs5ProfilesValuesDP0302DP030025E struct {
	value *Acs5ProfilesValuesDP0302DP030025E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0302DP030025E) Get() *Acs5ProfilesValuesDP0302DP030025E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0302DP030025E) Set(val *Acs5ProfilesValuesDP0302DP030025E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0302DP030025E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0302DP030025E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0302DP030025E(val *Acs5ProfilesValuesDP0302DP030025E) *NullableAcs5ProfilesValuesDP0302DP030025E {
	return &NullableAcs5ProfilesValuesDP0302DP030025E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0302DP030025E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0302DP030025E) UnmarshalJSON(src []byte) error {
	v.isSet = true

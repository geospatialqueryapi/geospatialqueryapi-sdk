...
// Acs5ProfilesValuesDP0504DP050033E struct for Acs5ProfilesValuesDP0504DP050033E
type Acs5ProfilesValuesDP0504DP050033E struct {
...
type _Acs5ProfilesValuesDP0504DP050033E Acs5ProfilesValuesDP0504DP050033E
...
func NewAcs5ProfilesValuesDP0504DP050033E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0504DP050033E {
	this := Acs5ProfilesValuesDP0504DP050033E{}
...
func (o Acs5ProfilesValuesDP0504DP050033E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0504DP050033E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0504DP050033E := _Acs5ProfilesValuesDP0504DP050033E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0504DP050033E); err == nil {
		*o = Acs5ProfilesValuesDP0504DP050033E(varAcs5ProfilesValuesDP0504DP050033E)
	}
...
type NullableAcs5ProfilesValuesDP0504DP050033E struct {
	value *Acs5ProfilesValuesDP0504DP050033E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0504DP050033E) Get() *Acs5ProfilesValuesDP0504DP050033E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0504DP050033E) Set(val *Acs5ProfilesValuesDP0504DP050033E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0504DP050033E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0504DP050033E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0504DP050033E(val *Acs5ProfilesValuesDP0504DP050033E) *NullableAcs5ProfilesValuesDP0504DP050033E {
	return &NullableAcs5ProfilesValuesDP0504DP050033E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0504DP050033E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0504DP050033E) UnmarshalJSON(src []byte) error {
	v.isSet = true

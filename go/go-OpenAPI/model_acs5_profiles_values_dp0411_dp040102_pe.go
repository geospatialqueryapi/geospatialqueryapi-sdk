...
// Acs5ProfilesValuesDP0411DP040102PE struct for Acs5ProfilesValuesDP0411DP040102PE
type Acs5ProfilesValuesDP0411DP040102PE struct {
...
type _Acs5ProfilesValuesDP0411DP040102PE Acs5ProfilesValuesDP0411DP040102PE
...
func NewAcs5ProfilesValuesDP0411DP040102PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0411DP040102PE {
	this := Acs5ProfilesValuesDP0411DP040102PE{}
...
func (o Acs5ProfilesValuesDP0411DP040102PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0411DP040102PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0411DP040102PE := _Acs5ProfilesValuesDP0411DP040102PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0411DP040102PE); err == nil {
		*o = Acs5ProfilesValuesDP0411DP040102PE(varAcs5ProfilesValuesDP0411DP040102PE)
	}
...
type NullableAcs5ProfilesValuesDP0411DP040102PE struct {
	value *Acs5ProfilesValuesDP0411DP040102PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0411DP040102PE) Get() *Acs5ProfilesValuesDP0411DP040102PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0411DP040102PE) Set(val *Acs5ProfilesValuesDP0411DP040102PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0411DP040102PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0411DP040102PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0411DP040102PE(val *Acs5ProfilesValuesDP0411DP040102PE) *NullableAcs5ProfilesValuesDP0411DP040102PE {
	return &NullableAcs5ProfilesValuesDP0411DP040102PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0411DP040102PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0411DP040102PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

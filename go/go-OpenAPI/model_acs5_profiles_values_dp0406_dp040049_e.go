...
// Acs5ProfilesValuesDP0406DP040049E Average household size of renter-occupied unit
type Acs5ProfilesValuesDP0406DP040049E struct {
	// DP04_0049E
...
type _Acs5ProfilesValuesDP0406DP040049E Acs5ProfilesValuesDP0406DP040049E
...
func NewAcs5ProfilesValuesDP0406DP040049E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0406DP040049E {
	this := Acs5ProfilesValuesDP0406DP040049E{}
...
func (o Acs5ProfilesValuesDP0406DP040049E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0406DP040049E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0406DP040049E := _Acs5ProfilesValuesDP0406DP040049E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0406DP040049E); err == nil {
		*o = Acs5ProfilesValuesDP0406DP040049E(varAcs5ProfilesValuesDP0406DP040049E)
	}
...
type NullableAcs5ProfilesValuesDP0406DP040049E struct {
	value *Acs5ProfilesValuesDP0406DP040049E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0406DP040049E) Get() *Acs5ProfilesValuesDP0406DP040049E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0406DP040049E) Set(val *Acs5ProfilesValuesDP0406DP040049E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0406DP040049E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0406DP040049E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0406DP040049E(val *Acs5ProfilesValuesDP0406DP040049E) *NullableAcs5ProfilesValuesDP0406DP040049E {
	return &NullableAcs5ProfilesValuesDP0406DP040049E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0406DP040049E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0406DP040049E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0301DP030009PE struct for Acs5ProfilesValuesDP0301DP030009PE
...
type _Acs5ProfilesValuesDP0301DP030009PE Acs5ProfilesValuesDP0301DP030009PE
...
func NewAcs5ProfilesValuesDP0301DP030009PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0301DP030009PE {
	this := Acs5ProfilesValuesDP0301DP030009PE{}
...
func (o Acs5ProfilesValuesDP0301DP030009PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0301DP030009PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0301DP030009PE := _Acs5ProfilesValuesDP0301DP030009PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0301DP030009PE); err == nil {
		*o = Acs5ProfilesValuesDP0301DP030009PE(varAcs5ProfilesValuesDP0301DP030009PE)
	}
...
type NullableAcs5ProfilesValuesDP0301DP030009PE struct {
	value *Acs5ProfilesValuesDP0301DP030009PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0301DP030009PE) Get() *Acs5ProfilesValuesDP0301DP030009PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0301DP030009PE) Set(val *Acs5ProfilesValuesDP0301DP030009PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0301DP030009PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0301DP030009PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0301DP030009PE(val *Acs5ProfilesValuesDP0301DP030009PE) *NullableAcs5ProfilesValuesDP0301DP030009PE {
	return &NullableAcs5ProfilesValuesDP0301DP030009PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0301DP030009PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0301DP030009PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

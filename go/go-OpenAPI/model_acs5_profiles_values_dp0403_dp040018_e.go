...
// Acs5ProfilesValuesDP0403DP040018E struct for Acs5ProfilesValuesDP0403DP040018E
type Acs5ProfilesValuesDP0403DP040018E struct {
...
type _Acs5ProfilesValuesDP0403DP040018E Acs5ProfilesValuesDP0403DP040018E
...
func NewAcs5ProfilesValuesDP0403DP040018E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040018E {
	this := Acs5ProfilesValuesDP0403DP040018E{}
...
func (o Acs5ProfilesValuesDP0403DP040018E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040018E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040018E := _Acs5ProfilesValuesDP0403DP040018E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040018E); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040018E(varAcs5ProfilesValuesDP0403DP040018E)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040018E struct {
	value *Acs5ProfilesValuesDP0403DP040018E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040018E) Get() *Acs5ProfilesValuesDP0403DP040018E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040018E) Set(val *Acs5ProfilesValuesDP0403DP040018E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040018E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040018E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040018E(val *Acs5ProfilesValuesDP0403DP040018E) *NullableAcs5ProfilesValuesDP0403DP040018E {
	return &NullableAcs5ProfilesValuesDP0403DP040018E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040018E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040018E) UnmarshalJSON(src []byte) error {
	v.isSet = true

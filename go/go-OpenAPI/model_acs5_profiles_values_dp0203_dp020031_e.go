...
// Acs5ProfilesValuesDP0203DP020031E struct for Acs5ProfilesValuesDP0203DP020031E
type Acs5ProfilesValuesDP0203DP020031E struct {
...
type _Acs5ProfilesValuesDP0203DP020031E Acs5ProfilesValuesDP0203DP020031E
...
func NewAcs5ProfilesValuesDP0203DP020031E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0203DP020031E {
	this := Acs5ProfilesValuesDP0203DP020031E{}
...
func (o Acs5ProfilesValuesDP0203DP020031E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0203DP020031E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0203DP020031E := _Acs5ProfilesValuesDP0203DP020031E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0203DP020031E); err == nil {
		*o = Acs5ProfilesValuesDP0203DP020031E(varAcs5ProfilesValuesDP0203DP020031E)
	}
...
type NullableAcs5ProfilesValuesDP0203DP020031E struct {
	value *Acs5ProfilesValuesDP0203DP020031E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0203DP020031E) Get() *Acs5ProfilesValuesDP0203DP020031E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0203DP020031E) Set(val *Acs5ProfilesValuesDP0203DP020031E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0203DP020031E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0203DP020031E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0203DP020031E(val *Acs5ProfilesValuesDP0203DP020031E) *NullableAcs5ProfilesValuesDP0203DP020031E {
	return &NullableAcs5ProfilesValuesDP0203DP020031E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0203DP020031E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0203DP020031E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0408DP040058PE struct for Acs5ProfilesValuesDP0408DP040058PE
type Acs5ProfilesValuesDP0408DP040058PE struct {
...
type _Acs5ProfilesValuesDP0408DP040058PE Acs5ProfilesValuesDP0408DP040058PE
...
func NewAcs5ProfilesValuesDP0408DP040058PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0408DP040058PE {
	this := Acs5ProfilesValuesDP0408DP040058PE{}
...
func (o Acs5ProfilesValuesDP0408DP040058PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0408DP040058PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0408DP040058PE := _Acs5ProfilesValuesDP0408DP040058PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0408DP040058PE); err == nil {
		*o = Acs5ProfilesValuesDP0408DP040058PE(varAcs5ProfilesValuesDP0408DP040058PE)
	}
...
type NullableAcs5ProfilesValuesDP0408DP040058PE struct {
	value *Acs5ProfilesValuesDP0408DP040058PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0408DP040058PE) Get() *Acs5ProfilesValuesDP0408DP040058PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0408DP040058PE) Set(val *Acs5ProfilesValuesDP0408DP040058PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0408DP040058PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0408DP040058PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0408DP040058PE(val *Acs5ProfilesValuesDP0408DP040058PE) *NullableAcs5ProfilesValuesDP0408DP040058PE {
	return &NullableAcs5ProfilesValuesDP0408DP040058PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0408DP040058PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0408DP040058PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

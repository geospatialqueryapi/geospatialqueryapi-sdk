...
// Acs5ProfilesValuesDP0409DP040086PE struct for Acs5ProfilesValuesDP0409DP040086PE
type Acs5ProfilesValuesDP0409DP040086PE struct {
...
type _Acs5ProfilesValuesDP0409DP040086PE Acs5ProfilesValuesDP0409DP040086PE
...
func NewAcs5ProfilesValuesDP0409DP040086PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0409DP040086PE {
	this := Acs5ProfilesValuesDP0409DP040086PE{}
...
func (o Acs5ProfilesValuesDP0409DP040086PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0409DP040086PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0409DP040086PE := _Acs5ProfilesValuesDP0409DP040086PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0409DP040086PE); err == nil {
		*o = Acs5ProfilesValuesDP0409DP040086PE(varAcs5ProfilesValuesDP0409DP040086PE)
	}
...
type NullableAcs5ProfilesValuesDP0409DP040086PE struct {
	value *Acs5ProfilesValuesDP0409DP040086PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0409DP040086PE) Get() *Acs5ProfilesValuesDP0409DP040086PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0409DP040086PE) Set(val *Acs5ProfilesValuesDP0409DP040086PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0409DP040086PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0409DP040086PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0409DP040086PE(val *Acs5ProfilesValuesDP0409DP040086PE) *NullableAcs5ProfilesValuesDP0409DP040086PE {
	return &NullableAcs5ProfilesValuesDP0409DP040086PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0409DP040086PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0409DP040086PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

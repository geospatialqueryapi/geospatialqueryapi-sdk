...
// Acs5ProfilesValuesDP0403DP040024E struct for Acs5ProfilesValuesDP0403DP040024E
type Acs5ProfilesValuesDP0403DP040024E struct {
...
type _Acs5ProfilesValuesDP0403DP040024E Acs5ProfilesValuesDP0403DP040024E
...
func NewAcs5ProfilesValuesDP0403DP040024E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040024E {
	this := Acs5ProfilesValuesDP0403DP040024E{}
...
func (o Acs5ProfilesValuesDP0403DP040024E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040024E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040024E := _Acs5ProfilesValuesDP0403DP040024E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040024E); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040024E(varAcs5ProfilesValuesDP0403DP040024E)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040024E struct {
	value *Acs5ProfilesValuesDP0403DP040024E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040024E) Get() *Acs5ProfilesValuesDP0403DP040024E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040024E) Set(val *Acs5ProfilesValuesDP0403DP040024E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040024E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040024E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040024E(val *Acs5ProfilesValuesDP0403DP040024E) *NullableAcs5ProfilesValuesDP0403DP040024E {
	return &NullableAcs5ProfilesValuesDP0403DP040024E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040024E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040024E) UnmarshalJSON(src []byte) error {
	v.isSet = true

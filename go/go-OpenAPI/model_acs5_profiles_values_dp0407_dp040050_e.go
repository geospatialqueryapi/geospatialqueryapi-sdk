...
// Acs5ProfilesValuesDP0407DP040050E struct for Acs5ProfilesValuesDP0407DP040050E
type Acs5ProfilesValuesDP0407DP040050E struct {
...
type _Acs5ProfilesValuesDP0407DP040050E Acs5ProfilesValuesDP0407DP040050E
...
func NewAcs5ProfilesValuesDP0407DP040050E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0407DP040050E {
	this := Acs5ProfilesValuesDP0407DP040050E{}
...
func (o Acs5ProfilesValuesDP0407DP040050E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0407DP040050E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0407DP040050E := _Acs5ProfilesValuesDP0407DP040050E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0407DP040050E); err == nil {
		*o = Acs5ProfilesValuesDP0407DP040050E(varAcs5ProfilesValuesDP0407DP040050E)
	}
...
type NullableAcs5ProfilesValuesDP0407DP040050E struct {
	value *Acs5ProfilesValuesDP0407DP040050E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0407DP040050E) Get() *Acs5ProfilesValuesDP0407DP040050E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0407DP040050E) Set(val *Acs5ProfilesValuesDP0407DP040050E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0407DP040050E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0407DP040050E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0407DP040050E(val *Acs5ProfilesValuesDP0407DP040050E) *NullableAcs5ProfilesValuesDP0407DP040050E {
	return &NullableAcs5ProfilesValuesDP0407DP040050E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0407DP040050E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0407DP040050E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0204DP020038E Unmarried women (widowed, divorced, and never married)
type Acs5ProfilesValuesDP0204DP020038E struct {
	// DP02_0038E
...
type _Acs5ProfilesValuesDP0204DP020038E Acs5ProfilesValuesDP0204DP020038E
...
func NewAcs5ProfilesValuesDP0204DP020038E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0204DP020038E {
	this := Acs5ProfilesValuesDP0204DP020038E{}
...
func (o Acs5ProfilesValuesDP0204DP020038E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0204DP020038E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0204DP020038E := _Acs5ProfilesValuesDP0204DP020038E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0204DP020038E); err == nil {
		*o = Acs5ProfilesValuesDP0204DP020038E(varAcs5ProfilesValuesDP0204DP020038E)
	}
...
type NullableAcs5ProfilesValuesDP0204DP020038E struct {
	value *Acs5ProfilesValuesDP0204DP020038E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0204DP020038E) Get() *Acs5ProfilesValuesDP0204DP020038E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0204DP020038E) Set(val *Acs5ProfilesValuesDP0204DP020038E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0204DP020038E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0204DP020038E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0204DP020038E(val *Acs5ProfilesValuesDP0204DP020038E) *NullableAcs5ProfilesValuesDP0204DP020038E {
	return &NullableAcs5ProfilesValuesDP0204DP020038E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0204DP020038E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0204DP020038E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0401DP040003PE struct for Acs5ProfilesValuesDP0401DP040003PE
type Acs5ProfilesValuesDP0401DP040003PE struct {
...
type _Acs5ProfilesValuesDP0401DP040003PE Acs5ProfilesValuesDP0401DP040003PE
...
func NewAcs5ProfilesValuesDP0401DP040003PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0401DP040003PE {
	this := Acs5ProfilesValuesDP0401DP040003PE{}
...
func (o Acs5ProfilesValuesDP0401DP040003PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0401DP040003PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0401DP040003PE := _Acs5ProfilesValuesDP0401DP040003PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0401DP040003PE); err == nil {
		*o = Acs5ProfilesValuesDP0401DP040003PE(varAcs5ProfilesValuesDP0401DP040003PE)
	}
...
type NullableAcs5ProfilesValuesDP0401DP040003PE struct {
	value *Acs5ProfilesValuesDP0401DP040003PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0401DP040003PE) Get() *Acs5ProfilesValuesDP0401DP040003PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0401DP040003PE) Set(val *Acs5ProfilesValuesDP0401DP040003PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0401DP040003PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0401DP040003PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0401DP040003PE(val *Acs5ProfilesValuesDP0401DP040003PE) *NullableAcs5ProfilesValuesDP0401DP040003PE {
	return &NullableAcs5ProfilesValuesDP0401DP040003PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0401DP040003PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0401DP040003PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

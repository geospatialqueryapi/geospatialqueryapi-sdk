...
// Acs5ProfilesValuesDP0410DP040093E struct for Acs5ProfilesValuesDP0410DP040093E
type Acs5ProfilesValuesDP0410DP040093E struct {
...
type _Acs5ProfilesValuesDP0410DP040093E Acs5ProfilesValuesDP0410DP040093E
...
func NewAcs5ProfilesValuesDP0410DP040093E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0410DP040093E {
	this := Acs5ProfilesValuesDP0410DP040093E{}
...
func (o Acs5ProfilesValuesDP0410DP040093E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0410DP040093E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0410DP040093E := _Acs5ProfilesValuesDP0410DP040093E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0410DP040093E); err == nil {
		*o = Acs5ProfilesValuesDP0410DP040093E(varAcs5ProfilesValuesDP0410DP040093E)
	}
...
type NullableAcs5ProfilesValuesDP0410DP040093E struct {
	value *Acs5ProfilesValuesDP0410DP040093E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0410DP040093E) Get() *Acs5ProfilesValuesDP0410DP040093E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0410DP040093E) Set(val *Acs5ProfilesValuesDP0410DP040093E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0410DP040093E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0410DP040093E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0410DP040093E(val *Acs5ProfilesValuesDP0410DP040093E) *NullableAcs5ProfilesValuesDP0410DP040093E {
	return &NullableAcs5ProfilesValuesDP0410DP040093E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0410DP040093E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0410DP040093E) UnmarshalJSON(src []byte) error {
	v.isSet = true

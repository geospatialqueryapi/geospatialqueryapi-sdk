...
// Acs5ProfilesValuesDP0207DP020064PE Population 25 years and over: Associate's degree (percent)
type Acs5ProfilesValuesDP0207DP020064PE struct {
	// DP02_0064PE
...
type _Acs5ProfilesValuesDP0207DP020064PE Acs5ProfilesValuesDP0207DP020064PE
...
func NewAcs5ProfilesValuesDP0207DP020064PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0207DP020064PE {
	this := Acs5ProfilesValuesDP0207DP020064PE{}
...
func (o Acs5ProfilesValuesDP0207DP020064PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0207DP020064PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0207DP020064PE := _Acs5ProfilesValuesDP0207DP020064PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0207DP020064PE); err == nil {
		*o = Acs5ProfilesValuesDP0207DP020064PE(varAcs5ProfilesValuesDP0207DP020064PE)
	}
...
type NullableAcs5ProfilesValuesDP0207DP020064PE struct {
	value *Acs5ProfilesValuesDP0207DP020064PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0207DP020064PE) Get() *Acs5ProfilesValuesDP0207DP020064PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0207DP020064PE) Set(val *Acs5ProfilesValuesDP0207DP020064PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0207DP020064PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0207DP020064PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0207DP020064PE(val *Acs5ProfilesValuesDP0207DP020064PE) *NullableAcs5ProfilesValuesDP0207DP020064PE {
	return &NullableAcs5ProfilesValuesDP0207DP020064PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0207DP020064PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0207DP020064PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0305DP030046E Class of worker: Civilian employed population 16 years and over
type Acs5ProfilesValuesDP0305DP030046E struct {
	// DP03_0046E
...
type _Acs5ProfilesValuesDP0305DP030046E Acs5ProfilesValuesDP0305DP030046E
...
func NewAcs5ProfilesValuesDP0305DP030046E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0305DP030046E {
	this := Acs5ProfilesValuesDP0305DP030046E{}
...
func (o Acs5ProfilesValuesDP0305DP030046E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0305DP030046E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0305DP030046E := _Acs5ProfilesValuesDP0305DP030046E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0305DP030046E); err == nil {
		*o = Acs5ProfilesValuesDP0305DP030046E(varAcs5ProfilesValuesDP0305DP030046E)
	}
...
type NullableAcs5ProfilesValuesDP0305DP030046E struct {
	value *Acs5ProfilesValuesDP0305DP030046E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0305DP030046E) Get() *Acs5ProfilesValuesDP0305DP030046E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0305DP030046E) Set(val *Acs5ProfilesValuesDP0305DP030046E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0305DP030046E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0305DP030046E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0305DP030046E(val *Acs5ProfilesValuesDP0305DP030046E) *NullableAcs5ProfilesValuesDP0305DP030046E {
	return &NullableAcs5ProfilesValuesDP0305DP030046E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0305DP030046E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0305DP030046E) UnmarshalJSON(src []byte) error {
	v.isSet = true

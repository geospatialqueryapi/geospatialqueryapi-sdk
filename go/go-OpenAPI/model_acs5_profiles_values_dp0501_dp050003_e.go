...
// Acs5ProfilesValuesDP0501DP050003E struct for Acs5ProfilesValuesDP0501DP050003E
type Acs5ProfilesValuesDP0501DP050003E struct {
...
type _Acs5ProfilesValuesDP0501DP050003E Acs5ProfilesValuesDP0501DP050003E
...
func NewAcs5ProfilesValuesDP0501DP050003E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0501DP050003E {
	this := Acs5ProfilesValuesDP0501DP050003E{}
...
func (o Acs5ProfilesValuesDP0501DP050003E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0501DP050003E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0501DP050003E := _Acs5ProfilesValuesDP0501DP050003E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0501DP050003E); err == nil {
		*o = Acs5ProfilesValuesDP0501DP050003E(varAcs5ProfilesValuesDP0501DP050003E)
	}
...
type NullableAcs5ProfilesValuesDP0501DP050003E struct {
	value *Acs5ProfilesValuesDP0501DP050003E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0501DP050003E) Get() *Acs5ProfilesValuesDP0501DP050003E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0501DP050003E) Set(val *Acs5ProfilesValuesDP0501DP050003E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0501DP050003E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0501DP050003E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0501DP050003E(val *Acs5ProfilesValuesDP0501DP050003E) *NullableAcs5ProfilesValuesDP0501DP050003E {
	return &NullableAcs5ProfilesValuesDP0501DP050003E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0501DP050003E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0501DP050003E) UnmarshalJSON(src []byte) error {
	v.isSet = true

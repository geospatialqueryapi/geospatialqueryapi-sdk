...
// Acs5ProfilesValuesDP0303DP030030PE Natural resources, construction, and maintenance occupations (percent)
type Acs5ProfilesValuesDP0303DP030030PE struct {
	// DP03_0030PE
...
type _Acs5ProfilesValuesDP0303DP030030PE Acs5ProfilesValuesDP0303DP030030PE
...
func NewAcs5ProfilesValuesDP0303DP030030PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0303DP030030PE {
	this := Acs5ProfilesValuesDP0303DP030030PE{}
...
func (o Acs5ProfilesValuesDP0303DP030030PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0303DP030030PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0303DP030030PE := _Acs5ProfilesValuesDP0303DP030030PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0303DP030030PE); err == nil {
		*o = Acs5ProfilesValuesDP0303DP030030PE(varAcs5ProfilesValuesDP0303DP030030PE)
	}
...
type NullableAcs5ProfilesValuesDP0303DP030030PE struct {
	value *Acs5ProfilesValuesDP0303DP030030PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0303DP030030PE) Get() *Acs5ProfilesValuesDP0303DP030030PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0303DP030030PE) Set(val *Acs5ProfilesValuesDP0303DP030030PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0303DP030030PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0303DP030030PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0303DP030030PE(val *Acs5ProfilesValuesDP0303DP030030PE) *NullableAcs5ProfilesValuesDP0303DP030030PE {
	return &NullableAcs5ProfilesValuesDP0303DP030030PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0303DP030030PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0303DP030030PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

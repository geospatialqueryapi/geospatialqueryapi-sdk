...
// Acs5ProfilesValuesDP0409DP040082PE struct for Acs5ProfilesValuesDP0409DP040082PE
type Acs5ProfilesValuesDP0409DP040082PE struct {
...
type _Acs5ProfilesValuesDP0409DP040082PE Acs5ProfilesValuesDP0409DP040082PE
...
func NewAcs5ProfilesValuesDP0409DP040082PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0409DP040082PE {
	this := Acs5ProfilesValuesDP0409DP040082PE{}
...
func (o Acs5ProfilesValuesDP0409DP040082PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0409DP040082PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0409DP040082PE := _Acs5ProfilesValuesDP0409DP040082PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0409DP040082PE); err == nil {
		*o = Acs5ProfilesValuesDP0409DP040082PE(varAcs5ProfilesValuesDP0409DP040082PE)
	}
...
type NullableAcs5ProfilesValuesDP0409DP040082PE struct {
	value *Acs5ProfilesValuesDP0409DP040082PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0409DP040082PE) Get() *Acs5ProfilesValuesDP0409DP040082PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0409DP040082PE) Set(val *Acs5ProfilesValuesDP0409DP040082PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0409DP040082PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0409DP040082PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0409DP040082PE(val *Acs5ProfilesValuesDP0409DP040082PE) *NullableAcs5ProfilesValuesDP0409DP040082PE {
	return &NullableAcs5ProfilesValuesDP0409DP040082PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0409DP040082PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0409DP040082PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0410DP040092E struct for Acs5ProfilesValuesDP0410DP040092E
type Acs5ProfilesValuesDP0410DP040092E struct {
...
type _Acs5ProfilesValuesDP0410DP040092E Acs5ProfilesValuesDP0410DP040092E
...
func NewAcs5ProfilesValuesDP0410DP040092E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0410DP040092E {
	this := Acs5ProfilesValuesDP0410DP040092E{}
...
func (o Acs5ProfilesValuesDP0410DP040092E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0410DP040092E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0410DP040092E := _Acs5ProfilesValuesDP0410DP040092E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0410DP040092E); err == nil {
		*o = Acs5ProfilesValuesDP0410DP040092E(varAcs5ProfilesValuesDP0410DP040092E)
	}
...
type NullableAcs5ProfilesValuesDP0410DP040092E struct {
	value *Acs5ProfilesValuesDP0410DP040092E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0410DP040092E) Get() *Acs5ProfilesValuesDP0410DP040092E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0410DP040092E) Set(val *Acs5ProfilesValuesDP0410DP040092E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0410DP040092E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0410DP040092E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0410DP040092E(val *Acs5ProfilesValuesDP0410DP040092E) *NullableAcs5ProfilesValuesDP0410DP040092E {
	return &NullableAcs5ProfilesValuesDP0410DP040092E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0410DP040092E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0410DP040092E) UnmarshalJSON(src []byte) error {
	v.isSet = true

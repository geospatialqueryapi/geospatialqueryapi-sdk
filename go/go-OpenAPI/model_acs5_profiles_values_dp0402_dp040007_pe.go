...
// Acs5ProfilesValuesDP0402DP040007PE struct for Acs5ProfilesValuesDP0402DP040007PE
type Acs5ProfilesValuesDP0402DP040007PE struct {
...
type _Acs5ProfilesValuesDP0402DP040007PE Acs5ProfilesValuesDP0402DP040007PE
...
func NewAcs5ProfilesValuesDP0402DP040007PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040007PE {
	this := Acs5ProfilesValuesDP0402DP040007PE{}
...
func (o Acs5ProfilesValuesDP0402DP040007PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040007PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040007PE := _Acs5ProfilesValuesDP0402DP040007PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040007PE); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040007PE(varAcs5ProfilesValuesDP0402DP040007PE)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040007PE struct {
	value *Acs5ProfilesValuesDP0402DP040007PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040007PE) Get() *Acs5ProfilesValuesDP0402DP040007PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040007PE) Set(val *Acs5ProfilesValuesDP0402DP040007PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040007PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040007PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040007PE(val *Acs5ProfilesValuesDP0402DP040007PE) *NullableAcs5ProfilesValuesDP0402DP040007PE {
	return &NullableAcs5ProfilesValuesDP0402DP040007PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040007PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040007PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

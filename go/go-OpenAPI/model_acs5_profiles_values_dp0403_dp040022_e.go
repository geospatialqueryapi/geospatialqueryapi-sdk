...
// Acs5ProfilesValuesDP0403DP040022E struct for Acs5ProfilesValuesDP0403DP040022E
type Acs5ProfilesValuesDP0403DP040022E struct {
...
type _Acs5ProfilesValuesDP0403DP040022E Acs5ProfilesValuesDP0403DP040022E
...
func NewAcs5ProfilesValuesDP0403DP040022E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040022E {
	this := Acs5ProfilesValuesDP0403DP040022E{}
...
func (o Acs5ProfilesValuesDP0403DP040022E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040022E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040022E := _Acs5ProfilesValuesDP0403DP040022E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040022E); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040022E(varAcs5ProfilesValuesDP0403DP040022E)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040022E struct {
	value *Acs5ProfilesValuesDP0403DP040022E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040022E) Get() *Acs5ProfilesValuesDP0403DP040022E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040022E) Set(val *Acs5ProfilesValuesDP0403DP040022E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040022E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040022E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040022E(val *Acs5ProfilesValuesDP0403DP040022E) *NullableAcs5ProfilesValuesDP0403DP040022E {
	return &NullableAcs5ProfilesValuesDP0403DP040022E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040022E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040022E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0209DP020083E Population 1 year and over- Different house in the U.S.: Different county
type Acs5ProfilesValuesDP0209DP020083E struct {
	// DP02_0083E
...
type _Acs5ProfilesValuesDP0209DP020083E Acs5ProfilesValuesDP0209DP020083E
...
func NewAcs5ProfilesValuesDP0209DP020083E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0209DP020083E {
	this := Acs5ProfilesValuesDP0209DP020083E{}
...
func (o Acs5ProfilesValuesDP0209DP020083E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0209DP020083E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0209DP020083E := _Acs5ProfilesValuesDP0209DP020083E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0209DP020083E); err == nil {
		*o = Acs5ProfilesValuesDP0209DP020083E(varAcs5ProfilesValuesDP0209DP020083E)
	}
...
type NullableAcs5ProfilesValuesDP0209DP020083E struct {
	value *Acs5ProfilesValuesDP0209DP020083E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0209DP020083E) Get() *Acs5ProfilesValuesDP0209DP020083E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0209DP020083E) Set(val *Acs5ProfilesValuesDP0209DP020083E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0209DP020083E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0209DP020083E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0209DP020083E(val *Acs5ProfilesValuesDP0209DP020083E) *NullableAcs5ProfilesValuesDP0209DP020083E {
	return &NullableAcs5ProfilesValuesDP0209DP020083E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0209DP020083E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0209DP020083E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0403DP040016E struct for Acs5ProfilesValuesDP0403DP040016E
type Acs5ProfilesValuesDP0403DP040016E struct {
...
type _Acs5ProfilesValuesDP0403DP040016E Acs5ProfilesValuesDP0403DP040016E
...
func NewAcs5ProfilesValuesDP0403DP040016E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040016E {
	this := Acs5ProfilesValuesDP0403DP040016E{}
...
func (o Acs5ProfilesValuesDP0403DP040016E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040016E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040016E := _Acs5ProfilesValuesDP0403DP040016E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040016E); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040016E(varAcs5ProfilesValuesDP0403DP040016E)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040016E struct {
	value *Acs5ProfilesValuesDP0403DP040016E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040016E) Get() *Acs5ProfilesValuesDP0403DP040016E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040016E) Set(val *Acs5ProfilesValuesDP0403DP040016E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040016E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040016E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040016E(val *Acs5ProfilesValuesDP0403DP040016E) *NullableAcs5ProfilesValuesDP0403DP040016E {
	return &NullableAcs5ProfilesValuesDP0403DP040016E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040016E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040016E) UnmarshalJSON(src []byte) error {
	v.isSet = true

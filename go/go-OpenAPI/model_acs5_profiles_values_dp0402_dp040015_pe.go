...
// Acs5ProfilesValuesDP0402DP040015PE struct for Acs5ProfilesValuesDP0402DP040015PE
type Acs5ProfilesValuesDP0402DP040015PE struct {
...
type _Acs5ProfilesValuesDP0402DP040015PE Acs5ProfilesValuesDP0402DP040015PE
...
func NewAcs5ProfilesValuesDP0402DP040015PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040015PE {
	this := Acs5ProfilesValuesDP0402DP040015PE{}
...
func (o Acs5ProfilesValuesDP0402DP040015PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040015PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040015PE := _Acs5ProfilesValuesDP0402DP040015PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040015PE); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040015PE(varAcs5ProfilesValuesDP0402DP040015PE)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040015PE struct {
	value *Acs5ProfilesValuesDP0402DP040015PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040015PE) Get() *Acs5ProfilesValuesDP0402DP040015PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040015PE) Set(val *Acs5ProfilesValuesDP0402DP040015PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040015PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040015PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040015PE(val *Acs5ProfilesValuesDP0402DP040015PE) *NullableAcs5ProfilesValuesDP0402DP040015PE {
	return &NullableAcs5ProfilesValuesDP0402DP040015PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040015PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040015PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

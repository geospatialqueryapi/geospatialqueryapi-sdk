...
// Acs5ProfilesValuesDP0407DP040051E struct for Acs5ProfilesValuesDP0407DP040051E
type Acs5ProfilesValuesDP0407DP040051E struct {
...
type _Acs5ProfilesValuesDP0407DP040051E Acs5ProfilesValuesDP0407DP040051E
...
func NewAcs5ProfilesValuesDP0407DP040051E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0407DP040051E {
	this := Acs5ProfilesValuesDP0407DP040051E{}
...
func (o Acs5ProfilesValuesDP0407DP040051E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0407DP040051E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0407DP040051E := _Acs5ProfilesValuesDP0407DP040051E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0407DP040051E); err == nil {
		*o = Acs5ProfilesValuesDP0407DP040051E(varAcs5ProfilesValuesDP0407DP040051E)
	}
...
type NullableAcs5ProfilesValuesDP0407DP040051E struct {
	value *Acs5ProfilesValuesDP0407DP040051E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0407DP040051E) Get() *Acs5ProfilesValuesDP0407DP040051E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0407DP040051E) Set(val *Acs5ProfilesValuesDP0407DP040051E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0407DP040051E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0407DP040051E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0407DP040051E(val *Acs5ProfilesValuesDP0407DP040051E) *NullableAcs5ProfilesValuesDP0407DP040051E {
	return &NullableAcs5ProfilesValuesDP0407DP040051E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0407DP040051E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0407DP040051E) UnmarshalJSON(src []byte) error {
	v.isSet = true

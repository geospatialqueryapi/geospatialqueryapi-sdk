...
// Acs5ProfilesValuesDP0402DP040008PE struct for Acs5ProfilesValuesDP0402DP040008PE
type Acs5ProfilesValuesDP0402DP040008PE struct {
...
type _Acs5ProfilesValuesDP0402DP040008PE Acs5ProfilesValuesDP0402DP040008PE
...
func NewAcs5ProfilesValuesDP0402DP040008PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040008PE {
	this := Acs5ProfilesValuesDP0402DP040008PE{}
...
func (o Acs5ProfilesValuesDP0402DP040008PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040008PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040008PE := _Acs5ProfilesValuesDP0402DP040008PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040008PE); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040008PE(varAcs5ProfilesValuesDP0402DP040008PE)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040008PE struct {
	value *Acs5ProfilesValuesDP0402DP040008PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040008PE) Get() *Acs5ProfilesValuesDP0402DP040008PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040008PE) Set(val *Acs5ProfilesValuesDP0402DP040008PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040008PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040008PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040008PE(val *Acs5ProfilesValuesDP0402DP040008PE) *NullableAcs5ProfilesValuesDP0402DP040008PE {
	return &NullableAcs5ProfilesValuesDP0402DP040008PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040008PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040008PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

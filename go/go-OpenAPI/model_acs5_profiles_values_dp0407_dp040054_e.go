...
// Acs5ProfilesValuesDP0407DP040054E struct for Acs5ProfilesValuesDP0407DP040054E
type Acs5ProfilesValuesDP0407DP040054E struct {
...
type _Acs5ProfilesValuesDP0407DP040054E Acs5ProfilesValuesDP0407DP040054E
...
func NewAcs5ProfilesValuesDP0407DP040054E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0407DP040054E {
	this := Acs5ProfilesValuesDP0407DP040054E{}
...
func (o Acs5ProfilesValuesDP0407DP040054E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0407DP040054E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0407DP040054E := _Acs5ProfilesValuesDP0407DP040054E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0407DP040054E); err == nil {
		*o = Acs5ProfilesValuesDP0407DP040054E(varAcs5ProfilesValuesDP0407DP040054E)
	}
...
type NullableAcs5ProfilesValuesDP0407DP040054E struct {
	value *Acs5ProfilesValuesDP0407DP040054E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0407DP040054E) Get() *Acs5ProfilesValuesDP0407DP040054E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0407DP040054E) Set(val *Acs5ProfilesValuesDP0407DP040054E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0407DP040054E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0407DP040054E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0407DP040054E(val *Acs5ProfilesValuesDP0407DP040054E) *NullableAcs5ProfilesValuesDP0407DP040054E {
	return &NullableAcs5ProfilesValuesDP0407DP040054E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0407DP040054E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0407DP040054E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0406DP040046E struct for Acs5ProfilesValuesDP0406DP040046E
type Acs5ProfilesValuesDP0406DP040046E struct {
...
type _Acs5ProfilesValuesDP0406DP040046E Acs5ProfilesValuesDP0406DP040046E
...
func NewAcs5ProfilesValuesDP0406DP040046E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0406DP040046E {
	this := Acs5ProfilesValuesDP0406DP040046E{}
...
func (o Acs5ProfilesValuesDP0406DP040046E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0406DP040046E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0406DP040046E := _Acs5ProfilesValuesDP0406DP040046E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0406DP040046E); err == nil {
		*o = Acs5ProfilesValuesDP0406DP040046E(varAcs5ProfilesValuesDP0406DP040046E)
	}
...
type NullableAcs5ProfilesValuesDP0406DP040046E struct {
	value *Acs5ProfilesValuesDP0406DP040046E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0406DP040046E) Get() *Acs5ProfilesValuesDP0406DP040046E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0406DP040046E) Set(val *Acs5ProfilesValuesDP0406DP040046E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0406DP040046E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0406DP040046E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0406DP040046E(val *Acs5ProfilesValuesDP0406DP040046E) *NullableAcs5ProfilesValuesDP0406DP040046E {
	return &NullableAcs5ProfilesValuesDP0406DP040046E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0406DP040046E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0406DP040046E) UnmarshalJSON(src []byte) error {
	v.isSet = true

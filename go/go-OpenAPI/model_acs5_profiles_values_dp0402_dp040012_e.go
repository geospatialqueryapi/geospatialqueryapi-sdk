...
// Acs5ProfilesValuesDP0402DP040012E struct for Acs5ProfilesValuesDP0402DP040012E
type Acs5ProfilesValuesDP0402DP040012E struct {
...
type _Acs5ProfilesValuesDP0402DP040012E Acs5ProfilesValuesDP0402DP040012E
...
func NewAcs5ProfilesValuesDP0402DP040012E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040012E {
	this := Acs5ProfilesValuesDP0402DP040012E{}
...
func (o Acs5ProfilesValuesDP0402DP040012E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040012E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040012E := _Acs5ProfilesValuesDP0402DP040012E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040012E); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040012E(varAcs5ProfilesValuesDP0402DP040012E)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040012E struct {
	value *Acs5ProfilesValuesDP0402DP040012E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040012E) Get() *Acs5ProfilesValuesDP0402DP040012E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040012E) Set(val *Acs5ProfilesValuesDP0402DP040012E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040012E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040012E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040012E(val *Acs5ProfilesValuesDP0402DP040012E) *NullableAcs5ProfilesValuesDP0402DP040012E {
	return &NullableAcs5ProfilesValuesDP0402DP040012E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040012E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040012E) UnmarshalJSON(src []byte) error {
	v.isSet = true

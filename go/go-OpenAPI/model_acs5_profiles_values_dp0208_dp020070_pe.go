...
// Acs5ProfilesValuesDP0208DP020070PE struct for Acs5ProfilesValuesDP0208DP020070PE
type Acs5ProfilesValuesDP0208DP020070PE struct {
...
type _Acs5ProfilesValuesDP0208DP020070PE Acs5ProfilesValuesDP0208DP020070PE
...
func NewAcs5ProfilesValuesDP0208DP020070PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0208DP020070PE {
	this := Acs5ProfilesValuesDP0208DP020070PE{}
...
func (o Acs5ProfilesValuesDP0208DP020070PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0208DP020070PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0208DP020070PE := _Acs5ProfilesValuesDP0208DP020070PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0208DP020070PE); err == nil {
		*o = Acs5ProfilesValuesDP0208DP020070PE(varAcs5ProfilesValuesDP0208DP020070PE)
	}
...
type NullableAcs5ProfilesValuesDP0208DP020070PE struct {
	value *Acs5ProfilesValuesDP0208DP020070PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0208DP020070PE) Get() *Acs5ProfilesValuesDP0208DP020070PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0208DP020070PE) Set(val *Acs5ProfilesValuesDP0208DP020070PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0208DP020070PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0208DP020070PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0208DP020070PE(val *Acs5ProfilesValuesDP0208DP020070PE) *NullableAcs5ProfilesValuesDP0208DP020070PE {
	return &NullableAcs5ProfilesValuesDP0208DP020070PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0208DP020070PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0208DP020070PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0201DP020003PE Married-couple family: With own children of the householder under 18 years (percent)
type Acs5ProfilesValuesDP0201DP020003PE struct {
	// DP02_0003PE
...
type _Acs5ProfilesValuesDP0201DP020003PE Acs5ProfilesValuesDP0201DP020003PE
...
func NewAcs5ProfilesValuesDP0201DP020003PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0201DP020003PE {
	this := Acs5ProfilesValuesDP0201DP020003PE{}
...
func (o Acs5ProfilesValuesDP0201DP020003PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0201DP020003PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0201DP020003PE := _Acs5ProfilesValuesDP0201DP020003PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0201DP020003PE); err == nil {
		*o = Acs5ProfilesValuesDP0201DP020003PE(varAcs5ProfilesValuesDP0201DP020003PE)
	}
...
type NullableAcs5ProfilesValuesDP0201DP020003PE struct {
	value *Acs5ProfilesValuesDP0201DP020003PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0201DP020003PE) Get() *Acs5ProfilesValuesDP0201DP020003PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0201DP020003PE) Set(val *Acs5ProfilesValuesDP0201DP020003PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0201DP020003PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0201DP020003PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0201DP020003PE(val *Acs5ProfilesValuesDP0201DP020003PE) *NullableAcs5ProfilesValuesDP0201DP020003PE {
	return &NullableAcs5ProfilesValuesDP0201DP020003PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0201DP020003PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0201DP020003PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

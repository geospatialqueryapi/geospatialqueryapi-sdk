...
// Acs5ProfilesValuesDP0306DP030055PE struct for Acs5ProfilesValuesDP0306DP030055PE
type Acs5ProfilesValuesDP0306DP030055PE struct {
...
type _Acs5ProfilesValuesDP0306DP030055PE Acs5ProfilesValuesDP0306DP030055PE
...
func NewAcs5ProfilesValuesDP0306DP030055PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030055PE {
	this := Acs5ProfilesValuesDP0306DP030055PE{}
...
func (o Acs5ProfilesValuesDP0306DP030055PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030055PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030055PE := _Acs5ProfilesValuesDP0306DP030055PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030055PE); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030055PE(varAcs5ProfilesValuesDP0306DP030055PE)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030055PE struct {
	value *Acs5ProfilesValuesDP0306DP030055PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030055PE) Get() *Acs5ProfilesValuesDP0306DP030055PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030055PE) Set(val *Acs5ProfilesValuesDP0306DP030055PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030055PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030055PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030055PE(val *Acs5ProfilesValuesDP0306DP030055PE) *NullableAcs5ProfilesValuesDP0306DP030055PE {
	return &NullableAcs5ProfilesValuesDP0306DP030055PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030055PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030055PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0402DP040011E struct for Acs5ProfilesValuesDP0402DP040011E
type Acs5ProfilesValuesDP0402DP040011E struct {
...
type _Acs5ProfilesValuesDP0402DP040011E Acs5ProfilesValuesDP0402DP040011E
...
func NewAcs5ProfilesValuesDP0402DP040011E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040011E {
	this := Acs5ProfilesValuesDP0402DP040011E{}
...
func (o Acs5ProfilesValuesDP0402DP040011E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040011E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040011E := _Acs5ProfilesValuesDP0402DP040011E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040011E); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040011E(varAcs5ProfilesValuesDP0402DP040011E)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040011E struct {
	value *Acs5ProfilesValuesDP0402DP040011E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040011E) Get() *Acs5ProfilesValuesDP0402DP040011E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040011E) Set(val *Acs5ProfilesValuesDP0402DP040011E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040011E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040011E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040011E(val *Acs5ProfilesValuesDP0402DP040011E) *NullableAcs5ProfilesValuesDP0402DP040011E {
	return &NullableAcs5ProfilesValuesDP0402DP040011E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040011E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040011E) UnmarshalJSON(src []byte) error {
	v.isSet = true

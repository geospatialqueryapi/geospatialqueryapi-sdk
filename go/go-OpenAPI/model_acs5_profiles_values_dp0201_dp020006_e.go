...
// Acs5ProfilesValuesDP0201DP020006E struct for Acs5ProfilesValuesDP0201DP020006E
type Acs5ProfilesValuesDP0201DP020006E struct {
...
type _Acs5ProfilesValuesDP0201DP020006E Acs5ProfilesValuesDP0201DP020006E
...
func NewAcs5ProfilesValuesDP0201DP020006E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0201DP020006E {
	this := Acs5ProfilesValuesDP0201DP020006E{}
...
func (o Acs5ProfilesValuesDP0201DP020006E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0201DP020006E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0201DP020006E := _Acs5ProfilesValuesDP0201DP020006E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0201DP020006E); err == nil {
		*o = Acs5ProfilesValuesDP0201DP020006E(varAcs5ProfilesValuesDP0201DP020006E)
	}
...
type NullableAcs5ProfilesValuesDP0201DP020006E struct {
	value *Acs5ProfilesValuesDP0201DP020006E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0201DP020006E) Get() *Acs5ProfilesValuesDP0201DP020006E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0201DP020006E) Set(val *Acs5ProfilesValuesDP0201DP020006E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0201DP020006E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0201DP020006E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0201DP020006E(val *Acs5ProfilesValuesDP0201DP020006E) *NullableAcs5ProfilesValuesDP0201DP020006E {
	return &NullableAcs5ProfilesValuesDP0201DP020006E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0201DP020006E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0201DP020006E) UnmarshalJSON(src []byte) error {
	v.isSet = true

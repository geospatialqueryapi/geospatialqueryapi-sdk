...
// Acs5ProfilesValuesDP0305DP030047E struct for Acs5ProfilesValuesDP0305DP030047E
type Acs5ProfilesValuesDP0305DP030047E struct {
...
type _Acs5ProfilesValuesDP0305DP030047E Acs5ProfilesValuesDP0305DP030047E
...
func NewAcs5ProfilesValuesDP0305DP030047E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0305DP030047E {
	this := Acs5ProfilesValuesDP0305DP030047E{}
...
func (o Acs5ProfilesValuesDP0305DP030047E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0305DP030047E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0305DP030047E := _Acs5ProfilesValuesDP0305DP030047E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0305DP030047E); err == nil {
		*o = Acs5ProfilesValuesDP0305DP030047E(varAcs5ProfilesValuesDP0305DP030047E)
	}
...
type NullableAcs5ProfilesValuesDP0305DP030047E struct {
	value *Acs5ProfilesValuesDP0305DP030047E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0305DP030047E) Get() *Acs5ProfilesValuesDP0305DP030047E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0305DP030047E) Set(val *Acs5ProfilesValuesDP0305DP030047E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0305DP030047E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0305DP030047E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0305DP030047E(val *Acs5ProfilesValuesDP0305DP030047E) *NullableAcs5ProfilesValuesDP0305DP030047E {
	return &NullableAcs5ProfilesValuesDP0305DP030047E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0305DP030047E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0305DP030047E) UnmarshalJSON(src []byte) error {
	v.isSet = true

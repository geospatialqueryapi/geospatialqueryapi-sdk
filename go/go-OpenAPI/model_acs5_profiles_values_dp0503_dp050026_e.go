...
// Acs5ProfilesValuesDP0503DP050026E struct for Acs5ProfilesValuesDP0503DP050026E
type Acs5ProfilesValuesDP0503DP050026E struct {
...
type _Acs5ProfilesValuesDP0503DP050026E Acs5ProfilesValuesDP0503DP050026E
...
func NewAcs5ProfilesValuesDP0503DP050026E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0503DP050026E {
	this := Acs5ProfilesValuesDP0503DP050026E{}
...
func (o Acs5ProfilesValuesDP0503DP050026E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0503DP050026E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0503DP050026E := _Acs5ProfilesValuesDP0503DP050026E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0503DP050026E); err == nil {
		*o = Acs5ProfilesValuesDP0503DP050026E(varAcs5ProfilesValuesDP0503DP050026E)
	}
...
type NullableAcs5ProfilesValuesDP0503DP050026E struct {
	value *Acs5ProfilesValuesDP0503DP050026E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0503DP050026E) Get() *Acs5ProfilesValuesDP0503DP050026E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0503DP050026E) Set(val *Acs5ProfilesValuesDP0503DP050026E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0503DP050026E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0503DP050026E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0503DP050026E(val *Acs5ProfilesValuesDP0503DP050026E) *NullableAcs5ProfilesValuesDP0503DP050026E {
	return &NullableAcs5ProfilesValuesDP0503DP050026E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0503DP050026E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0503DP050026E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0305DP030048PE struct for Acs5ProfilesValuesDP0305DP030048PE
type Acs5ProfilesValuesDP0305DP030048PE struct {
...
type _Acs5ProfilesValuesDP0305DP030048PE Acs5ProfilesValuesDP0305DP030048PE
...
func NewAcs5ProfilesValuesDP0305DP030048PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0305DP030048PE {
	this := Acs5ProfilesValuesDP0305DP030048PE{}
...
func (o Acs5ProfilesValuesDP0305DP030048PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0305DP030048PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0305DP030048PE := _Acs5ProfilesValuesDP0305DP030048PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0305DP030048PE); err == nil {
		*o = Acs5ProfilesValuesDP0305DP030048PE(varAcs5ProfilesValuesDP0305DP030048PE)
	}
...
type NullableAcs5ProfilesValuesDP0305DP030048PE struct {
	value *Acs5ProfilesValuesDP0305DP030048PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0305DP030048PE) Get() *Acs5ProfilesValuesDP0305DP030048PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0305DP030048PE) Set(val *Acs5ProfilesValuesDP0305DP030048PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0305DP030048PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0305DP030048PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0305DP030048PE(val *Acs5ProfilesValuesDP0305DP030048PE) *NullableAcs5ProfilesValuesDP0305DP030048PE {
	return &NullableAcs5ProfilesValuesDP0305DP030048PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0305DP030048PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0305DP030048PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

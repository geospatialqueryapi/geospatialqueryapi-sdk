...
// Acs5ProfilesValuesDP0409DP040087PE struct for Acs5ProfilesValuesDP0409DP040087PE
type Acs5ProfilesValuesDP0409DP040087PE struct {
...
type _Acs5ProfilesValuesDP0409DP040087PE Acs5ProfilesValuesDP0409DP040087PE
...
func NewAcs5ProfilesValuesDP0409DP040087PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0409DP040087PE {
	this := Acs5ProfilesValuesDP0409DP040087PE{}
...
func (o Acs5ProfilesValuesDP0409DP040087PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0409DP040087PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0409DP040087PE := _Acs5ProfilesValuesDP0409DP040087PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0409DP040087PE); err == nil {
		*o = Acs5ProfilesValuesDP0409DP040087PE(varAcs5ProfilesValuesDP0409DP040087PE)
	}
...
type NullableAcs5ProfilesValuesDP0409DP040087PE struct {
	value *Acs5ProfilesValuesDP0409DP040087PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0409DP040087PE) Get() *Acs5ProfilesValuesDP0409DP040087PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0409DP040087PE) Set(val *Acs5ProfilesValuesDP0409DP040087PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0409DP040087PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0409DP040087PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0409DP040087PE(val *Acs5ProfilesValuesDP0409DP040087PE) *NullableAcs5ProfilesValuesDP0409DP040087PE {
	return &NullableAcs5ProfilesValuesDP0409DP040087PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0409DP040087PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0409DP040087PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0409DP040084E struct for Acs5ProfilesValuesDP0409DP040084E
type Acs5ProfilesValuesDP0409DP040084E struct {
...
type _Acs5ProfilesValuesDP0409DP040084E Acs5ProfilesValuesDP0409DP040084E
...
func NewAcs5ProfilesValuesDP0409DP040084E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0409DP040084E {
	this := Acs5ProfilesValuesDP0409DP040084E{}
...
func (o Acs5ProfilesValuesDP0409DP040084E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0409DP040084E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0409DP040084E := _Acs5ProfilesValuesDP0409DP040084E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0409DP040084E); err == nil {
		*o = Acs5ProfilesValuesDP0409DP040084E(varAcs5ProfilesValuesDP0409DP040084E)
	}
...
type NullableAcs5ProfilesValuesDP0409DP040084E struct {
	value *Acs5ProfilesValuesDP0409DP040084E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0409DP040084E) Get() *Acs5ProfilesValuesDP0409DP040084E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0409DP040084E) Set(val *Acs5ProfilesValuesDP0409DP040084E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0409DP040084E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0409DP040084E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0409DP040084E(val *Acs5ProfilesValuesDP0409DP040084E) *NullableAcs5ProfilesValuesDP0409DP040084E {
	return &NullableAcs5ProfilesValuesDP0409DP040084E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0409DP040084E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0409DP040084E) UnmarshalJSON(src []byte) error {
	v.isSet = true

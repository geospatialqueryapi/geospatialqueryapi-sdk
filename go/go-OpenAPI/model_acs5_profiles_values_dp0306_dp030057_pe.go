...
// Acs5ProfilesValuesDP0306DP030057PE struct for Acs5ProfilesValuesDP0306DP030057PE
type Acs5ProfilesValuesDP0306DP030057PE struct {
...
type _Acs5ProfilesValuesDP0306DP030057PE Acs5ProfilesValuesDP0306DP030057PE
...
func NewAcs5ProfilesValuesDP0306DP030057PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030057PE {
	this := Acs5ProfilesValuesDP0306DP030057PE{}
...
func (o Acs5ProfilesValuesDP0306DP030057PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030057PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030057PE := _Acs5ProfilesValuesDP0306DP030057PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030057PE); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030057PE(varAcs5ProfilesValuesDP0306DP030057PE)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030057PE struct {
	value *Acs5ProfilesValuesDP0306DP030057PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030057PE) Get() *Acs5ProfilesValuesDP0306DP030057PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030057PE) Set(val *Acs5ProfilesValuesDP0306DP030057PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030057PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030057PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030057PE(val *Acs5ProfilesValuesDP0306DP030057PE) *NullableAcs5ProfilesValuesDP0306DP030057PE {
	return &NullableAcs5ProfilesValuesDP0306DP030057PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030057PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030057PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

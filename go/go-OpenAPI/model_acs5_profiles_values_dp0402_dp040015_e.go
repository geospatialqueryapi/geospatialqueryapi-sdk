...
// Acs5ProfilesValuesDP0402DP040015E struct for Acs5ProfilesValuesDP0402DP040015E
type Acs5ProfilesValuesDP0402DP040015E struct {
...
type _Acs5ProfilesValuesDP0402DP040015E Acs5ProfilesValuesDP0402DP040015E
...
func NewAcs5ProfilesValuesDP0402DP040015E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040015E {
	this := Acs5ProfilesValuesDP0402DP040015E{}
...
func (o Acs5ProfilesValuesDP0402DP040015E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040015E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040015E := _Acs5ProfilesValuesDP0402DP040015E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040015E); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040015E(varAcs5ProfilesValuesDP0402DP040015E)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040015E struct {
	value *Acs5ProfilesValuesDP0402DP040015E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040015E) Get() *Acs5ProfilesValuesDP0402DP040015E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040015E) Set(val *Acs5ProfilesValuesDP0402DP040015E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040015E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040015E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040015E(val *Acs5ProfilesValuesDP0402DP040015E) *NullableAcs5ProfilesValuesDP0402DP040015E {
	return &NullableAcs5ProfilesValuesDP0402DP040015E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040015E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040015E) UnmarshalJSON(src []byte) error {
	v.isSet = true

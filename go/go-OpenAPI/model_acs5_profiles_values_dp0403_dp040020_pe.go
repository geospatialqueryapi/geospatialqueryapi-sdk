...
// Acs5ProfilesValuesDP0403DP040020PE struct for Acs5ProfilesValuesDP0403DP040020PE
type Acs5ProfilesValuesDP0403DP040020PE struct {
...
type _Acs5ProfilesValuesDP0403DP040020PE Acs5ProfilesValuesDP0403DP040020PE
...
func NewAcs5ProfilesValuesDP0403DP040020PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040020PE {
	this := Acs5ProfilesValuesDP0403DP040020PE{}
...
func (o Acs5ProfilesValuesDP0403DP040020PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040020PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040020PE := _Acs5ProfilesValuesDP0403DP040020PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040020PE); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040020PE(varAcs5ProfilesValuesDP0403DP040020PE)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040020PE struct {
	value *Acs5ProfilesValuesDP0403DP040020PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040020PE) Get() *Acs5ProfilesValuesDP0403DP040020PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040020PE) Set(val *Acs5ProfilesValuesDP0403DP040020PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040020PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040020PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040020PE(val *Acs5ProfilesValuesDP0403DP040020PE) *NullableAcs5ProfilesValuesDP0403DP040020PE {
	return &NullableAcs5ProfilesValuesDP0403DP040020PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040020PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040020PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

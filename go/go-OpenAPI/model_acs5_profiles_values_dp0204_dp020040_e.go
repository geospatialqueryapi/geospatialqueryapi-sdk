...
// Acs5ProfilesValuesDP0204DP020040E Number of women 15 to 50 years old who had a birth in the past 12 months: Per 1,000 women 15 to 50 years old
type Acs5ProfilesValuesDP0204DP020040E struct {
	// DP02_0040E
...
type _Acs5ProfilesValuesDP0204DP020040E Acs5ProfilesValuesDP0204DP020040E
...
func NewAcs5ProfilesValuesDP0204DP020040E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0204DP020040E {
	this := Acs5ProfilesValuesDP0204DP020040E{}
...
func (o Acs5ProfilesValuesDP0204DP020040E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0204DP020040E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0204DP020040E := _Acs5ProfilesValuesDP0204DP020040E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0204DP020040E); err == nil {
		*o = Acs5ProfilesValuesDP0204DP020040E(varAcs5ProfilesValuesDP0204DP020040E)
	}
...
type NullableAcs5ProfilesValuesDP0204DP020040E struct {
	value *Acs5ProfilesValuesDP0204DP020040E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0204DP020040E) Get() *Acs5ProfilesValuesDP0204DP020040E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0204DP020040E) Set(val *Acs5ProfilesValuesDP0204DP020040E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0204DP020040E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0204DP020040E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0204DP020040E(val *Acs5ProfilesValuesDP0204DP020040E) *NullableAcs5ProfilesValuesDP0204DP020040E {
	return &NullableAcs5ProfilesValuesDP0204DP020040E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0204DP020040E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0204DP020040E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0301DP030005E struct for Acs5ProfilesValuesDP0301DP030005E
type Acs5ProfilesValuesDP0301DP030005E struct {
...
type _Acs5ProfilesValuesDP0301DP030005E Acs5ProfilesValuesDP0301DP030005E
...
func NewAcs5ProfilesValuesDP0301DP030005E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0301DP030005E {
	this := Acs5ProfilesValuesDP0301DP030005E{}
...
func (o Acs5ProfilesValuesDP0301DP030005E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0301DP030005E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0301DP030005E := _Acs5ProfilesValuesDP0301DP030005E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0301DP030005E); err == nil {
		*o = Acs5ProfilesValuesDP0301DP030005E(varAcs5ProfilesValuesDP0301DP030005E)
	}
...
type NullableAcs5ProfilesValuesDP0301DP030005E struct {
	value *Acs5ProfilesValuesDP0301DP030005E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0301DP030005E) Get() *Acs5ProfilesValuesDP0301DP030005E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0301DP030005E) Set(val *Acs5ProfilesValuesDP0301DP030005E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0301DP030005E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0301DP030005E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0301DP030005E(val *Acs5ProfilesValuesDP0301DP030005E) *NullableAcs5ProfilesValuesDP0301DP030005E {
	return &NullableAcs5ProfilesValuesDP0301DP030005E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0301DP030005E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0301DP030005E) UnmarshalJSON(src []byte) error {
	v.isSet = true

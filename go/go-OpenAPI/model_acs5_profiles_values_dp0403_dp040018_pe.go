...
// Acs5ProfilesValuesDP0403DP040018PE struct for Acs5ProfilesValuesDP0403DP040018PE
type Acs5ProfilesValuesDP0403DP040018PE struct {
...
type _Acs5ProfilesValuesDP0403DP040018PE Acs5ProfilesValuesDP0403DP040018PE
...
func NewAcs5ProfilesValuesDP0403DP040018PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040018PE {
	this := Acs5ProfilesValuesDP0403DP040018PE{}
...
func (o Acs5ProfilesValuesDP0403DP040018PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040018PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040018PE := _Acs5ProfilesValuesDP0403DP040018PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040018PE); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040018PE(varAcs5ProfilesValuesDP0403DP040018PE)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040018PE struct {
	value *Acs5ProfilesValuesDP0403DP040018PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040018PE) Get() *Acs5ProfilesValuesDP0403DP040018PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040018PE) Set(val *Acs5ProfilesValuesDP0403DP040018PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040018PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040018PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040018PE(val *Acs5ProfilesValuesDP0403DP040018PE) *NullableAcs5ProfilesValuesDP0403DP040018PE {
	return &NullableAcs5ProfilesValuesDP0403DP040018PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040018PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040018PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

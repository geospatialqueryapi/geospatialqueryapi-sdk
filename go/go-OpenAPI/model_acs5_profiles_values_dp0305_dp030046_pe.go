...
// Acs5ProfilesValuesDP0305DP030046PE Class of worker: Civilian employed population 16 years and over (percent)
type Acs5ProfilesValuesDP0305DP030046PE struct {
	// DP03_0046PE
...
type _Acs5ProfilesValuesDP0305DP030046PE Acs5ProfilesValuesDP0305DP030046PE
...
func NewAcs5ProfilesValuesDP0305DP030046PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0305DP030046PE {
	this := Acs5ProfilesValuesDP0305DP030046PE{}
...
func (o Acs5ProfilesValuesDP0305DP030046PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0305DP030046PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0305DP030046PE := _Acs5ProfilesValuesDP0305DP030046PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0305DP030046PE); err == nil {
		*o = Acs5ProfilesValuesDP0305DP030046PE(varAcs5ProfilesValuesDP0305DP030046PE)
	}
...
type NullableAcs5ProfilesValuesDP0305DP030046PE struct {
	value *Acs5ProfilesValuesDP0305DP030046PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0305DP030046PE) Get() *Acs5ProfilesValuesDP0305DP030046PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0305DP030046PE) Set(val *Acs5ProfilesValuesDP0305DP030046PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0305DP030046PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0305DP030046PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0305DP030046PE(val *Acs5ProfilesValuesDP0305DP030046PE) *NullableAcs5ProfilesValuesDP0305DP030046PE {
	return &NullableAcs5ProfilesValuesDP0305DP030046PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0305DP030046PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0305DP030046PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

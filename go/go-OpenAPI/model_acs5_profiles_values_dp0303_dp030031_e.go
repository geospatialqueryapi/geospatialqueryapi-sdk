...
// Acs5ProfilesValuesDP0303DP030031E Production, transportation, and material moving occupations
type Acs5ProfilesValuesDP0303DP030031E struct {
	// DP03_0031E
...
type _Acs5ProfilesValuesDP0303DP030031E Acs5ProfilesValuesDP0303DP030031E
...
func NewAcs5ProfilesValuesDP0303DP030031E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0303DP030031E {
	this := Acs5ProfilesValuesDP0303DP030031E{}
...
func (o Acs5ProfilesValuesDP0303DP030031E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0303DP030031E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0303DP030031E := _Acs5ProfilesValuesDP0303DP030031E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0303DP030031E); err == nil {
		*o = Acs5ProfilesValuesDP0303DP030031E(varAcs5ProfilesValuesDP0303DP030031E)
	}
...
type NullableAcs5ProfilesValuesDP0303DP030031E struct {
	value *Acs5ProfilesValuesDP0303DP030031E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0303DP030031E) Get() *Acs5ProfilesValuesDP0303DP030031E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0303DP030031E) Set(val *Acs5ProfilesValuesDP0303DP030031E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0303DP030031E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0303DP030031E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0303DP030031E(val *Acs5ProfilesValuesDP0303DP030031E) *NullableAcs5ProfilesValuesDP0303DP030031E {
	return &NullableAcs5ProfilesValuesDP0303DP030031E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0303DP030031E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0303DP030031E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0402DP040014PE struct for Acs5ProfilesValuesDP0402DP040014PE
type Acs5ProfilesValuesDP0402DP040014PE struct {
...
type _Acs5ProfilesValuesDP0402DP040014PE Acs5ProfilesValuesDP0402DP040014PE
...
func NewAcs5ProfilesValuesDP0402DP040014PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040014PE {
	this := Acs5ProfilesValuesDP0402DP040014PE{}
...
func (o Acs5ProfilesValuesDP0402DP040014PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040014PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040014PE := _Acs5ProfilesValuesDP0402DP040014PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040014PE); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040014PE(varAcs5ProfilesValuesDP0402DP040014PE)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040014PE struct {
	value *Acs5ProfilesValuesDP0402DP040014PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040014PE) Get() *Acs5ProfilesValuesDP0402DP040014PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040014PE) Set(val *Acs5ProfilesValuesDP0402DP040014PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040014PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040014PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040014PE(val *Acs5ProfilesValuesDP0402DP040014PE) *NullableAcs5ProfilesValuesDP0402DP040014PE {
	return &NullableAcs5ProfilesValuesDP0402DP040014PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040014PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040014PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

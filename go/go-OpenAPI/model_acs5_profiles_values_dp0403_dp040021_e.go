...
// Acs5ProfilesValuesDP0403DP040021E struct for Acs5ProfilesValuesDP0403DP040021E
type Acs5ProfilesValuesDP0403DP040021E struct {
...
type _Acs5ProfilesValuesDP0403DP040021E Acs5ProfilesValuesDP0403DP040021E
...
func NewAcs5ProfilesValuesDP0403DP040021E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040021E {
	this := Acs5ProfilesValuesDP0403DP040021E{}
...
func (o Acs5ProfilesValuesDP0403DP040021E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040021E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040021E := _Acs5ProfilesValuesDP0403DP040021E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040021E); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040021E(varAcs5ProfilesValuesDP0403DP040021E)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040021E struct {
	value *Acs5ProfilesValuesDP0403DP040021E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040021E) Get() *Acs5ProfilesValuesDP0403DP040021E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040021E) Set(val *Acs5ProfilesValuesDP0403DP040021E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040021E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040021E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040021E(val *Acs5ProfilesValuesDP0403DP040021E) *NullableAcs5ProfilesValuesDP0403DP040021E {
	return &NullableAcs5ProfilesValuesDP0403DP040021E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040021E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040021E) UnmarshalJSON(src []byte) error {
	v.isSet = true

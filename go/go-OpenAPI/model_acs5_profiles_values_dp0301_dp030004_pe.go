...
// Acs5ProfilesValuesDP0301DP030004PE struct for Acs5ProfilesValuesDP0301DP030004PE
type Acs5ProfilesValuesDP0301DP030004PE struct {
...
type _Acs5ProfilesValuesDP0301DP030004PE Acs5ProfilesValuesDP0301DP030004PE
...
func NewAcs5ProfilesValuesDP0301DP030004PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0301DP030004PE {
	this := Acs5ProfilesValuesDP0301DP030004PE{}
...
func (o Acs5ProfilesValuesDP0301DP030004PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0301DP030004PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0301DP030004PE := _Acs5ProfilesValuesDP0301DP030004PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0301DP030004PE); err == nil {
		*o = Acs5ProfilesValuesDP0301DP030004PE(varAcs5ProfilesValuesDP0301DP030004PE)
	}
...
type NullableAcs5ProfilesValuesDP0301DP030004PE struct {
	value *Acs5ProfilesValuesDP0301DP030004PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0301DP030004PE) Get() *Acs5ProfilesValuesDP0301DP030004PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0301DP030004PE) Set(val *Acs5ProfilesValuesDP0301DP030004PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0301DP030004PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0301DP030004PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0301DP030004PE(val *Acs5ProfilesValuesDP0301DP030004PE) *NullableAcs5ProfilesValuesDP0301DP030004PE {
	return &NullableAcs5ProfilesValuesDP0301DP030004PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0301DP030004PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0301DP030004PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

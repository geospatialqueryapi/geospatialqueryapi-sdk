...
// Acs5ProfilesValuesDP0402DP040010E struct for Acs5ProfilesValuesDP0402DP040010E
type Acs5ProfilesValuesDP0402DP040010E struct {
...
type _Acs5ProfilesValuesDP0402DP040010E Acs5ProfilesValuesDP0402DP040010E
...
func NewAcs5ProfilesValuesDP0402DP040010E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040010E {
	this := Acs5ProfilesValuesDP0402DP040010E{}
...
func (o Acs5ProfilesValuesDP0402DP040010E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040010E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040010E := _Acs5ProfilesValuesDP0402DP040010E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040010E); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040010E(varAcs5ProfilesValuesDP0402DP040010E)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040010E struct {
	value *Acs5ProfilesValuesDP0402DP040010E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040010E) Get() *Acs5ProfilesValuesDP0402DP040010E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040010E) Set(val *Acs5ProfilesValuesDP0402DP040010E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040010E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040010E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040010E(val *Acs5ProfilesValuesDP0402DP040010E) *NullableAcs5ProfilesValuesDP0402DP040010E {
	return &NullableAcs5ProfilesValuesDP0402DP040010E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040010E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040010E) UnmarshalJSON(src []byte) error {
	v.isSet = true

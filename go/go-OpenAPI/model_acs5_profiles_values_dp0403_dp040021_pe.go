...
// Acs5ProfilesValuesDP0403DP040021PE struct for Acs5ProfilesValuesDP0403DP040021PE
type Acs5ProfilesValuesDP0403DP040021PE struct {
...
type _Acs5ProfilesValuesDP0403DP040021PE Acs5ProfilesValuesDP0403DP040021PE
...
func NewAcs5ProfilesValuesDP0403DP040021PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040021PE {
	this := Acs5ProfilesValuesDP0403DP040021PE{}
...
func (o Acs5ProfilesValuesDP0403DP040021PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040021PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040021PE := _Acs5ProfilesValuesDP0403DP040021PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040021PE); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040021PE(varAcs5ProfilesValuesDP0403DP040021PE)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040021PE struct {
	value *Acs5ProfilesValuesDP0403DP040021PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040021PE) Get() *Acs5ProfilesValuesDP0403DP040021PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040021PE) Set(val *Acs5ProfilesValuesDP0403DP040021PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040021PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040021PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040021PE(val *Acs5ProfilesValuesDP0403DP040021PE) *NullableAcs5ProfilesValuesDP0403DP040021PE {
	return &NullableAcs5ProfilesValuesDP0403DP040021PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040021PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040021PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

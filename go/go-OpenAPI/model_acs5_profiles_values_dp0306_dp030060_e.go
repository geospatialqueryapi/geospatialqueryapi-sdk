...
// Acs5ProfilesValuesDP0306DP030060E struct for Acs5ProfilesValuesDP0306DP030060E
type Acs5ProfilesValuesDP0306DP030060E struct {
...
type _Acs5ProfilesValuesDP0306DP030060E Acs5ProfilesValuesDP0306DP030060E
...
func NewAcs5ProfilesValuesDP0306DP030060E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030060E {
	this := Acs5ProfilesValuesDP0306DP030060E{}
...
func (o Acs5ProfilesValuesDP0306DP030060E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030060E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030060E := _Acs5ProfilesValuesDP0306DP030060E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030060E); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030060E(varAcs5ProfilesValuesDP0306DP030060E)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030060E struct {
	value *Acs5ProfilesValuesDP0306DP030060E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030060E) Get() *Acs5ProfilesValuesDP0306DP030060E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030060E) Set(val *Acs5ProfilesValuesDP0306DP030060E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030060E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030060E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030060E(val *Acs5ProfilesValuesDP0306DP030060E) *NullableAcs5ProfilesValuesDP0306DP030060E {
	return &NullableAcs5ProfilesValuesDP0306DP030060E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030060E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030060E) UnmarshalJSON(src []byte) error {
	v.isSet = true

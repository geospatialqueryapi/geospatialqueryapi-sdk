...
// Acs5ProfilesValuesDP0402DP040012PE struct for Acs5ProfilesValuesDP0402DP040012PE
type Acs5ProfilesValuesDP0402DP040012PE struct {
...
type _Acs5ProfilesValuesDP0402DP040012PE Acs5ProfilesValuesDP0402DP040012PE
...
func NewAcs5ProfilesValuesDP0402DP040012PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0402DP040012PE {
	this := Acs5ProfilesValuesDP0402DP040012PE{}
...
func (o Acs5ProfilesValuesDP0402DP040012PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0402DP040012PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0402DP040012PE := _Acs5ProfilesValuesDP0402DP040012PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0402DP040012PE); err == nil {
		*o = Acs5ProfilesValuesDP0402DP040012PE(varAcs5ProfilesValuesDP0402DP040012PE)
	}
...
type NullableAcs5ProfilesValuesDP0402DP040012PE struct {
	value *Acs5ProfilesValuesDP0402DP040012PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0402DP040012PE) Get() *Acs5ProfilesValuesDP0402DP040012PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0402DP040012PE) Set(val *Acs5ProfilesValuesDP0402DP040012PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0402DP040012PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0402DP040012PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0402DP040012PE(val *Acs5ProfilesValuesDP0402DP040012PE) *NullableAcs5ProfilesValuesDP0402DP040012PE {
	return &NullableAcs5ProfilesValuesDP0402DP040012PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0402DP040012PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0402DP040012PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0201DP020010E Female householder, no spouse/partner present
type Acs5ProfilesValuesDP0201DP020010E struct {
	// DP02_0010E
...
type _Acs5ProfilesValuesDP0201DP020010E Acs5ProfilesValuesDP0201DP020010E
...
func NewAcs5ProfilesValuesDP0201DP020010E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0201DP020010E {
	this := Acs5ProfilesValuesDP0201DP020010E{}
...
func (o Acs5ProfilesValuesDP0201DP020010E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0201DP020010E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0201DP020010E := _Acs5ProfilesValuesDP0201DP020010E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0201DP020010E); err == nil {
		*o = Acs5ProfilesValuesDP0201DP020010E(varAcs5ProfilesValuesDP0201DP020010E)
	}
...
type NullableAcs5ProfilesValuesDP0201DP020010E struct {
	value *Acs5ProfilesValuesDP0201DP020010E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0201DP020010E) Get() *Acs5ProfilesValuesDP0201DP020010E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0201DP020010E) Set(val *Acs5ProfilesValuesDP0201DP020010E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0201DP020010E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0201DP020010E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0201DP020010E(val *Acs5ProfilesValuesDP0201DP020010E) *NullableAcs5ProfilesValuesDP0201DP020010E {
	return &NullableAcs5ProfilesValuesDP0201DP020010E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0201DP020010E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0201DP020010E) UnmarshalJSON(src []byte) error {
	v.isSet = true

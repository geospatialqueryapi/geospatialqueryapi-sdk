...
// Acs5ProfilesValuesDP0302DP030024E struct for Acs5ProfilesValuesDP0302DP030024E
type Acs5ProfilesValuesDP0302DP030024E struct {
...
type _Acs5ProfilesValuesDP0302DP030024E Acs5ProfilesValuesDP0302DP030024E
...
func NewAcs5ProfilesValuesDP0302DP030024E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0302DP030024E {
	this := Acs5ProfilesValuesDP0302DP030024E{}
...
func (o Acs5ProfilesValuesDP0302DP030024E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0302DP030024E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0302DP030024E := _Acs5ProfilesValuesDP0302DP030024E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0302DP030024E); err == nil {
		*o = Acs5ProfilesValuesDP0302DP030024E(varAcs5ProfilesValuesDP0302DP030024E)
	}
...
type NullableAcs5ProfilesValuesDP0302DP030024E struct {
	value *Acs5ProfilesValuesDP0302DP030024E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0302DP030024E) Get() *Acs5ProfilesValuesDP0302DP030024E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0302DP030024E) Set(val *Acs5ProfilesValuesDP0302DP030024E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0302DP030024E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0302DP030024E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0302DP030024E(val *Acs5ProfilesValuesDP0302DP030024E) *NullableAcs5ProfilesValuesDP0302DP030024E {
	return &NullableAcs5ProfilesValuesDP0302DP030024E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0302DP030024E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0302DP030024E) UnmarshalJSON(src []byte) error {
	v.isSet = true

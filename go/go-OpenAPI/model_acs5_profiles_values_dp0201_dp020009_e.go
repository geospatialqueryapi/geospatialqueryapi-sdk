...
// Acs5ProfilesValuesDP0201DP020009E Male householder, no spouse/partner present- Householder living alone: 65 years and over
type Acs5ProfilesValuesDP0201DP020009E struct {
	// DP02_0009E
...
type _Acs5ProfilesValuesDP0201DP020009E Acs5ProfilesValuesDP0201DP020009E
...
func NewAcs5ProfilesValuesDP0201DP020009E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0201DP020009E {
	this := Acs5ProfilesValuesDP0201DP020009E{}
...
func (o Acs5ProfilesValuesDP0201DP020009E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0201DP020009E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0201DP020009E := _Acs5ProfilesValuesDP0201DP020009E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0201DP020009E); err == nil {
		*o = Acs5ProfilesValuesDP0201DP020009E(varAcs5ProfilesValuesDP0201DP020009E)
	}
...
type NullableAcs5ProfilesValuesDP0201DP020009E struct {
	value *Acs5ProfilesValuesDP0201DP020009E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0201DP020009E) Get() *Acs5ProfilesValuesDP0201DP020009E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0201DP020009E) Set(val *Acs5ProfilesValuesDP0201DP020009E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0201DP020009E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0201DP020009E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0201DP020009E(val *Acs5ProfilesValuesDP0201DP020009E) *NullableAcs5ProfilesValuesDP0201DP020009E {
	return &NullableAcs5ProfilesValuesDP0201DP020009E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0201DP020009E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0201DP020009E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0301DP030002PE struct for Acs5ProfilesValuesDP0301DP030002PE
type Acs5ProfilesValuesDP0301DP030002PE struct {
...
type _Acs5ProfilesValuesDP0301DP030002PE Acs5ProfilesValuesDP0301DP030002PE
...
func NewAcs5ProfilesValuesDP0301DP030002PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0301DP030002PE {
	this := Acs5ProfilesValuesDP0301DP030002PE{}
...
func (o Acs5ProfilesValuesDP0301DP030002PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0301DP030002PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0301DP030002PE := _Acs5ProfilesValuesDP0301DP030002PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0301DP030002PE); err == nil {
		*o = Acs5ProfilesValuesDP0301DP030002PE(varAcs5ProfilesValuesDP0301DP030002PE)
	}
...
type NullableAcs5ProfilesValuesDP0301DP030002PE struct {
	value *Acs5ProfilesValuesDP0301DP030002PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0301DP030002PE) Get() *Acs5ProfilesValuesDP0301DP030002PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0301DP030002PE) Set(val *Acs5ProfilesValuesDP0301DP030002PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0301DP030002PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0301DP030002PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0301DP030002PE(val *Acs5ProfilesValuesDP0301DP030002PE) *NullableAcs5ProfilesValuesDP0301DP030002PE {
	return &NullableAcs5ProfilesValuesDP0301DP030002PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0301DP030002PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0301DP030002PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

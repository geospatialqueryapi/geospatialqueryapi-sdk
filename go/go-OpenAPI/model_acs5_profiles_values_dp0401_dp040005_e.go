...
// Acs5ProfilesValuesDP0401DP040005E struct for Acs5ProfilesValuesDP0401DP040005E
type Acs5ProfilesValuesDP0401DP040005E struct {
...
type _Acs5ProfilesValuesDP0401DP040005E Acs5ProfilesValuesDP0401DP040005E
...
func NewAcs5ProfilesValuesDP0401DP040005E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0401DP040005E {
	this := Acs5ProfilesValuesDP0401DP040005E{}
...
func (o Acs5ProfilesValuesDP0401DP040005E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0401DP040005E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0401DP040005E := _Acs5ProfilesValuesDP0401DP040005E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0401DP040005E); err == nil {
		*o = Acs5ProfilesValuesDP0401DP040005E(varAcs5ProfilesValuesDP0401DP040005E)
	}
...
type NullableAcs5ProfilesValuesDP0401DP040005E struct {
	value *Acs5ProfilesValuesDP0401DP040005E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0401DP040005E) Get() *Acs5ProfilesValuesDP0401DP040005E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0401DP040005E) Set(val *Acs5ProfilesValuesDP0401DP040005E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0401DP040005E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0401DP040005E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0401DP040005E(val *Acs5ProfilesValuesDP0401DP040005E) *NullableAcs5ProfilesValuesDP0401DP040005E {
	return &NullableAcs5ProfilesValuesDP0401DP040005E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0401DP040005E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0401DP040005E) UnmarshalJSON(src []byte) error {
	v.isSet = true

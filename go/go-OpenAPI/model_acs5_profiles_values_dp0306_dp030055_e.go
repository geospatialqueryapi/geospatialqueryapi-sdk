...
// Acs5ProfilesValuesDP0306DP030055E struct for Acs5ProfilesValuesDP0306DP030055E
type Acs5ProfilesValuesDP0306DP030055E struct {
...
type _Acs5ProfilesValuesDP0306DP030055E Acs5ProfilesValuesDP0306DP030055E
...
func NewAcs5ProfilesValuesDP0306DP030055E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030055E {
	this := Acs5ProfilesValuesDP0306DP030055E{}
...
func (o Acs5ProfilesValuesDP0306DP030055E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030055E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030055E := _Acs5ProfilesValuesDP0306DP030055E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030055E); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030055E(varAcs5ProfilesValuesDP0306DP030055E)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030055E struct {
	value *Acs5ProfilesValuesDP0306DP030055E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030055E) Get() *Acs5ProfilesValuesDP0306DP030055E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030055E) Set(val *Acs5ProfilesValuesDP0306DP030055E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030055E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030055E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030055E(val *Acs5ProfilesValuesDP0306DP030055E) *NullableAcs5ProfilesValuesDP0306DP030055E {
	return &NullableAcs5ProfilesValuesDP0306DP030055E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030055E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030055E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0503DP050025PE struct for Acs5ProfilesValuesDP0503DP050025PE
type Acs5ProfilesValuesDP0503DP050025PE struct {
...
type _Acs5ProfilesValuesDP0503DP050025PE Acs5ProfilesValuesDP0503DP050025PE
...
func NewAcs5ProfilesValuesDP0503DP050025PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0503DP050025PE {
	this := Acs5ProfilesValuesDP0503DP050025PE{}
...
func (o Acs5ProfilesValuesDP0503DP050025PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0503DP050025PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0503DP050025PE := _Acs5ProfilesValuesDP0503DP050025PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0503DP050025PE); err == nil {
		*o = Acs5ProfilesValuesDP0503DP050025PE(varAcs5ProfilesValuesDP0503DP050025PE)
	}
...
type NullableAcs5ProfilesValuesDP0503DP050025PE struct {
	value *Acs5ProfilesValuesDP0503DP050025PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0503DP050025PE) Get() *Acs5ProfilesValuesDP0503DP050025PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0503DP050025PE) Set(val *Acs5ProfilesValuesDP0503DP050025PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0503DP050025PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0503DP050025PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0503DP050025PE(val *Acs5ProfilesValuesDP0503DP050025PE) *NullableAcs5ProfilesValuesDP0503DP050025PE {
	return &NullableAcs5ProfilesValuesDP0503DP050025PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0503DP050025PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0503DP050025PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

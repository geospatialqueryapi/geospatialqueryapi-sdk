...
// Acs5ProfilesValuesDP0505DP050071E struct for Acs5ProfilesValuesDP0505DP050071E
type Acs5ProfilesValuesDP0505DP050071E struct {
...
type _Acs5ProfilesValuesDP0505DP050071E Acs5ProfilesValuesDP0505DP050071E
...
func NewAcs5ProfilesValuesDP0505DP050071E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0505DP050071E {
	this := Acs5ProfilesValuesDP0505DP050071E{}
...
func (o Acs5ProfilesValuesDP0505DP050071E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0505DP050071E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0505DP050071E := _Acs5ProfilesValuesDP0505DP050071E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0505DP050071E); err == nil {
		*o = Acs5ProfilesValuesDP0505DP050071E(varAcs5ProfilesValuesDP0505DP050071E)
	}
...
type NullableAcs5ProfilesValuesDP0505DP050071E struct {
	value *Acs5ProfilesValuesDP0505DP050071E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0505DP050071E) Get() *Acs5ProfilesValuesDP0505DP050071E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0505DP050071E) Set(val *Acs5ProfilesValuesDP0505DP050071E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0505DP050071E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0505DP050071E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0505DP050071E(val *Acs5ProfilesValuesDP0505DP050071E) *NullableAcs5ProfilesValuesDP0505DP050071E {
	return &NullableAcs5ProfilesValuesDP0505DP050071E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0505DP050071E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0505DP050071E) UnmarshalJSON(src []byte) error {
	v.isSet = true

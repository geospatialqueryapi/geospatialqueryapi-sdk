...
// Acs5ProfilesValuesDP0207DP020067PE Population 25 years and over: High school graduate or higher (percent)
type Acs5ProfilesValuesDP0207DP020067PE struct {
	// DP02_0067PE
...
type _Acs5ProfilesValuesDP0207DP020067PE Acs5ProfilesValuesDP0207DP020067PE
...
func NewAcs5ProfilesValuesDP0207DP020067PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0207DP020067PE {
	this := Acs5ProfilesValuesDP0207DP020067PE{}
...
func (o Acs5ProfilesValuesDP0207DP020067PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0207DP020067PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0207DP020067PE := _Acs5ProfilesValuesDP0207DP020067PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0207DP020067PE); err == nil {
		*o = Acs5ProfilesValuesDP0207DP020067PE(varAcs5ProfilesValuesDP0207DP020067PE)
	}
...
type NullableAcs5ProfilesValuesDP0207DP020067PE struct {
	value *Acs5ProfilesValuesDP0207DP020067PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0207DP020067PE) Get() *Acs5ProfilesValuesDP0207DP020067PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0207DP020067PE) Set(val *Acs5ProfilesValuesDP0207DP020067PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0207DP020067PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0207DP020067PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0207DP020067PE(val *Acs5ProfilesValuesDP0207DP020067PE) *NullableAcs5ProfilesValuesDP0207DP020067PE {
	return &NullableAcs5ProfilesValuesDP0207DP020067PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0207DP020067PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0207DP020067PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

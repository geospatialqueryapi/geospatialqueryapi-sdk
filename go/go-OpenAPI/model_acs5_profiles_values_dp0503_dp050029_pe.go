...
// Acs5ProfilesValuesDP0503DP050029PE struct for Acs5ProfilesValuesDP0503DP050029PE
type Acs5ProfilesValuesDP0503DP050029PE struct {
...
type _Acs5ProfilesValuesDP0503DP050029PE Acs5ProfilesValuesDP0503DP050029PE
...
func NewAcs5ProfilesValuesDP0503DP050029PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0503DP050029PE {
	this := Acs5ProfilesValuesDP0503DP050029PE{}
...
func (o Acs5ProfilesValuesDP0503DP050029PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0503DP050029PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0503DP050029PE := _Acs5ProfilesValuesDP0503DP050029PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0503DP050029PE); err == nil {
		*o = Acs5ProfilesValuesDP0503DP050029PE(varAcs5ProfilesValuesDP0503DP050029PE)
	}
...
type NullableAcs5ProfilesValuesDP0503DP050029PE struct {
	value *Acs5ProfilesValuesDP0503DP050029PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0503DP050029PE) Get() *Acs5ProfilesValuesDP0503DP050029PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0503DP050029PE) Set(val *Acs5ProfilesValuesDP0503DP050029PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0503DP050029PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0503DP050029PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0503DP050029PE(val *Acs5ProfilesValuesDP0503DP050029PE) *NullableAcs5ProfilesValuesDP0503DP050029PE {
	return &NullableAcs5ProfilesValuesDP0503DP050029PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0503DP050029PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0503DP050029PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0207DP020059PE struct for Acs5ProfilesValuesDP0207DP020059PE
type Acs5ProfilesValuesDP0207DP020059PE struct {
...
type _Acs5ProfilesValuesDP0207DP020059PE Acs5ProfilesValuesDP0207DP020059PE
...
func NewAcs5ProfilesValuesDP0207DP020059PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0207DP020059PE {
	this := Acs5ProfilesValuesDP0207DP020059PE{}
...
func (o Acs5ProfilesValuesDP0207DP020059PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0207DP020059PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0207DP020059PE := _Acs5ProfilesValuesDP0207DP020059PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0207DP020059PE); err == nil {
		*o = Acs5ProfilesValuesDP0207DP020059PE(varAcs5ProfilesValuesDP0207DP020059PE)
	}
...
type NullableAcs5ProfilesValuesDP0207DP020059PE struct {
	value *Acs5ProfilesValuesDP0207DP020059PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0207DP020059PE) Get() *Acs5ProfilesValuesDP0207DP020059PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0207DP020059PE) Set(val *Acs5ProfilesValuesDP0207DP020059PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0207DP020059PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0207DP020059PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0207DP020059PE(val *Acs5ProfilesValuesDP0207DP020059PE) *NullableAcs5ProfilesValuesDP0207DP020059PE {
	return &NullableAcs5ProfilesValuesDP0207DP020059PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0207DP020059PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0207DP020059PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0409DP040083PE struct for Acs5ProfilesValuesDP0409DP040083PE
type Acs5ProfilesValuesDP0409DP040083PE struct {
...
type _Acs5ProfilesValuesDP0409DP040083PE Acs5ProfilesValuesDP0409DP040083PE
...
func NewAcs5ProfilesValuesDP0409DP040083PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0409DP040083PE {
	this := Acs5ProfilesValuesDP0409DP040083PE{}
...
func (o Acs5ProfilesValuesDP0409DP040083PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0409DP040083PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0409DP040083PE := _Acs5ProfilesValuesDP0409DP040083PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0409DP040083PE); err == nil {
		*o = Acs5ProfilesValuesDP0409DP040083PE(varAcs5ProfilesValuesDP0409DP040083PE)
	}
...
type NullableAcs5ProfilesValuesDP0409DP040083PE struct {
	value *Acs5ProfilesValuesDP0409DP040083PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0409DP040083PE) Get() *Acs5ProfilesValuesDP0409DP040083PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0409DP040083PE) Set(val *Acs5ProfilesValuesDP0409DP040083PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0409DP040083PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0409DP040083PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0409DP040083PE(val *Acs5ProfilesValuesDP0409DP040083PE) *NullableAcs5ProfilesValuesDP0409DP040083PE {
	return &NullableAcs5ProfilesValuesDP0409DP040083PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0409DP040083PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0409DP040083PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

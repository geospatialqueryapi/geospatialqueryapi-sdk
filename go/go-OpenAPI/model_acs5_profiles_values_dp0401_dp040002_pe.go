...
// Acs5ProfilesValuesDP0401DP040002PE struct for Acs5ProfilesValuesDP0401DP040002PE
type Acs5ProfilesValuesDP0401DP040002PE struct {
...
type _Acs5ProfilesValuesDP0401DP040002PE Acs5ProfilesValuesDP0401DP040002PE
...
func NewAcs5ProfilesValuesDP0401DP040002PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0401DP040002PE {
	this := Acs5ProfilesValuesDP0401DP040002PE{}
...
func (o Acs5ProfilesValuesDP0401DP040002PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0401DP040002PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0401DP040002PE := _Acs5ProfilesValuesDP0401DP040002PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0401DP040002PE); err == nil {
		*o = Acs5ProfilesValuesDP0401DP040002PE(varAcs5ProfilesValuesDP0401DP040002PE)
	}
...
type NullableAcs5ProfilesValuesDP0401DP040002PE struct {
	value *Acs5ProfilesValuesDP0401DP040002PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0401DP040002PE) Get() *Acs5ProfilesValuesDP0401DP040002PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0401DP040002PE) Set(val *Acs5ProfilesValuesDP0401DP040002PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0401DP040002PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0401DP040002PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0401DP040002PE(val *Acs5ProfilesValuesDP0401DP040002PE) *NullableAcs5ProfilesValuesDP0401DP040002PE {
	return &NullableAcs5ProfilesValuesDP0401DP040002PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0401DP040002PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0401DP040002PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

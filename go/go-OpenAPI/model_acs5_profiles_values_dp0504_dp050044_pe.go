...
// Acs5ProfilesValuesDP0504DP050044PE struct for Acs5ProfilesValuesDP0504DP050044PE
type Acs5ProfilesValuesDP0504DP050044PE struct {
...
type _Acs5ProfilesValuesDP0504DP050044PE Acs5ProfilesValuesDP0504DP050044PE
...
func NewAcs5ProfilesValuesDP0504DP050044PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0504DP050044PE {
	this := Acs5ProfilesValuesDP0504DP050044PE{}
...
func (o Acs5ProfilesValuesDP0504DP050044PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0504DP050044PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0504DP050044PE := _Acs5ProfilesValuesDP0504DP050044PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0504DP050044PE); err == nil {
		*o = Acs5ProfilesValuesDP0504DP050044PE(varAcs5ProfilesValuesDP0504DP050044PE)
	}
...
type NullableAcs5ProfilesValuesDP0504DP050044PE struct {
	value *Acs5ProfilesValuesDP0504DP050044PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0504DP050044PE) Get() *Acs5ProfilesValuesDP0504DP050044PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0504DP050044PE) Set(val *Acs5ProfilesValuesDP0504DP050044PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0504DP050044PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0504DP050044PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0504DP050044PE(val *Acs5ProfilesValuesDP0504DP050044PE) *NullableAcs5ProfilesValuesDP0504DP050044PE {
	return &NullableAcs5ProfilesValuesDP0504DP050044PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0504DP050044PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0504DP050044PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0502DP050021E struct for Acs5ProfilesValuesDP0502DP050021E
type Acs5ProfilesValuesDP0502DP050021E struct {
...
type _Acs5ProfilesValuesDP0502DP050021E Acs5ProfilesValuesDP0502DP050021E
...
func NewAcs5ProfilesValuesDP0502DP050021E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0502DP050021E {
	this := Acs5ProfilesValuesDP0502DP050021E{}
...
func (o Acs5ProfilesValuesDP0502DP050021E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0502DP050021E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0502DP050021E := _Acs5ProfilesValuesDP0502DP050021E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0502DP050021E); err == nil {
		*o = Acs5ProfilesValuesDP0502DP050021E(varAcs5ProfilesValuesDP0502DP050021E)
	}
...
type NullableAcs5ProfilesValuesDP0502DP050021E struct {
	value *Acs5ProfilesValuesDP0502DP050021E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0502DP050021E) Get() *Acs5ProfilesValuesDP0502DP050021E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0502DP050021E) Set(val *Acs5ProfilesValuesDP0502DP050021E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0502DP050021E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0502DP050021E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0502DP050021E(val *Acs5ProfilesValuesDP0502DP050021E) *NullableAcs5ProfilesValuesDP0502DP050021E {
	return &NullableAcs5ProfilesValuesDP0502DP050021E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0502DP050021E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0502DP050021E) UnmarshalJSON(src []byte) error {
	v.isSet = true

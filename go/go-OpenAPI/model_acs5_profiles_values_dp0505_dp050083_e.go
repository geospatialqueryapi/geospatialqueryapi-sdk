...
// Acs5ProfilesValuesDP0505DP050083E struct for Acs5ProfilesValuesDP0505DP050083E
type Acs5ProfilesValuesDP0505DP050083E struct {
...
type _Acs5ProfilesValuesDP0505DP050083E Acs5ProfilesValuesDP0505DP050083E
...
func NewAcs5ProfilesValuesDP0505DP050083E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0505DP050083E {
	this := Acs5ProfilesValuesDP0505DP050083E{}
...
func (o Acs5ProfilesValuesDP0505DP050083E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0505DP050083E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0505DP050083E := _Acs5ProfilesValuesDP0505DP050083E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0505DP050083E); err == nil {
		*o = Acs5ProfilesValuesDP0505DP050083E(varAcs5ProfilesValuesDP0505DP050083E)
	}
...
type NullableAcs5ProfilesValuesDP0505DP050083E struct {
	value *Acs5ProfilesValuesDP0505DP050083E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0505DP050083E) Get() *Acs5ProfilesValuesDP0505DP050083E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0505DP050083E) Set(val *Acs5ProfilesValuesDP0505DP050083E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0505DP050083E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0505DP050083E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0505DP050083E(val *Acs5ProfilesValuesDP0505DP050083E) *NullableAcs5ProfilesValuesDP0505DP050083E {
	return &NullableAcs5ProfilesValuesDP0505DP050083E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0505DP050083E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0505DP050083E) UnmarshalJSON(src []byte) error {
	v.isSet = true

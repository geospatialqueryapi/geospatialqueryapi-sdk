...
// Acs5ProfilesValuesDP0501DP050002E struct for Acs5ProfilesValuesDP0501DP050002E
type Acs5ProfilesValuesDP0501DP050002E struct {
...
type _Acs5ProfilesValuesDP0501DP050002E Acs5ProfilesValuesDP0501DP050002E
...
func NewAcs5ProfilesValuesDP0501DP050002E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0501DP050002E {
	this := Acs5ProfilesValuesDP0501DP050002E{}
...
func (o Acs5ProfilesValuesDP0501DP050002E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0501DP050002E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0501DP050002E := _Acs5ProfilesValuesDP0501DP050002E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0501DP050002E); err == nil {
		*o = Acs5ProfilesValuesDP0501DP050002E(varAcs5ProfilesValuesDP0501DP050002E)
	}
...
type NullableAcs5ProfilesValuesDP0501DP050002E struct {
	value *Acs5ProfilesValuesDP0501DP050002E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0501DP050002E) Get() *Acs5ProfilesValuesDP0501DP050002E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0501DP050002E) Set(val *Acs5ProfilesValuesDP0501DP050002E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0501DP050002E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0501DP050002E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0501DP050002E(val *Acs5ProfilesValuesDP0501DP050002E) *NullableAcs5ProfilesValuesDP0501DP050002E {
	return &NullableAcs5ProfilesValuesDP0501DP050002E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0501DP050002E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0501DP050002E) UnmarshalJSON(src []byte) error {
	v.isSet = true

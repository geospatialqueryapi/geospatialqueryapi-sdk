...
// Acs5ProfilesValuesDP0209DP020081E Population 1 year and over: Different house in the U.S.
type Acs5ProfilesValuesDP0209DP020081E struct {
	// DP02_0081E
...
type _Acs5ProfilesValuesDP0209DP020081E Acs5ProfilesValuesDP0209DP020081E
...
func NewAcs5ProfilesValuesDP0209DP020081E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0209DP020081E {
	this := Acs5ProfilesValuesDP0209DP020081E{}
...
func (o Acs5ProfilesValuesDP0209DP020081E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0209DP020081E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0209DP020081E := _Acs5ProfilesValuesDP0209DP020081E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0209DP020081E); err == nil {
		*o = Acs5ProfilesValuesDP0209DP020081E(varAcs5ProfilesValuesDP0209DP020081E)
	}
...
type NullableAcs5ProfilesValuesDP0209DP020081E struct {
	value *Acs5ProfilesValuesDP0209DP020081E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0209DP020081E) Get() *Acs5ProfilesValuesDP0209DP020081E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0209DP020081E) Set(val *Acs5ProfilesValuesDP0209DP020081E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0209DP020081E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0209DP020081E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0209DP020081E(val *Acs5ProfilesValuesDP0209DP020081E) *NullableAcs5ProfilesValuesDP0209DP020081E {
	return &NullableAcs5ProfilesValuesDP0209DP020081E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0209DP020081E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0209DP020081E) UnmarshalJSON(src []byte) error {
	v.isSet = true

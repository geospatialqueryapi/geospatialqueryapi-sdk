...
// Acs5ProfilesValuesDP0306DP030088E struct for Acs5ProfilesValuesDP0306DP030088E
type Acs5ProfilesValuesDP0306DP030088E struct {
...
type _Acs5ProfilesValuesDP0306DP030088E Acs5ProfilesValuesDP0306DP030088E
...
func NewAcs5ProfilesValuesDP0306DP030088E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030088E {
	this := Acs5ProfilesValuesDP0306DP030088E{}
...
func (o Acs5ProfilesValuesDP0306DP030088E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030088E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030088E := _Acs5ProfilesValuesDP0306DP030088E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030088E); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030088E(varAcs5ProfilesValuesDP0306DP030088E)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030088E struct {
	value *Acs5ProfilesValuesDP0306DP030088E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030088E) Get() *Acs5ProfilesValuesDP0306DP030088E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030088E) Set(val *Acs5ProfilesValuesDP0306DP030088E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030088E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030088E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030088E(val *Acs5ProfilesValuesDP0306DP030088E) *NullableAcs5ProfilesValuesDP0306DP030088E {
	return &NullableAcs5ProfilesValuesDP0306DP030088E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030088E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030088E) UnmarshalJSON(src []byte) error {
	v.isSet = true

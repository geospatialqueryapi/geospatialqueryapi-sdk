...
// Acs5ProfilesValuesDP0301DP030010PE EMPLOYMENT STATUS: Females 16 years and over (percent)
type Acs5ProfilesValuesDP0301DP030010PE struct {
	// DP03_0010PE
...
type _Acs5ProfilesValuesDP0301DP030010PE Acs5ProfilesValuesDP0301DP030010PE
...
func NewAcs5ProfilesValuesDP0301DP030010PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0301DP030010PE {
	this := Acs5ProfilesValuesDP0301DP030010PE{}
...
func (o Acs5ProfilesValuesDP0301DP030010PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0301DP030010PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0301DP030010PE := _Acs5ProfilesValuesDP0301DP030010PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0301DP030010PE); err == nil {
		*o = Acs5ProfilesValuesDP0301DP030010PE(varAcs5ProfilesValuesDP0301DP030010PE)
	}
...
type NullableAcs5ProfilesValuesDP0301DP030010PE struct {
	value *Acs5ProfilesValuesDP0301DP030010PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0301DP030010PE) Get() *Acs5ProfilesValuesDP0301DP030010PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0301DP030010PE) Set(val *Acs5ProfilesValuesDP0301DP030010PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0301DP030010PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0301DP030010PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0301DP030010PE(val *Acs5ProfilesValuesDP0301DP030010PE) *NullableAcs5ProfilesValuesDP0301DP030010PE {
	return &NullableAcs5ProfilesValuesDP0301DP030010PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0301DP030010PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0301DP030010PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

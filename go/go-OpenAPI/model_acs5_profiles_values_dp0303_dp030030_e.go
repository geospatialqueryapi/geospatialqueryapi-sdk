...
// Acs5ProfilesValuesDP0303DP030030E Natural resources, construction, and maintenance occupations
type Acs5ProfilesValuesDP0303DP030030E struct {
	// DP03_0030E
...
type _Acs5ProfilesValuesDP0303DP030030E Acs5ProfilesValuesDP0303DP030030E
...
func NewAcs5ProfilesValuesDP0303DP030030E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0303DP030030E {
	this := Acs5ProfilesValuesDP0303DP030030E{}
...
func (o Acs5ProfilesValuesDP0303DP030030E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0303DP030030E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0303DP030030E := _Acs5ProfilesValuesDP0303DP030030E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0303DP030030E); err == nil {
		*o = Acs5ProfilesValuesDP0303DP030030E(varAcs5ProfilesValuesDP0303DP030030E)
	}
...
type NullableAcs5ProfilesValuesDP0303DP030030E struct {
	value *Acs5ProfilesValuesDP0303DP030030E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0303DP030030E) Get() *Acs5ProfilesValuesDP0303DP030030E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0303DP030030E) Set(val *Acs5ProfilesValuesDP0303DP030030E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0303DP030030E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0303DP030030E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0303DP030030E(val *Acs5ProfilesValuesDP0303DP030030E) *NullableAcs5ProfilesValuesDP0303DP030030E {
	return &NullableAcs5ProfilesValuesDP0303DP030030E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0303DP030030E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0303DP030030E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0406DP040045PE struct for Acs5ProfilesValuesDP0406DP040045PE
type Acs5ProfilesValuesDP0406DP040045PE struct {
...
type _Acs5ProfilesValuesDP0406DP040045PE Acs5ProfilesValuesDP0406DP040045PE
...
func NewAcs5ProfilesValuesDP0406DP040045PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0406DP040045PE {
	this := Acs5ProfilesValuesDP0406DP040045PE{}
...
func (o Acs5ProfilesValuesDP0406DP040045PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0406DP040045PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0406DP040045PE := _Acs5ProfilesValuesDP0406DP040045PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0406DP040045PE); err == nil {
		*o = Acs5ProfilesValuesDP0406DP040045PE(varAcs5ProfilesValuesDP0406DP040045PE)
	}
...
type NullableAcs5ProfilesValuesDP0406DP040045PE struct {
	value *Acs5ProfilesValuesDP0406DP040045PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0406DP040045PE) Get() *Acs5ProfilesValuesDP0406DP040045PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0406DP040045PE) Set(val *Acs5ProfilesValuesDP0406DP040045PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0406DP040045PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0406DP040045PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0406DP040045PE(val *Acs5ProfilesValuesDP0406DP040045PE) *NullableAcs5ProfilesValuesDP0406DP040045PE {
	return &NullableAcs5ProfilesValuesDP0406DP040045PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0406DP040045PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0406DP040045PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

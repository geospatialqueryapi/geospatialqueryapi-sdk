...
type _Acs5ProfilesValuesDP0407DP040053E Acs5ProfilesValuesDP0407DP040053E
...
func NewAcs5ProfilesValuesDP0407DP040053E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0407DP040053E {
	this := Acs5ProfilesValuesDP0407DP040053E{}
...
func (o Acs5ProfilesValuesDP0407DP040053E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0407DP040053E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0407DP040053E := _Acs5ProfilesValuesDP0407DP040053E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0407DP040053E); err == nil {
		*o = Acs5ProfilesValuesDP0407DP040053E(varAcs5ProfilesValuesDP0407DP040053E)
	}
...
type NullableAcs5ProfilesValuesDP0407DP040053E struct {
	value *Acs5ProfilesValuesDP0407DP040053E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0407DP040053E) Get() *Acs5ProfilesValuesDP0407DP040053E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0407DP040053E) Set(val *Acs5ProfilesValuesDP0407DP040053E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0407DP040053E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0407DP040053E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0407DP040053E(val *Acs5ProfilesValuesDP0407DP040053E) *NullableAcs5ProfilesValuesDP0407DP040053E {
	return &NullableAcs5ProfilesValuesDP0407DP040053E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0407DP040053E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0407DP040053E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0209DP020080E struct for Acs5ProfilesValuesDP0209DP020080E
...
type _Acs5ProfilesValuesDP0209DP020080E Acs5ProfilesValuesDP0209DP020080E
...
func NewAcs5ProfilesValuesDP0209DP020080E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0209DP020080E {
	this := Acs5ProfilesValuesDP0209DP020080E{}
...
func (o Acs5ProfilesValuesDP0209DP020080E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0209DP020080E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0209DP020080E := _Acs5ProfilesValuesDP0209DP020080E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0209DP020080E); err == nil {
		*o = Acs5ProfilesValuesDP0209DP020080E(varAcs5ProfilesValuesDP0209DP020080E)
	}
...
type NullableAcs5ProfilesValuesDP0209DP020080E struct {
	value *Acs5ProfilesValuesDP0209DP020080E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0209DP020080E) Get() *Acs5ProfilesValuesDP0209DP020080E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0209DP020080E) Set(val *Acs5ProfilesValuesDP0209DP020080E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0209DP020080E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0209DP020080E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0209DP020080E(val *Acs5ProfilesValuesDP0209DP020080E) *NullableAcs5ProfilesValuesDP0209DP020080E {
	return &NullableAcs5ProfilesValuesDP0209DP020080E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0209DP020080E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0209DP020080E) UnmarshalJSON(src []byte) error {
	v.isSet = true

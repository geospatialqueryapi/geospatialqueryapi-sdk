...
// Acs5ProfilesValuesDP0410DP040091PE struct for Acs5ProfilesValuesDP0410DP040091PE
type Acs5ProfilesValuesDP0410DP040091PE struct {
...
type _Acs5ProfilesValuesDP0410DP040091PE Acs5ProfilesValuesDP0410DP040091PE
...
func NewAcs5ProfilesValuesDP0410DP040091PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0410DP040091PE {
	this := Acs5ProfilesValuesDP0410DP040091PE{}
...
func (o Acs5ProfilesValuesDP0410DP040091PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0410DP040091PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0410DP040091PE := _Acs5ProfilesValuesDP0410DP040091PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0410DP040091PE); err == nil {
		*o = Acs5ProfilesValuesDP0410DP040091PE(varAcs5ProfilesValuesDP0410DP040091PE)
	}
...
type NullableAcs5ProfilesValuesDP0410DP040091PE struct {
	value *Acs5ProfilesValuesDP0410DP040091PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0410DP040091PE) Get() *Acs5ProfilesValuesDP0410DP040091PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0410DP040091PE) Set(val *Acs5ProfilesValuesDP0410DP040091PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0410DP040091PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0410DP040091PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0410DP040091PE(val *Acs5ProfilesValuesDP0410DP040091PE) *NullableAcs5ProfilesValuesDP0410DP040091PE {
	return &NullableAcs5ProfilesValuesDP0410DP040091PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0410DP040091PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0410DP040091PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

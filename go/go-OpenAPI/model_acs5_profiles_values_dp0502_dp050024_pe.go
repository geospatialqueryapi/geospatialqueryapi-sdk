...
// Acs5ProfilesValuesDP0502DP050024PE struct for Acs5ProfilesValuesDP0502DP050024PE
type Acs5ProfilesValuesDP0502DP050024PE struct {
...
type _Acs5ProfilesValuesDP0502DP050024PE Acs5ProfilesValuesDP0502DP050024PE
...
func NewAcs5ProfilesValuesDP0502DP050024PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0502DP050024PE {
	this := Acs5ProfilesValuesDP0502DP050024PE{}
...
func (o Acs5ProfilesValuesDP0502DP050024PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0502DP050024PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0502DP050024PE := _Acs5ProfilesValuesDP0502DP050024PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0502DP050024PE); err == nil {
		*o = Acs5ProfilesValuesDP0502DP050024PE(varAcs5ProfilesValuesDP0502DP050024PE)
	}
...
type NullableAcs5ProfilesValuesDP0502DP050024PE struct {
	value *Acs5ProfilesValuesDP0502DP050024PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0502DP050024PE) Get() *Acs5ProfilesValuesDP0502DP050024PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0502DP050024PE) Set(val *Acs5ProfilesValuesDP0502DP050024PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0502DP050024PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0502DP050024PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0502DP050024PE(val *Acs5ProfilesValuesDP0502DP050024PE) *NullableAcs5ProfilesValuesDP0502DP050024PE {
	return &NullableAcs5ProfilesValuesDP0502DP050024PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0502DP050024PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0502DP050024PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

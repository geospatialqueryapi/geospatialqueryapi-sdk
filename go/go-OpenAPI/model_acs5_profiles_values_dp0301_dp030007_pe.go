...
// Acs5ProfilesValuesDP0301DP030007PE struct for Acs5ProfilesValuesDP0301DP030007PE
type Acs5ProfilesValuesDP0301DP030007PE struct {
...
type _Acs5ProfilesValuesDP0301DP030007PE Acs5ProfilesValuesDP0301DP030007PE
...
func NewAcs5ProfilesValuesDP0301DP030007PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0301DP030007PE {
	this := Acs5ProfilesValuesDP0301DP030007PE{}
...
func (o Acs5ProfilesValuesDP0301DP030007PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0301DP030007PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0301DP030007PE := _Acs5ProfilesValuesDP0301DP030007PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0301DP030007PE); err == nil {
		*o = Acs5ProfilesValuesDP0301DP030007PE(varAcs5ProfilesValuesDP0301DP030007PE)
	}
...
type NullableAcs5ProfilesValuesDP0301DP030007PE struct {
	value *Acs5ProfilesValuesDP0301DP030007PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0301DP030007PE) Get() *Acs5ProfilesValuesDP0301DP030007PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0301DP030007PE) Set(val *Acs5ProfilesValuesDP0301DP030007PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0301DP030007PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0301DP030007PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0301DP030007PE(val *Acs5ProfilesValuesDP0301DP030007PE) *NullableAcs5ProfilesValuesDP0301DP030007PE {
	return &NullableAcs5ProfilesValuesDP0301DP030007PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0301DP030007PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0301DP030007PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

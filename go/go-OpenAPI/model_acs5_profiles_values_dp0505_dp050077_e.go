...
type _Acs5ProfilesValuesDP0505DP050077E Acs5ProfilesValuesDP0505DP050077E
...
func NewAcs5ProfilesValuesDP0505DP050077E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0505DP050077E {
	this := Acs5ProfilesValuesDP0505DP050077E{}
...
func (o Acs5ProfilesValuesDP0505DP050077E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0505DP050077E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0505DP050077E := _Acs5ProfilesValuesDP0505DP050077E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0505DP050077E); err == nil {
		*o = Acs5ProfilesValuesDP0505DP050077E(varAcs5ProfilesValuesDP0505DP050077E)
	}
...
type NullableAcs5ProfilesValuesDP0505DP050077E struct {
	value *Acs5ProfilesValuesDP0505DP050077E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0505DP050077E) Get() *Acs5ProfilesValuesDP0505DP050077E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0505DP050077E) Set(val *Acs5ProfilesValuesDP0505DP050077E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0505DP050077E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0505DP050077E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0505DP050077E(val *Acs5ProfilesValuesDP0505DP050077E) *NullableAcs5ProfilesValuesDP0505DP050077E {
	return &NullableAcs5ProfilesValuesDP0505DP050077E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0505DP050077E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0505DP050077E) UnmarshalJSON(src []byte) error {
	v.isSet = true

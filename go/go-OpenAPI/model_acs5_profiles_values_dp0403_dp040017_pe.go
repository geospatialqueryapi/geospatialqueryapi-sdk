...
// Acs5ProfilesValuesDP0403DP040017PE struct for Acs5ProfilesValuesDP0403DP040017PE
type Acs5ProfilesValuesDP0403DP040017PE struct {
...
type _Acs5ProfilesValuesDP0403DP040017PE Acs5ProfilesValuesDP0403DP040017PE
...
func NewAcs5ProfilesValuesDP0403DP040017PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040017PE {
	this := Acs5ProfilesValuesDP0403DP040017PE{}
...
func (o Acs5ProfilesValuesDP0403DP040017PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040017PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040017PE := _Acs5ProfilesValuesDP0403DP040017PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040017PE); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040017PE(varAcs5ProfilesValuesDP0403DP040017PE)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040017PE struct {
	value *Acs5ProfilesValuesDP0403DP040017PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040017PE) Get() *Acs5ProfilesValuesDP0403DP040017PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040017PE) Set(val *Acs5ProfilesValuesDP0403DP040017PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040017PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040017PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040017PE(val *Acs5ProfilesValuesDP0403DP040017PE) *NullableAcs5ProfilesValuesDP0403DP040017PE {
	return &NullableAcs5ProfilesValuesDP0403DP040017PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040017PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040017PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

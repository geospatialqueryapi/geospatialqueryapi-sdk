...
// Acs5ProfilesValuesDP0503DP050027PE struct for Acs5ProfilesValuesDP0503DP050027PE
type Acs5ProfilesValuesDP0503DP050027PE struct {
...
type _Acs5ProfilesValuesDP0503DP050027PE Acs5ProfilesValuesDP0503DP050027PE
...
func NewAcs5ProfilesValuesDP0503DP050027PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0503DP050027PE {
	this := Acs5ProfilesValuesDP0503DP050027PE{}
...
func (o Acs5ProfilesValuesDP0503DP050027PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0503DP050027PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0503DP050027PE := _Acs5ProfilesValuesDP0503DP050027PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0503DP050027PE); err == nil {
		*o = Acs5ProfilesValuesDP0503DP050027PE(varAcs5ProfilesValuesDP0503DP050027PE)
	}
...
type NullableAcs5ProfilesValuesDP0503DP050027PE struct {
	value *Acs5ProfilesValuesDP0503DP050027PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0503DP050027PE) Get() *Acs5ProfilesValuesDP0503DP050027PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0503DP050027PE) Set(val *Acs5ProfilesValuesDP0503DP050027PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0503DP050027PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0503DP050027PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0503DP050027PE(val *Acs5ProfilesValuesDP0503DP050027PE) *NullableAcs5ProfilesValuesDP0503DP050027PE {
	return &NullableAcs5ProfilesValuesDP0503DP050027PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0503DP050027PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0503DP050027PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0505DP050070E struct for Acs5ProfilesValuesDP0505DP050070E
type Acs5ProfilesValuesDP0505DP050070E struct {
...
type _Acs5ProfilesValuesDP0505DP050070E Acs5ProfilesValuesDP0505DP050070E
...
func NewAcs5ProfilesValuesDP0505DP050070E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0505DP050070E {
	this := Acs5ProfilesValuesDP0505DP050070E{}
...
func (o Acs5ProfilesValuesDP0505DP050070E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0505DP050070E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0505DP050070E := _Acs5ProfilesValuesDP0505DP050070E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0505DP050070E); err == nil {
		*o = Acs5ProfilesValuesDP0505DP050070E(varAcs5ProfilesValuesDP0505DP050070E)
	}
...
type NullableAcs5ProfilesValuesDP0505DP050070E struct {
	value *Acs5ProfilesValuesDP0505DP050070E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0505DP050070E) Get() *Acs5ProfilesValuesDP0505DP050070E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0505DP050070E) Set(val *Acs5ProfilesValuesDP0505DP050070E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0505DP050070E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0505DP050070E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0505DP050070E(val *Acs5ProfilesValuesDP0505DP050070E) *NullableAcs5ProfilesValuesDP0505DP050070E {
	return &NullableAcs5ProfilesValuesDP0505DP050070E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0505DP050070E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0505DP050070E) UnmarshalJSON(src []byte) error {
	v.isSet = true

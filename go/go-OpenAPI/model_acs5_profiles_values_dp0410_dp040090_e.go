...
// Acs5ProfilesValuesDP0410DP040090E struct for Acs5ProfilesValuesDP0410DP040090E
type Acs5ProfilesValuesDP0410DP040090E struct {
...
type _Acs5ProfilesValuesDP0410DP040090E Acs5ProfilesValuesDP0410DP040090E
...
func NewAcs5ProfilesValuesDP0410DP040090E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0410DP040090E {
	this := Acs5ProfilesValuesDP0410DP040090E{}
...
func (o Acs5ProfilesValuesDP0410DP040090E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0410DP040090E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0410DP040090E := _Acs5ProfilesValuesDP0410DP040090E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0410DP040090E); err == nil {
		*o = Acs5ProfilesValuesDP0410DP040090E(varAcs5ProfilesValuesDP0410DP040090E)
	}
...
type NullableAcs5ProfilesValuesDP0410DP040090E struct {
	value *Acs5ProfilesValuesDP0410DP040090E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0410DP040090E) Get() *Acs5ProfilesValuesDP0410DP040090E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0410DP040090E) Set(val *Acs5ProfilesValuesDP0410DP040090E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0410DP040090E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0410DP040090E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0410DP040090E(val *Acs5ProfilesValuesDP0410DP040090E) *NullableAcs5ProfilesValuesDP0410DP040090E {
	return &NullableAcs5ProfilesValuesDP0410DP040090E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0410DP040090E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0410DP040090E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0504DP050036PE struct for Acs5ProfilesValuesDP0504DP050036PE
type Acs5ProfilesValuesDP0504DP050036PE struct {
...
type _Acs5ProfilesValuesDP0504DP050036PE Acs5ProfilesValuesDP0504DP050036PE
...
func NewAcs5ProfilesValuesDP0504DP050036PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0504DP050036PE {
	this := Acs5ProfilesValuesDP0504DP050036PE{}
...
func (o Acs5ProfilesValuesDP0504DP050036PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0504DP050036PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0504DP050036PE := _Acs5ProfilesValuesDP0504DP050036PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0504DP050036PE); err == nil {
		*o = Acs5ProfilesValuesDP0504DP050036PE(varAcs5ProfilesValuesDP0504DP050036PE)
	}
...
type NullableAcs5ProfilesValuesDP0504DP050036PE struct {
	value *Acs5ProfilesValuesDP0504DP050036PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0504DP050036PE) Get() *Acs5ProfilesValuesDP0504DP050036PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0504DP050036PE) Set(val *Acs5ProfilesValuesDP0504DP050036PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0504DP050036PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0504DP050036PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0504DP050036PE(val *Acs5ProfilesValuesDP0504DP050036PE) *NullableAcs5ProfilesValuesDP0504DP050036PE {
	return &NullableAcs5ProfilesValuesDP0504DP050036PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0504DP050036PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0504DP050036PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

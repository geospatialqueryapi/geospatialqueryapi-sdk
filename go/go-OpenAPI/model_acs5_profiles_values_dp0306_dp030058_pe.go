...
// Acs5ProfilesValuesDP0306DP030058PE struct for Acs5ProfilesValuesDP0306DP030058PE
type Acs5ProfilesValuesDP0306DP030058PE struct {
...
type _Acs5ProfilesValuesDP0306DP030058PE Acs5ProfilesValuesDP0306DP030058PE
...
func NewAcs5ProfilesValuesDP0306DP030058PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030058PE {
	this := Acs5ProfilesValuesDP0306DP030058PE{}
...
func (o Acs5ProfilesValuesDP0306DP030058PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030058PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030058PE := _Acs5ProfilesValuesDP0306DP030058PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030058PE); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030058PE(varAcs5ProfilesValuesDP0306DP030058PE)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030058PE struct {
	value *Acs5ProfilesValuesDP0306DP030058PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030058PE) Get() *Acs5ProfilesValuesDP0306DP030058PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030058PE) Set(val *Acs5ProfilesValuesDP0306DP030058PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030058PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030058PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030058PE(val *Acs5ProfilesValuesDP0306DP030058PE) *NullableAcs5ProfilesValuesDP0306DP030058PE {
	return &NullableAcs5ProfilesValuesDP0306DP030058PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030058PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030058PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

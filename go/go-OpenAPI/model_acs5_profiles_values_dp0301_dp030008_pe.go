...
// Acs5ProfilesValuesDP0301DP030008PE struct for Acs5ProfilesValuesDP0301DP030008PE
...
type _Acs5ProfilesValuesDP0301DP030008PE Acs5ProfilesValuesDP0301DP030008PE
...
func NewAcs5ProfilesValuesDP0301DP030008PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0301DP030008PE {
	this := Acs5ProfilesValuesDP0301DP030008PE{}
...
func (o Acs5ProfilesValuesDP0301DP030008PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0301DP030008PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0301DP030008PE := _Acs5ProfilesValuesDP0301DP030008PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0301DP030008PE); err == nil {
		*o = Acs5ProfilesValuesDP0301DP030008PE(varAcs5ProfilesValuesDP0301DP030008PE)
	}
...
type NullableAcs5ProfilesValuesDP0301DP030008PE struct {
	value *Acs5ProfilesValuesDP0301DP030008PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0301DP030008PE) Get() *Acs5ProfilesValuesDP0301DP030008PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0301DP030008PE) Set(val *Acs5ProfilesValuesDP0301DP030008PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0301DP030008PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0301DP030008PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0301DP030008PE(val *Acs5ProfilesValuesDP0301DP030008PE) *NullableAcs5ProfilesValuesDP0301DP030008PE {
	return &NullableAcs5ProfilesValuesDP0301DP030008PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0301DP030008PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0301DP030008PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

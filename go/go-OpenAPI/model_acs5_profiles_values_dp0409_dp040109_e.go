...
// Acs5ProfilesValuesDP0409DP040109E Housing units without a mortgage: Median (dollars)
type Acs5ProfilesValuesDP0409DP040109E struct {
	// DP04_0109E
...
type _Acs5ProfilesValuesDP0409DP040109E Acs5ProfilesValuesDP0409DP040109E
...
func NewAcs5ProfilesValuesDP0409DP040109E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0409DP040109E {
	this := Acs5ProfilesValuesDP0409DP040109E{}
...
func (o Acs5ProfilesValuesDP0409DP040109E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0409DP040109E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0409DP040109E := _Acs5ProfilesValuesDP0409DP040109E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0409DP040109E); err == nil {
		*o = Acs5ProfilesValuesDP0409DP040109E(varAcs5ProfilesValuesDP0409DP040109E)
	}
...
type NullableAcs5ProfilesValuesDP0409DP040109E struct {
	value *Acs5ProfilesValuesDP0409DP040109E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0409DP040109E) Get() *Acs5ProfilesValuesDP0409DP040109E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0409DP040109E) Set(val *Acs5ProfilesValuesDP0409DP040109E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0409DP040109E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0409DP040109E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0409DP040109E(val *Acs5ProfilesValuesDP0409DP040109E) *NullableAcs5ProfilesValuesDP0409DP040109E {
	return &NullableAcs5ProfilesValuesDP0409DP040109E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0409DP040109E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0409DP040109E) UnmarshalJSON(src []byte) error {
	v.isSet = true

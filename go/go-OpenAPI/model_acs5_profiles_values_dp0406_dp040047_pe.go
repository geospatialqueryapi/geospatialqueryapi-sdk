...
// Acs5ProfilesValuesDP0406DP040047PE struct for Acs5ProfilesValuesDP0406DP040047PE
type Acs5ProfilesValuesDP0406DP040047PE struct {
...
type _Acs5ProfilesValuesDP0406DP040047PE Acs5ProfilesValuesDP0406DP040047PE
...
func NewAcs5ProfilesValuesDP0406DP040047PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0406DP040047PE {
	this := Acs5ProfilesValuesDP0406DP040047PE{}
...
func (o Acs5ProfilesValuesDP0406DP040047PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0406DP040047PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0406DP040047PE := _Acs5ProfilesValuesDP0406DP040047PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0406DP040047PE); err == nil {
		*o = Acs5ProfilesValuesDP0406DP040047PE(varAcs5ProfilesValuesDP0406DP040047PE)
	}
...
type NullableAcs5ProfilesValuesDP0406DP040047PE struct {
	value *Acs5ProfilesValuesDP0406DP040047PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0406DP040047PE) Get() *Acs5ProfilesValuesDP0406DP040047PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0406DP040047PE) Set(val *Acs5ProfilesValuesDP0406DP040047PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0406DP040047PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0406DP040047PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0406DP040047PE(val *Acs5ProfilesValuesDP0406DP040047PE) *NullableAcs5ProfilesValuesDP0406DP040047PE {
	return &NullableAcs5ProfilesValuesDP0406DP040047PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0406DP040047PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0406DP040047PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

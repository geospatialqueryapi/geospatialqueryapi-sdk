...
// Acs5ProfilesValuesDP0207DP020066PE Population 25 years and over: Graduate or professional degree (percent)
type Acs5ProfilesValuesDP0207DP020066PE struct {
	// DP02_0066PE
...
type _Acs5ProfilesValuesDP0207DP020066PE Acs5ProfilesValuesDP0207DP020066PE
...
func NewAcs5ProfilesValuesDP0207DP020066PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0207DP020066PE {
	this := Acs5ProfilesValuesDP0207DP020066PE{}
...
func (o Acs5ProfilesValuesDP0207DP020066PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0207DP020066PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0207DP020066PE := _Acs5ProfilesValuesDP0207DP020066PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0207DP020066PE); err == nil {
		*o = Acs5ProfilesValuesDP0207DP020066PE(varAcs5ProfilesValuesDP0207DP020066PE)
	}
...
type NullableAcs5ProfilesValuesDP0207DP020066PE struct {
	value *Acs5ProfilesValuesDP0207DP020066PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0207DP020066PE) Get() *Acs5ProfilesValuesDP0207DP020066PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0207DP020066PE) Set(val *Acs5ProfilesValuesDP0207DP020066PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0207DP020066PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0207DP020066PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0207DP020066PE(val *Acs5ProfilesValuesDP0207DP020066PE) *NullableAcs5ProfilesValuesDP0207DP020066PE {
	return &NullableAcs5ProfilesValuesDP0207DP020066PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0207DP020066PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0207DP020066PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0207DP020065PE Population 25 years and over: Bachelor's degree (percent)
type Acs5ProfilesValuesDP0207DP020065PE struct {
	// DP02_0065PE
...
type _Acs5ProfilesValuesDP0207DP020065PE Acs5ProfilesValuesDP0207DP020065PE
...
func NewAcs5ProfilesValuesDP0207DP020065PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0207DP020065PE {
	this := Acs5ProfilesValuesDP0207DP020065PE{}
...
func (o Acs5ProfilesValuesDP0207DP020065PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0207DP020065PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0207DP020065PE := _Acs5ProfilesValuesDP0207DP020065PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0207DP020065PE); err == nil {
		*o = Acs5ProfilesValuesDP0207DP020065PE(varAcs5ProfilesValuesDP0207DP020065PE)
	}
...
type NullableAcs5ProfilesValuesDP0207DP020065PE struct {
	value *Acs5ProfilesValuesDP0207DP020065PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0207DP020065PE) Get() *Acs5ProfilesValuesDP0207DP020065PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0207DP020065PE) Set(val *Acs5ProfilesValuesDP0207DP020065PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0207DP020065PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0207DP020065PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0207DP020065PE(val *Acs5ProfilesValuesDP0207DP020065PE) *NullableAcs5ProfilesValuesDP0207DP020065PE {
	return &NullableAcs5ProfilesValuesDP0207DP020065PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0207DP020065PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0207DP020065PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

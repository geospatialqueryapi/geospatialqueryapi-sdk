...
// Acs5ProfilesValuesDP0403DP040023E struct for Acs5ProfilesValuesDP0403DP040023E
type Acs5ProfilesValuesDP0403DP040023E struct {
...
type _Acs5ProfilesValuesDP0403DP040023E Acs5ProfilesValuesDP0403DP040023E
...
func NewAcs5ProfilesValuesDP0403DP040023E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0403DP040023E {
	this := Acs5ProfilesValuesDP0403DP040023E{}
...
func (o Acs5ProfilesValuesDP0403DP040023E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0403DP040023E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0403DP040023E := _Acs5ProfilesValuesDP0403DP040023E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0403DP040023E); err == nil {
		*o = Acs5ProfilesValuesDP0403DP040023E(varAcs5ProfilesValuesDP0403DP040023E)
	}
...
type NullableAcs5ProfilesValuesDP0403DP040023E struct {
	value *Acs5ProfilesValuesDP0403DP040023E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0403DP040023E) Get() *Acs5ProfilesValuesDP0403DP040023E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0403DP040023E) Set(val *Acs5ProfilesValuesDP0403DP040023E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0403DP040023E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0403DP040023E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0403DP040023E(val *Acs5ProfilesValuesDP0403DP040023E) *NullableAcs5ProfilesValuesDP0403DP040023E {
	return &NullableAcs5ProfilesValuesDP0403DP040023E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0403DP040023E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0403DP040023E) UnmarshalJSON(src []byte) error {
	v.isSet = true

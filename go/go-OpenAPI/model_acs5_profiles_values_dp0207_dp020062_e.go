...
// Acs5ProfilesValuesDP0207DP020062E Population 25 years and over: High school graduate
type Acs5ProfilesValuesDP0207DP020062E struct {
	// DP02_0062E
...
type _Acs5ProfilesValuesDP0207DP020062E Acs5ProfilesValuesDP0207DP020062E
...
func NewAcs5ProfilesValuesDP0207DP020062E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0207DP020062E {
	this := Acs5ProfilesValuesDP0207DP020062E{}
...
func (o Acs5ProfilesValuesDP0207DP020062E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0207DP020062E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0207DP020062E := _Acs5ProfilesValuesDP0207DP020062E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0207DP020062E); err == nil {
		*o = Acs5ProfilesValuesDP0207DP020062E(varAcs5ProfilesValuesDP0207DP020062E)
	}
...
type NullableAcs5ProfilesValuesDP0207DP020062E struct {
	value *Acs5ProfilesValuesDP0207DP020062E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0207DP020062E) Get() *Acs5ProfilesValuesDP0207DP020062E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0207DP020062E) Set(val *Acs5ProfilesValuesDP0207DP020062E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0207DP020062E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0207DP020062E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0207DP020062E(val *Acs5ProfilesValuesDP0207DP020062E) *NullableAcs5ProfilesValuesDP0207DP020062E {
	return &NullableAcs5ProfilesValuesDP0207DP020062E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0207DP020062E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0207DP020062E) UnmarshalJSON(src []byte) error {
	v.isSet = true

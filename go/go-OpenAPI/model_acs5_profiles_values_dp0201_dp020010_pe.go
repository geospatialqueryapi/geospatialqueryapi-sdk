...
// Acs5ProfilesValuesDP0201DP020010PE Female householder, no spouse/partner present (percent)
type Acs5ProfilesValuesDP0201DP020010PE struct {
	// DP02_0010PE
...
type _Acs5ProfilesValuesDP0201DP020010PE Acs5ProfilesValuesDP0201DP020010PE
...
func NewAcs5ProfilesValuesDP0201DP020010PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0201DP020010PE {
	this := Acs5ProfilesValuesDP0201DP020010PE{}
...
func (o Acs5ProfilesValuesDP0201DP020010PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0201DP020010PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0201DP020010PE := _Acs5ProfilesValuesDP0201DP020010PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0201DP020010PE); err == nil {
		*o = Acs5ProfilesValuesDP0201DP020010PE(varAcs5ProfilesValuesDP0201DP020010PE)
	}
...
type NullableAcs5ProfilesValuesDP0201DP020010PE struct {
	value *Acs5ProfilesValuesDP0201DP020010PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0201DP020010PE) Get() *Acs5ProfilesValuesDP0201DP020010PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0201DP020010PE) Set(val *Acs5ProfilesValuesDP0201DP020010PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0201DP020010PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0201DP020010PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0201DP020010PE(val *Acs5ProfilesValuesDP0201DP020010PE) *NullableAcs5ProfilesValuesDP0201DP020010PE {
	return &NullableAcs5ProfilesValuesDP0201DP020010PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0201DP020010PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0201DP020010PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

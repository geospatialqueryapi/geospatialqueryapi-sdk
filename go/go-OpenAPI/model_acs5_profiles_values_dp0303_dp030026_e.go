...
// Acs5ProfilesValuesDP0303DP030026E Civilian employed population 16 years and over
type Acs5ProfilesValuesDP0303DP030026E struct {
	// DP03_0026E
...
type _Acs5ProfilesValuesDP0303DP030026E Acs5ProfilesValuesDP0303DP030026E
...
func NewAcs5ProfilesValuesDP0303DP030026E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0303DP030026E {
	this := Acs5ProfilesValuesDP0303DP030026E{}
...
func (o Acs5ProfilesValuesDP0303DP030026E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0303DP030026E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0303DP030026E := _Acs5ProfilesValuesDP0303DP030026E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0303DP030026E); err == nil {
		*o = Acs5ProfilesValuesDP0303DP030026E(varAcs5ProfilesValuesDP0303DP030026E)
	}
...
type NullableAcs5ProfilesValuesDP0303DP030026E struct {
	value *Acs5ProfilesValuesDP0303DP030026E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0303DP030026E) Get() *Acs5ProfilesValuesDP0303DP030026E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0303DP030026E) Set(val *Acs5ProfilesValuesDP0303DP030026E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0303DP030026E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0303DP030026E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0303DP030026E(val *Acs5ProfilesValuesDP0303DP030026E) *NullableAcs5ProfilesValuesDP0303DP030026E {
	return &NullableAcs5ProfilesValuesDP0303DP030026E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0303DP030026E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0303DP030026E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0303DP030029E struct for Acs5ProfilesValuesDP0303DP030029E
type Acs5ProfilesValuesDP0303DP030029E struct {
...
type _Acs5ProfilesValuesDP0303DP030029E Acs5ProfilesValuesDP0303DP030029E
...
func NewAcs5ProfilesValuesDP0303DP030029E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0303DP030029E {
	this := Acs5ProfilesValuesDP0303DP030029E{}
...
func (o Acs5ProfilesValuesDP0303DP030029E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0303DP030029E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0303DP030029E := _Acs5ProfilesValuesDP0303DP030029E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0303DP030029E); err == nil {
		*o = Acs5ProfilesValuesDP0303DP030029E(varAcs5ProfilesValuesDP0303DP030029E)
	}
...
type NullableAcs5ProfilesValuesDP0303DP030029E struct {
	value *Acs5ProfilesValuesDP0303DP030029E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0303DP030029E) Get() *Acs5ProfilesValuesDP0303DP030029E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0303DP030029E) Set(val *Acs5ProfilesValuesDP0303DP030029E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0303DP030029E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0303DP030029E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0303DP030029E(val *Acs5ProfilesValuesDP0303DP030029E) *NullableAcs5ProfilesValuesDP0303DP030029E {
	return &NullableAcs5ProfilesValuesDP0303DP030029E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0303DP030029E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0303DP030029E) UnmarshalJSON(src []byte) error {
	v.isSet = true

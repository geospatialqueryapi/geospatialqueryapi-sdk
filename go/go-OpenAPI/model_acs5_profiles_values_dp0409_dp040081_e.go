...
// Acs5ProfilesValuesDP0409DP040081E struct for Acs5ProfilesValuesDP0409DP040081E
type Acs5ProfilesValuesDP0409DP040081E struct {
...
type _Acs5ProfilesValuesDP0409DP040081E Acs5ProfilesValuesDP0409DP040081E
...
func NewAcs5ProfilesValuesDP0409DP040081E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0409DP040081E {
	this := Acs5ProfilesValuesDP0409DP040081E{}
...
func (o Acs5ProfilesValuesDP0409DP040081E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0409DP040081E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0409DP040081E := _Acs5ProfilesValuesDP0409DP040081E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0409DP040081E); err == nil {
		*o = Acs5ProfilesValuesDP0409DP040081E(varAcs5ProfilesValuesDP0409DP040081E)
	}
...
type NullableAcs5ProfilesValuesDP0409DP040081E struct {
	value *Acs5ProfilesValuesDP0409DP040081E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0409DP040081E) Get() *Acs5ProfilesValuesDP0409DP040081E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0409DP040081E) Set(val *Acs5ProfilesValuesDP0409DP040081E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0409DP040081E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0409DP040081E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0409DP040081E(val *Acs5ProfilesValuesDP0409DP040081E) *NullableAcs5ProfilesValuesDP0409DP040081E {
	return &NullableAcs5ProfilesValuesDP0409DP040081E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0409DP040081E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0409DP040081E) UnmarshalJSON(src []byte) error {
	v.isSet = true

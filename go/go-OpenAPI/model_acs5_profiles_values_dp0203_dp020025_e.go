...
// Acs5ProfilesValuesDP0203DP020025E struct for Acs5ProfilesValuesDP0203DP020025E
type Acs5ProfilesValuesDP0203DP020025E struct {
...
type _Acs5ProfilesValuesDP0203DP020025E Acs5ProfilesValuesDP0203DP020025E
...
func NewAcs5ProfilesValuesDP0203DP020025E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0203DP020025E {
	this := Acs5ProfilesValuesDP0203DP020025E{}
...
func (o Acs5ProfilesValuesDP0203DP020025E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0203DP020025E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0203DP020025E := _Acs5ProfilesValuesDP0203DP020025E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0203DP020025E); err == nil {
		*o = Acs5ProfilesValuesDP0203DP020025E(varAcs5ProfilesValuesDP0203DP020025E)
	}
...
type NullableAcs5ProfilesValuesDP0203DP020025E struct {
	value *Acs5ProfilesValuesDP0203DP020025E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0203DP020025E) Get() *Acs5ProfilesValuesDP0203DP020025E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0203DP020025E) Set(val *Acs5ProfilesValuesDP0203DP020025E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0203DP020025E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0203DP020025E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0203DP020025E(val *Acs5ProfilesValuesDP0203DP020025E) *NullableAcs5ProfilesValuesDP0203DP020025E {
	return &NullableAcs5ProfilesValuesDP0203DP020025E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0203DP020025E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0203DP020025E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0303DP030029PE struct for Acs5ProfilesValuesDP0303DP030029PE
type Acs5ProfilesValuesDP0303DP030029PE struct {
...
type _Acs5ProfilesValuesDP0303DP030029PE Acs5ProfilesValuesDP0303DP030029PE
...
func NewAcs5ProfilesValuesDP0303DP030029PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0303DP030029PE {
	this := Acs5ProfilesValuesDP0303DP030029PE{}
...
func (o Acs5ProfilesValuesDP0303DP030029PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0303DP030029PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0303DP030029PE := _Acs5ProfilesValuesDP0303DP030029PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0303DP030029PE); err == nil {
		*o = Acs5ProfilesValuesDP0303DP030029PE(varAcs5ProfilesValuesDP0303DP030029PE)
	}
...
type NullableAcs5ProfilesValuesDP0303DP030029PE struct {
	value *Acs5ProfilesValuesDP0303DP030029PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0303DP030029PE) Get() *Acs5ProfilesValuesDP0303DP030029PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0303DP030029PE) Set(val *Acs5ProfilesValuesDP0303DP030029PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0303DP030029PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0303DP030029PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0303DP030029PE(val *Acs5ProfilesValuesDP0303DP030029PE) *NullableAcs5ProfilesValuesDP0303DP030029PE {
	return &NullableAcs5ProfilesValuesDP0303DP030029PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0303DP030029PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0303DP030029PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

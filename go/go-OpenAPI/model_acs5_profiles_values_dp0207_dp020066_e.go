...
// Acs5ProfilesValuesDP0207DP020066E Population 25 years and over- Graduate or professional degree
type Acs5ProfilesValuesDP0207DP020066E struct {
	// DP02_0066E
...
type _Acs5ProfilesValuesDP0207DP020066E Acs5ProfilesValuesDP0207DP020066E
...
func NewAcs5ProfilesValuesDP0207DP020066E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0207DP020066E {
	this := Acs5ProfilesValuesDP0207DP020066E{}
...
func (o Acs5ProfilesValuesDP0207DP020066E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0207DP020066E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0207DP020066E := _Acs5ProfilesValuesDP0207DP020066E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0207DP020066E); err == nil {
		*o = Acs5ProfilesValuesDP0207DP020066E(varAcs5ProfilesValuesDP0207DP020066E)
	}
...
type NullableAcs5ProfilesValuesDP0207DP020066E struct {
	value *Acs5ProfilesValuesDP0207DP020066E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0207DP020066E) Get() *Acs5ProfilesValuesDP0207DP020066E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0207DP020066E) Set(val *Acs5ProfilesValuesDP0207DP020066E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0207DP020066E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0207DP020066E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0207DP020066E(val *Acs5ProfilesValuesDP0207DP020066E) *NullableAcs5ProfilesValuesDP0207DP020066E {
	return &NullableAcs5ProfilesValuesDP0207DP020066E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0207DP020066E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0207DP020066E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0409DP040084PE struct for Acs5ProfilesValuesDP0409DP040084PE
type Acs5ProfilesValuesDP0409DP040084PE struct {
...
type _Acs5ProfilesValuesDP0409DP040084PE Acs5ProfilesValuesDP0409DP040084PE
...
func NewAcs5ProfilesValuesDP0409DP040084PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0409DP040084PE {
	this := Acs5ProfilesValuesDP0409DP040084PE{}
...
func (o Acs5ProfilesValuesDP0409DP040084PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0409DP040084PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0409DP040084PE := _Acs5ProfilesValuesDP0409DP040084PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0409DP040084PE); err == nil {
		*o = Acs5ProfilesValuesDP0409DP040084PE(varAcs5ProfilesValuesDP0409DP040084PE)
	}
...
type NullableAcs5ProfilesValuesDP0409DP040084PE struct {
	value *Acs5ProfilesValuesDP0409DP040084PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0409DP040084PE) Get() *Acs5ProfilesValuesDP0409DP040084PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0409DP040084PE) Set(val *Acs5ProfilesValuesDP0409DP040084PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0409DP040084PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0409DP040084PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0409DP040084PE(val *Acs5ProfilesValuesDP0409DP040084PE) *NullableAcs5ProfilesValuesDP0409DP040084PE {
	return &NullableAcs5ProfilesValuesDP0409DP040084PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0409DP040084PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0409DP040084PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

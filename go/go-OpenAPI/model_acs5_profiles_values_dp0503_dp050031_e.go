...
// Acs5ProfilesValuesDP0503DP050031E struct for Acs5ProfilesValuesDP0503DP050031E
type Acs5ProfilesValuesDP0503DP050031E struct {
...
type _Acs5ProfilesValuesDP0503DP050031E Acs5ProfilesValuesDP0503DP050031E
...
func NewAcs5ProfilesValuesDP0503DP050031E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0503DP050031E {
	this := Acs5ProfilesValuesDP0503DP050031E{}
...
func (o Acs5ProfilesValuesDP0503DP050031E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0503DP050031E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0503DP050031E := _Acs5ProfilesValuesDP0503DP050031E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0503DP050031E); err == nil {
		*o = Acs5ProfilesValuesDP0503DP050031E(varAcs5ProfilesValuesDP0503DP050031E)
	}
...
type NullableAcs5ProfilesValuesDP0503DP050031E struct {
	value *Acs5ProfilesValuesDP0503DP050031E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0503DP050031E) Get() *Acs5ProfilesValuesDP0503DP050031E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0503DP050031E) Set(val *Acs5ProfilesValuesDP0503DP050031E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0503DP050031E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0503DP050031E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0503DP050031E(val *Acs5ProfilesValuesDP0503DP050031E) *NullableAcs5ProfilesValuesDP0503DP050031E {
	return &NullableAcs5ProfilesValuesDP0503DP050031E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0503DP050031E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0503DP050031E) UnmarshalJSON(src []byte) error {
	v.isSet = true

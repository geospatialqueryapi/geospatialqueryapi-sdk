...
// Acs5ProfilesValuesDP0501DP050001E struct for Acs5ProfilesValuesDP0501DP050001E
type Acs5ProfilesValuesDP0501DP050001E struct {
...
type _Acs5ProfilesValuesDP0501DP050001E Acs5ProfilesValuesDP0501DP050001E
...
func NewAcs5ProfilesValuesDP0501DP050001E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0501DP050001E {
	this := Acs5ProfilesValuesDP0501DP050001E{}
...
func (o Acs5ProfilesValuesDP0501DP050001E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0501DP050001E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0501DP050001E := _Acs5ProfilesValuesDP0501DP050001E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0501DP050001E); err == nil {
		*o = Acs5ProfilesValuesDP0501DP050001E(varAcs5ProfilesValuesDP0501DP050001E)
	}
...
type NullableAcs5ProfilesValuesDP0501DP050001E struct {
	value *Acs5ProfilesValuesDP0501DP050001E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0501DP050001E) Get() *Acs5ProfilesValuesDP0501DP050001E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0501DP050001E) Set(val *Acs5ProfilesValuesDP0501DP050001E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0501DP050001E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0501DP050001E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0501DP050001E(val *Acs5ProfilesValuesDP0501DP050001E) *NullableAcs5ProfilesValuesDP0501DP050001E {
	return &NullableAcs5ProfilesValuesDP0501DP050001E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0501DP050001E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0501DP050001E) UnmarshalJSON(src []byte) error {
	v.isSet = true

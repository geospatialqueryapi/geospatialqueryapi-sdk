...
// Acs5ProfilesValuesDP0305DP030050PE struct for Acs5ProfilesValuesDP0305DP030050PE
type Acs5ProfilesValuesDP0305DP030050PE struct {
...
type _Acs5ProfilesValuesDP0305DP030050PE Acs5ProfilesValuesDP0305DP030050PE
...
func NewAcs5ProfilesValuesDP0305DP030050PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0305DP030050PE {
	this := Acs5ProfilesValuesDP0305DP030050PE{}
...
func (o Acs5ProfilesValuesDP0305DP030050PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0305DP030050PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0305DP030050PE := _Acs5ProfilesValuesDP0305DP030050PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0305DP030050PE); err == nil {
		*o = Acs5ProfilesValuesDP0305DP030050PE(varAcs5ProfilesValuesDP0305DP030050PE)
	}
...
type NullableAcs5ProfilesValuesDP0305DP030050PE struct {
	value *Acs5ProfilesValuesDP0305DP030050PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0305DP030050PE) Get() *Acs5ProfilesValuesDP0305DP030050PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0305DP030050PE) Set(val *Acs5ProfilesValuesDP0305DP030050PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0305DP030050PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0305DP030050PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0305DP030050PE(val *Acs5ProfilesValuesDP0305DP030050PE) *NullableAcs5ProfilesValuesDP0305DP030050PE {
	return &NullableAcs5ProfilesValuesDP0305DP030050PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0305DP030050PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0305DP030050PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

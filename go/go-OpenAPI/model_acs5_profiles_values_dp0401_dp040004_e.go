...
// Acs5ProfilesValuesDP0401DP040004E struct for Acs5ProfilesValuesDP0401DP040004E
type Acs5ProfilesValuesDP0401DP040004E struct {
...
type _Acs5ProfilesValuesDP0401DP040004E Acs5ProfilesValuesDP0401DP040004E
...
func NewAcs5ProfilesValuesDP0401DP040004E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0401DP040004E {
	this := Acs5ProfilesValuesDP0401DP040004E{}
...
func (o Acs5ProfilesValuesDP0401DP040004E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0401DP040004E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0401DP040004E := _Acs5ProfilesValuesDP0401DP040004E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0401DP040004E); err == nil {
		*o = Acs5ProfilesValuesDP0401DP040004E(varAcs5ProfilesValuesDP0401DP040004E)
	}
...
type NullableAcs5ProfilesValuesDP0401DP040004E struct {
	value *Acs5ProfilesValuesDP0401DP040004E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0401DP040004E) Get() *Acs5ProfilesValuesDP0401DP040004E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0401DP040004E) Set(val *Acs5ProfilesValuesDP0401DP040004E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0401DP040004E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0401DP040004E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0401DP040004E(val *Acs5ProfilesValuesDP0401DP040004E) *NullableAcs5ProfilesValuesDP0401DP040004E {
	return &NullableAcs5ProfilesValuesDP0401DP040004E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0401DP040004E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0401DP040004E) UnmarshalJSON(src []byte) error {
	v.isSet = true

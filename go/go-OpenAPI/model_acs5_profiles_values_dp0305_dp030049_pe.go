...
// Acs5ProfilesValuesDP0305DP030049PE Self-employed in own not incorporated business workers (percent)
type Acs5ProfilesValuesDP0305DP030049PE struct {
	// DP03_0049PE
...
type _Acs5ProfilesValuesDP0305DP030049PE Acs5ProfilesValuesDP0305DP030049PE
...
func NewAcs5ProfilesValuesDP0305DP030049PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0305DP030049PE {
	this := Acs5ProfilesValuesDP0305DP030049PE{}
...
func (o Acs5ProfilesValuesDP0305DP030049PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0305DP030049PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0305DP030049PE := _Acs5ProfilesValuesDP0305DP030049PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0305DP030049PE); err == nil {
		*o = Acs5ProfilesValuesDP0305DP030049PE(varAcs5ProfilesValuesDP0305DP030049PE)
	}
...
type NullableAcs5ProfilesValuesDP0305DP030049PE struct {
	value *Acs5ProfilesValuesDP0305DP030049PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0305DP030049PE) Get() *Acs5ProfilesValuesDP0305DP030049PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0305DP030049PE) Set(val *Acs5ProfilesValuesDP0305DP030049PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0305DP030049PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0305DP030049PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0305DP030049PE(val *Acs5ProfilesValuesDP0305DP030049PE) *NullableAcs5ProfilesValuesDP0305DP030049PE {
	return &NullableAcs5ProfilesValuesDP0305DP030049PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0305DP030049PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0305DP030049PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

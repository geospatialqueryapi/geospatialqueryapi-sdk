...
// Acs5ProfilesValuesDP0201DP020011PE Female householder, no spouse/partner present: With own children of the householder under 18 years (percent)
type Acs5ProfilesValuesDP0201DP020011PE struct {
	// DP02_0011PE
...
type _Acs5ProfilesValuesDP0201DP020011PE Acs5ProfilesValuesDP0201DP020011PE
...
func NewAcs5ProfilesValuesDP0201DP020011PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0201DP020011PE {
	this := Acs5ProfilesValuesDP0201DP020011PE{}
...
func (o Acs5ProfilesValuesDP0201DP020011PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0201DP020011PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0201DP020011PE := _Acs5ProfilesValuesDP0201DP020011PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0201DP020011PE); err == nil {
		*o = Acs5ProfilesValuesDP0201DP020011PE(varAcs5ProfilesValuesDP0201DP020011PE)
	}
...
type NullableAcs5ProfilesValuesDP0201DP020011PE struct {
	value *Acs5ProfilesValuesDP0201DP020011PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0201DP020011PE) Get() *Acs5ProfilesValuesDP0201DP020011PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0201DP020011PE) Set(val *Acs5ProfilesValuesDP0201DP020011PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0201DP020011PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0201DP020011PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0201DP020011PE(val *Acs5ProfilesValuesDP0201DP020011PE) *NullableAcs5ProfilesValuesDP0201DP020011PE {
	return &NullableAcs5ProfilesValuesDP0201DP020011PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0201DP020011PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0201DP020011PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

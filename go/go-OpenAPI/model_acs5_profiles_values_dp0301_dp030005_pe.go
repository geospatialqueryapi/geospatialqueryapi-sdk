...
// Acs5ProfilesValuesDP0301DP030005PE struct for Acs5ProfilesValuesDP0301DP030005PE
type Acs5ProfilesValuesDP0301DP030005PE struct {
...
type _Acs5ProfilesValuesDP0301DP030005PE Acs5ProfilesValuesDP0301DP030005PE
...
func NewAcs5ProfilesValuesDP0301DP030005PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0301DP030005PE {
	this := Acs5ProfilesValuesDP0301DP030005PE{}
...
func (o Acs5ProfilesValuesDP0301DP030005PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0301DP030005PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0301DP030005PE := _Acs5ProfilesValuesDP0301DP030005PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0301DP030005PE); err == nil {
		*o = Acs5ProfilesValuesDP0301DP030005PE(varAcs5ProfilesValuesDP0301DP030005PE)
	}
...
type NullableAcs5ProfilesValuesDP0301DP030005PE struct {
	value *Acs5ProfilesValuesDP0301DP030005PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0301DP030005PE) Get() *Acs5ProfilesValuesDP0301DP030005PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0301DP030005PE) Set(val *Acs5ProfilesValuesDP0301DP030005PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0301DP030005PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0301DP030005PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0301DP030005PE(val *Acs5ProfilesValuesDP0301DP030005PE) *NullableAcs5ProfilesValuesDP0301DP030005PE {
	return &NullableAcs5ProfilesValuesDP0301DP030005PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0301DP030005PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0301DP030005PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

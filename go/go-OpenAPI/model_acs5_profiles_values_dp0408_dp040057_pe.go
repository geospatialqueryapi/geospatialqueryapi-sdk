...
// Acs5ProfilesValuesDP0408DP040057PE struct for Acs5ProfilesValuesDP0408DP040057PE
type Acs5ProfilesValuesDP0408DP040057PE struct {
...
type _Acs5ProfilesValuesDP0408DP040057PE Acs5ProfilesValuesDP0408DP040057PE
...
func NewAcs5ProfilesValuesDP0408DP040057PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0408DP040057PE {
	this := Acs5ProfilesValuesDP0408DP040057PE{}
...
func (o Acs5ProfilesValuesDP0408DP040057PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0408DP040057PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0408DP040057PE := _Acs5ProfilesValuesDP0408DP040057PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0408DP040057PE); err == nil {
		*o = Acs5ProfilesValuesDP0408DP040057PE(varAcs5ProfilesValuesDP0408DP040057PE)
	}
...
type NullableAcs5ProfilesValuesDP0408DP040057PE struct {
	value *Acs5ProfilesValuesDP0408DP040057PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0408DP040057PE) Get() *Acs5ProfilesValuesDP0408DP040057PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0408DP040057PE) Set(val *Acs5ProfilesValuesDP0408DP040057PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0408DP040057PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0408DP040057PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0408DP040057PE(val *Acs5ProfilesValuesDP0408DP040057PE) *NullableAcs5ProfilesValuesDP0408DP040057PE {
	return &NullableAcs5ProfilesValuesDP0408DP040057PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0408DP040057PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0408DP040057PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

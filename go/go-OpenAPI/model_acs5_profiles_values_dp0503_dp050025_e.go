...
// Acs5ProfilesValuesDP0503DP050025E struct for Acs5ProfilesValuesDP0503DP050025E
type Acs5ProfilesValuesDP0503DP050025E struct {
...
type _Acs5ProfilesValuesDP0503DP050025E Acs5ProfilesValuesDP0503DP050025E
...
func NewAcs5ProfilesValuesDP0503DP050025E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0503DP050025E {
	this := Acs5ProfilesValuesDP0503DP050025E{}
...
func (o Acs5ProfilesValuesDP0503DP050025E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0503DP050025E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0503DP050025E := _Acs5ProfilesValuesDP0503DP050025E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0503DP050025E); err == nil {
		*o = Acs5ProfilesValuesDP0503DP050025E(varAcs5ProfilesValuesDP0503DP050025E)
	}
...
type NullableAcs5ProfilesValuesDP0503DP050025E struct {
	value *Acs5ProfilesValuesDP0503DP050025E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0503DP050025E) Get() *Acs5ProfilesValuesDP0503DP050025E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0503DP050025E) Set(val *Acs5ProfilesValuesDP0503DP050025E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0503DP050025E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0503DP050025E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0503DP050025E(val *Acs5ProfilesValuesDP0503DP050025E) *NullableAcs5ProfilesValuesDP0503DP050025E {
	return &NullableAcs5ProfilesValuesDP0503DP050025E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0503DP050025E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0503DP050025E) UnmarshalJSON(src []byte) error {
	v.isSet = true

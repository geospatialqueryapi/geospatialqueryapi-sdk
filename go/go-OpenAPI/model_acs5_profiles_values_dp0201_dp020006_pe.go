...
// Acs5ProfilesValuesDP0201DP020006PE Male householder, no spouse/partner present (percent)
type Acs5ProfilesValuesDP0201DP020006PE struct {
	// DP02_0006PE
...
type _Acs5ProfilesValuesDP0201DP020006PE Acs5ProfilesValuesDP0201DP020006PE
...
func NewAcs5ProfilesValuesDP0201DP020006PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0201DP020006PE {
	this := Acs5ProfilesValuesDP0201DP020006PE{}
...
func (o Acs5ProfilesValuesDP0201DP020006PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0201DP020006PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0201DP020006PE := _Acs5ProfilesValuesDP0201DP020006PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0201DP020006PE); err == nil {
		*o = Acs5ProfilesValuesDP0201DP020006PE(varAcs5ProfilesValuesDP0201DP020006PE)
	}
...
type NullableAcs5ProfilesValuesDP0201DP020006PE struct {
	value *Acs5ProfilesValuesDP0201DP020006PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0201DP020006PE) Get() *Acs5ProfilesValuesDP0201DP020006PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0201DP020006PE) Set(val *Acs5ProfilesValuesDP0201DP020006PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0201DP020006PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0201DP020006PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0201DP020006PE(val *Acs5ProfilesValuesDP0201DP020006PE) *NullableAcs5ProfilesValuesDP0201DP020006PE {
	return &NullableAcs5ProfilesValuesDP0201DP020006PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0201DP020006PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0201DP020006PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

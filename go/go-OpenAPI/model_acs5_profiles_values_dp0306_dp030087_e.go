...
// Acs5ProfilesValuesDP0306DP030087E struct for Acs5ProfilesValuesDP0306DP030087E
type Acs5ProfilesValuesDP0306DP030087E struct {
...
type _Acs5ProfilesValuesDP0306DP030087E Acs5ProfilesValuesDP0306DP030087E
...
func NewAcs5ProfilesValuesDP0306DP030087E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030087E {
	this := Acs5ProfilesValuesDP0306DP030087E{}
...
func (o Acs5ProfilesValuesDP0306DP030087E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030087E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030087E := _Acs5ProfilesValuesDP0306DP030087E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030087E); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030087E(varAcs5ProfilesValuesDP0306DP030087E)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030087E struct {
	value *Acs5ProfilesValuesDP0306DP030087E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030087E) Get() *Acs5ProfilesValuesDP0306DP030087E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030087E) Set(val *Acs5ProfilesValuesDP0306DP030087E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030087E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030087E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030087E(val *Acs5ProfilesValuesDP0306DP030087E) *NullableAcs5ProfilesValuesDP0306DP030087E {
	return &NullableAcs5ProfilesValuesDP0306DP030087E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030087E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030087E) UnmarshalJSON(src []byte) error {
	v.isSet = true

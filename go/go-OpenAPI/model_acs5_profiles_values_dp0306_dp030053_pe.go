...
// Acs5ProfilesValuesDP0306DP030053PE struct for Acs5ProfilesValuesDP0306DP030053PE
type Acs5ProfilesValuesDP0306DP030053PE struct {
...
type _Acs5ProfilesValuesDP0306DP030053PE Acs5ProfilesValuesDP0306DP030053PE
...
func NewAcs5ProfilesValuesDP0306DP030053PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0306DP030053PE {
	this := Acs5ProfilesValuesDP0306DP030053PE{}
...
func (o Acs5ProfilesValuesDP0306DP030053PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0306DP030053PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0306DP030053PE := _Acs5ProfilesValuesDP0306DP030053PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0306DP030053PE); err == nil {
		*o = Acs5ProfilesValuesDP0306DP030053PE(varAcs5ProfilesValuesDP0306DP030053PE)
	}
...
type NullableAcs5ProfilesValuesDP0306DP030053PE struct {
	value *Acs5ProfilesValuesDP0306DP030053PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0306DP030053PE) Get() *Acs5ProfilesValuesDP0306DP030053PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0306DP030053PE) Set(val *Acs5ProfilesValuesDP0306DP030053PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0306DP030053PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0306DP030053PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0306DP030053PE(val *Acs5ProfilesValuesDP0306DP030053PE) *NullableAcs5ProfilesValuesDP0306DP030053PE {
	return &NullableAcs5ProfilesValuesDP0306DP030053PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0306DP030053PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0306DP030053PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

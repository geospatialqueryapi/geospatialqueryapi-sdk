...
// Acs5ProfilesValuesDP0505DP050083PE Not Hispanic or Latino: Two or more races (percent)
type Acs5ProfilesValuesDP0505DP050083PE struct {
	// DP05_0083PE
...
type _Acs5ProfilesValuesDP0505DP050083PE Acs5ProfilesValuesDP0505DP050083PE
...
func NewAcs5ProfilesValuesDP0505DP050083PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0505DP050083PE {
	this := Acs5ProfilesValuesDP0505DP050083PE{}
...
func (o Acs5ProfilesValuesDP0505DP050083PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0505DP050083PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0505DP050083PE := _Acs5ProfilesValuesDP0505DP050083PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0505DP050083PE); err == nil {
		*o = Acs5ProfilesValuesDP0505DP050083PE(varAcs5ProfilesValuesDP0505DP050083PE)
	}
...
type NullableAcs5ProfilesValuesDP0505DP050083PE struct {
	value *Acs5ProfilesValuesDP0505DP050083PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0505DP050083PE) Get() *Acs5ProfilesValuesDP0505DP050083PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0505DP050083PE) Set(val *Acs5ProfilesValuesDP0505DP050083PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0505DP050083PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0505DP050083PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0505DP050083PE(val *Acs5ProfilesValuesDP0505DP050083PE) *NullableAcs5ProfilesValuesDP0505DP050083PE {
	return &NullableAcs5ProfilesValuesDP0505DP050083PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0505DP050083PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0505DP050083PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

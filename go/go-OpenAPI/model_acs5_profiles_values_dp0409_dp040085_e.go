...
// Acs5ProfilesValuesDP0409DP040085E struct for Acs5ProfilesValuesDP0409DP040085E
type Acs5ProfilesValuesDP0409DP040085E struct {
...
type _Acs5ProfilesValuesDP0409DP040085E Acs5ProfilesValuesDP0409DP040085E
...
func NewAcs5ProfilesValuesDP0409DP040085E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0409DP040085E {
	this := Acs5ProfilesValuesDP0409DP040085E{}
...
func (o Acs5ProfilesValuesDP0409DP040085E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0409DP040085E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0409DP040085E := _Acs5ProfilesValuesDP0409DP040085E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0409DP040085E); err == nil {
		*o = Acs5ProfilesValuesDP0409DP040085E(varAcs5ProfilesValuesDP0409DP040085E)
	}
...
type NullableAcs5ProfilesValuesDP0409DP040085E struct {
	value *Acs5ProfilesValuesDP0409DP040085E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0409DP040085E) Get() *Acs5ProfilesValuesDP0409DP040085E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0409DP040085E) Set(val *Acs5ProfilesValuesDP0409DP040085E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0409DP040085E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0409DP040085E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0409DP040085E(val *Acs5ProfilesValuesDP0409DP040085E) *NullableAcs5ProfilesValuesDP0409DP040085E {
	return &NullableAcs5ProfilesValuesDP0409DP040085E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0409DP040085E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0409DP040085E) UnmarshalJSON(src []byte) error {
	v.isSet = true

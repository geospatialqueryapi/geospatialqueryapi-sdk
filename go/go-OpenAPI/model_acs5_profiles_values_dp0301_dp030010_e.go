...
type _Acs5ProfilesValuesDP0301DP030010E Acs5ProfilesValuesDP0301DP030010E
...
func NewAcs5ProfilesValuesDP0301DP030010E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0301DP030010E {
	this := Acs5ProfilesValuesDP0301DP030010E{}
...
func (o Acs5ProfilesValuesDP0301DP030010E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0301DP030010E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0301DP030010E := _Acs5ProfilesValuesDP0301DP030010E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0301DP030010E); err == nil {
		*o = Acs5ProfilesValuesDP0301DP030010E(varAcs5ProfilesValuesDP0301DP030010E)
	}
...
type NullableAcs5ProfilesValuesDP0301DP030010E struct {
	value *Acs5ProfilesValuesDP0301DP030010E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0301DP030010E) Get() *Acs5ProfilesValuesDP0301DP030010E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0301DP030010E) Set(val *Acs5ProfilesValuesDP0301DP030010E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0301DP030010E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0301DP030010E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0301DP030010E(val *Acs5ProfilesValuesDP0301DP030010E) *NullableAcs5ProfilesValuesDP0301DP030010E {
	return &NullableAcs5ProfilesValuesDP0301DP030010E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0301DP030010E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0301DP030010E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0301DP030014E EMPLOYMENT STATUS: Own children of the householder under 6 years
type Acs5ProfilesValuesDP0301DP030014E struct {
	// DP03_0014E
...
type _Acs5ProfilesValuesDP0301DP030014E Acs5ProfilesValuesDP0301DP030014E
...
func NewAcs5ProfilesValuesDP0301DP030014E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0301DP030014E {
	this := Acs5ProfilesValuesDP0301DP030014E{}
...
func (o Acs5ProfilesValuesDP0301DP030014E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0301DP030014E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0301DP030014E := _Acs5ProfilesValuesDP0301DP030014E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0301DP030014E); err == nil {
		*o = Acs5ProfilesValuesDP0301DP030014E(varAcs5ProfilesValuesDP0301DP030014E)
	}
...
type NullableAcs5ProfilesValuesDP0301DP030014E struct {
	value *Acs5ProfilesValuesDP0301DP030014E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0301DP030014E) Get() *Acs5ProfilesValuesDP0301DP030014E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0301DP030014E) Set(val *Acs5ProfilesValuesDP0301DP030014E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0301DP030014E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0301DP030014E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0301DP030014E(val *Acs5ProfilesValuesDP0301DP030014E) *NullableAcs5ProfilesValuesDP0301DP030014E {
	return &NullableAcs5ProfilesValuesDP0301DP030014E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0301DP030014E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0301DP030014E) UnmarshalJSON(src []byte) error {
	v.isSet = true

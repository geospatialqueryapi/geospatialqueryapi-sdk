...
// Acs5ProfilesValuesDP0209DP020085E Population 1 year and over: Different house in the U.S.: Different county: Different state
type Acs5ProfilesValuesDP0209DP020085E struct {
	// DP02_0085E
...
type _Acs5ProfilesValuesDP0209DP020085E Acs5ProfilesValuesDP0209DP020085E
...
func NewAcs5ProfilesValuesDP0209DP020085E(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0209DP020085E {
	this := Acs5ProfilesValuesDP0209DP020085E{}
...
func (o Acs5ProfilesValuesDP0209DP020085E) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0209DP020085E) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0209DP020085E := _Acs5ProfilesValuesDP0209DP020085E{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0209DP020085E); err == nil {
		*o = Acs5ProfilesValuesDP0209DP020085E(varAcs5ProfilesValuesDP0209DP020085E)
	}
...
type NullableAcs5ProfilesValuesDP0209DP020085E struct {
	value *Acs5ProfilesValuesDP0209DP020085E
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0209DP020085E) Get() *Acs5ProfilesValuesDP0209DP020085E {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0209DP020085E) Set(val *Acs5ProfilesValuesDP0209DP020085E) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0209DP020085E) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0209DP020085E) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0209DP020085E(val *Acs5ProfilesValuesDP0209DP020085E) *NullableAcs5ProfilesValuesDP0209DP020085E {
	return &NullableAcs5ProfilesValuesDP0209DP020085E{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0209DP020085E) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0209DP020085E) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// Acs5ProfilesValuesDP0409DP040081PE struct for Acs5ProfilesValuesDP0409DP040081PE
type Acs5ProfilesValuesDP0409DP040081PE struct {
...
type _Acs5ProfilesValuesDP0409DP040081PE Acs5ProfilesValuesDP0409DP040081PE
...
func NewAcs5ProfilesValuesDP0409DP040081PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0409DP040081PE {
	this := Acs5ProfilesValuesDP0409DP040081PE{}
...
func (o Acs5ProfilesValuesDP0409DP040081PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0409DP040081PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0409DP040081PE := _Acs5ProfilesValuesDP0409DP040081PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0409DP040081PE); err == nil {
		*o = Acs5ProfilesValuesDP0409DP040081PE(varAcs5ProfilesValuesDP0409DP040081PE)
	}
...
type NullableAcs5ProfilesValuesDP0409DP040081PE struct {
	value *Acs5ProfilesValuesDP0409DP040081PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0409DP040081PE) Get() *Acs5ProfilesValuesDP0409DP040081PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0409DP040081PE) Set(val *Acs5ProfilesValuesDP0409DP040081PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0409DP040081PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0409DP040081PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0409DP040081PE(val *Acs5ProfilesValuesDP0409DP040081PE) *NullableAcs5ProfilesValuesDP0409DP040081PE {
	return &NullableAcs5ProfilesValuesDP0409DP040081PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0409DP040081PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0409DP040081PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

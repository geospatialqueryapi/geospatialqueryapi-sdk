...
// Acs5ProfilesValuesDP0203DP020031PE Marital status: Females 15 years and over (percent)
type Acs5ProfilesValuesDP0203DP020031PE struct {
	// DP02_0031PE
...
type _Acs5ProfilesValuesDP0203DP020031PE Acs5ProfilesValuesDP0203DP020031PE
...
func NewAcs5ProfilesValuesDP0203DP020031PE(mDBCode string, mDBName string, mDBValue string) *Acs5ProfilesValuesDP0203DP020031PE {
	this := Acs5ProfilesValuesDP0203DP020031PE{}
...
func (o Acs5ProfilesValuesDP0203DP020031PE) MarshalJSON() ([]byte, error) {
...
func (o *Acs5ProfilesValuesDP0203DP020031PE) UnmarshalJSON(bytes []byte) (err error) {
	varAcs5ProfilesValuesDP0203DP020031PE := _Acs5ProfilesValuesDP0203DP020031PE{}

	if err = json.Unmarshal(bytes, &varAcs5ProfilesValuesDP0203DP020031PE); err == nil {
		*o = Acs5ProfilesValuesDP0203DP020031PE(varAcs5ProfilesValuesDP0203DP020031PE)
	}
...
type NullableAcs5ProfilesValuesDP0203DP020031PE struct {
	value *Acs5ProfilesValuesDP0203DP020031PE
	isSet bool
}

func (v NullableAcs5ProfilesValuesDP0203DP020031PE) Get() *Acs5ProfilesValuesDP0203DP020031PE {
	return v.value
}

func (v *NullableAcs5ProfilesValuesDP0203DP020031PE) Set(val *Acs5ProfilesValuesDP0203DP020031PE) {
	v.value = val
	v.isSet = true
}

func (v NullableAcs5ProfilesValuesDP0203DP020031PE) IsSet() bool {
	return v.isSet
}

func (v *NullableAcs5ProfilesValuesDP0203DP020031PE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcs5ProfilesValuesDP0203DP020031PE(val *Acs5ProfilesValuesDP0203DP020031PE) *NullableAcs5ProfilesValuesDP0203DP020031PE {
	return &NullableAcs5ProfilesValuesDP0203DP020031PE{value: val, isSet: true}
}

func (v NullableAcs5ProfilesValuesDP0203DP020031PE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcs5ProfilesValuesDP0203DP020031PE) UnmarshalJSON(src []byte) error {
	v.isSet = true

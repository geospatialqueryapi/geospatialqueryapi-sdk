...
class DataApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_v1_boundaries_ustract_lat_lat_lon(
            self,
            lat_lon,
            **kwargs
        ):
            ...
            >>> thread = api.get_v1_boundaries_ustract_lat_lat_lon(lat_lon, async_req=True)
            >>> result = thread.get()
        ...
        self.get_v1_boundaries_ustract_lat_lat_lon = _Endpoint(
            settings={
                'response_type': (FeatureGeoJSON,),
                'auth': [],
                'endpoint_path': '/v1/boundaries/ustract/latlon/{LatLon}',
                'operation_id': 'get_v1_boundaries_ustract_lat_lat_lon',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_v1_boundaries_ustract_lat_lat_lon
        )
